...
public class clsBillDaoImpl implements clsBillDao
{
    ...
    {	
    	...
    	hdModel.setListBillDtlModels(list);
    	List<clsBillTaxDtlModel> list2 = hdModel.getListBillTaxDtlModels();
    	hdModel.setListBillTaxDtlModels(list2);
    	clsBillHdModel hdModelRet =hdModel;*/
    	return hdModel ;
    }
