...
public class clsGuestMasterDaoImpl implements clsGuestMasterDao
{
	...
	{
		String sqlDelete="delete from tblguestmaster where lngMobileNo='"+objGuestMasterModel.getLngMobileNo()+"' "
			+ " and strClientCode='"+objGuestMasterModel.getStrClientCode()+"'";
