...
public class clsRoomMasterModel implements Serializable
{
	...
	public String getStrFloorNo()
    {
		return strFloorNo;
    }

    public void setStrFloorNo(String strFloorNo)
    {
    	this.strFloorNo = (String) setDefaultValue(strFloorNo, "NA");
    }
    ...
    {
    	this.strProvisionForSmokingYN = (String) setDefaultValue(
		strProvisionForSmokingYN, "N");
    }
    ...
    private Object setDefaultValue(Object value, Object defaultValue)
    {
			...
			&& (value instanceof String && value.toString().length() > 0))
		{
			...
			&& (value instanceof Double && value.toString().length() > 0))
		{
		    return value;
		}
		else if (value != null
			&& (value instanceof Integer && value.toString().length() > 0))
		{
		    return value;
		}
		else if (value != null
			&& (value instanceof Long && value.toString().length() > 0))
		{
		    return value;
		}
		else
