...
public class clsCancelationReportController {
	 ...
	 @SuppressWarnings("unchecked")
		...
		try
		{
				...
				// get all parameters
			    String sqlCancel = " select a.strReservationNo,CONCAT(c.strFirstName,' ',c.strMiddleName,' ',c.strLastName) as strGuestName, "
			    		+ " e.strBookingTypeDesc,d.strRoomType,DATE_FORMAT(b.dteReservationDate,'%d-%m-%Y') as dteReservationDate, "
			    		+ " DATE_FORMAT(a.dteCancelDate,'%d-%m-%Y')  as dteCancelDate,f.strRoomDesc "
			    		+ " from tblroomcancelation a,tblreservationhd b,tblguestmaster c ,tblreservationdtl d,tblbookingtype e,tblroom f "
			    		+ " where date(b.dteReservationDate) "
