...
public class clsRoomMasterController
{
    ...
    {		
		...
		objModel.setStrFloorNo(objGlobal.funIfNull(objBean.getStrFloorNo(), "", objBean.getStrFloorNo()));
		...
		objModel.setStrBathTypeCode(objGlobal.funIfNull(objBean.getStrBathType(), "", objBean.getStrBathType()));
