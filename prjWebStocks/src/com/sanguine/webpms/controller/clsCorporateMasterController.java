...
//Open CorporateMaster
	...
	public ModelAndView funOpenForm(Map<String, Object> model,HttpServletRequest request){
		...
		String citySql="select strCityName from dbwebmms.tblcitymaster where strClientCode='"+clientCode+"' ";
		...
		String stateSql="select strStateName from dbwebmms.tblstatemaster where strClientCode='"+clientCode+"' ";
		...
		String countrySql="select strCountryName from dbwebmms.tblcountrymaster where strClientCode='"+clientCode+"' ";
