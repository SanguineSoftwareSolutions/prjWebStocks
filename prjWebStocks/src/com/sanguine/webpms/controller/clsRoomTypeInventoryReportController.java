...
try
{
	 String clientCode = req.getSession().getAttribute("clientCode").toString();
        ...
        {
		    String eachDateSql=" select d.strRoomTypeDesc,count(d.strRoomTypeDesc)  "
		    		+ " from tblcheckinhd a,tblcheckindtl b,tblroom c, tblroomtypemaster  d "
		    		+ "  where a.strCheckInNo=b.strCheckInNo "
		    		+ " and b.strRoomNo=c.strRoomCode and c.strRoomTypeCode=d.strRoomTypeCode "
		    		+ " and date(a.dteCheckInDate) = '"+key+"' "
		    		+ " and a.strClientCode=b.strClientCode  and b.strClientCode=c.strClientCode "
		    		+ " and c.strClientCode=d.strClientCode and d.strClientCode='"+clientCode+"' "
		    		+ " group by d.strRoomTypeDesc ";
