...
public class clsChargeProcessingServiceImpl implements clsChargeProcessingService{
	...
	@Override
	public List funCalculateOutstanding(String string, String funGetDate,String funGetDate2, String strMemberCode) 
	{	
		return objChargeProcessingDao.funCalculateOutstanding(string, funGetDate, funGetDate2, strMemberCode);
	}
