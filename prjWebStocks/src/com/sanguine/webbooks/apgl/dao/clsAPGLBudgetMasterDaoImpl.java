...
public class clsAPGLBudgetMasterDaoImpl implements clsAPGLBudgetMasterDao  {
	...
	{
//		String sql="select a.strAccountCode,a.strAccountName,IFNULL(b.strMonth,''),IFNULL(b.strYear,''),IFNULL(b.dblBudgetAmt,0.0), IFNULL(b.intID,' ') from tblacmaster a " 
...
//		
		...
		String sql="select a.strAccountCode,a.strAccountName,IFNULL(b.dblBudgetAmt,0.0), IFNULL(b.intID,' ') from tblacmaster a " 
				  +" left outer join tblbudget b on a.strAccountCode=b.strAccCode and a.strClientCode=b.strClientCode where b.strMonth='"+strMonth+"' and "
				  +" b.strYear='"+strYear+"' and a.strClientCode='"+strClientCode+"' and b.strClientCode='"+strClientCode+"'  order by b.strMonth,b.strMonth" ;
