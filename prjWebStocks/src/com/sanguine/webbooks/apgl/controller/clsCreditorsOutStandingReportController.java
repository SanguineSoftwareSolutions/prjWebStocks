...
public class clsCreditorsOutStandingReportController {
	...
	public ModelAndView funOpenForm(Map<String, Object> model,
		...
		if ("2".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmCreditorsOutStandingReport_1",
					"command", new clsCreditorOutStandingReportBean());
		} else if ("1".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmCreditorsOutStandingReport", "command",
	...
	private void funReport(@ModelAttribute("command") clsCreditorOutStandingReportBean objBean,
		...
		try {
			...
			String sqlQuery = "SELECT  a.dteVouchDate,a.strVouchNo, DATE_FORMAT(a.dteVouchDate,'%d-%m-%Y'),"
							...
							+" AND a.strModuleType='AP' AND  c.strDebtorCode=d.strDebtorCode  and d.strPType='Supp' "
			...
			if (jprintlist.size() > 0) {
				...
				exporter.setParameter(JRPdfExporterParameter.IGNORE_PAGE_MARGINS,Boolean.TRUE);
				 ...
				 "inline;filename=rptCreditorsOutStandingReport_"+dteFromDate+"_To_"+dteToDate+"_"+userCode+".pdf");
				...
				exporter.setParameter(JRXlsExporterParameter.IGNORE_PAGE_MARGINS,Boolean.TRUE);
				 resp.setHeader("Content-Disposition",
				 "inline;filename=rptCreditorsOutStandingReport_"+dteFromDate+"_To_"+dteToDate+"_"+userCode+".xls");
				exporter.exportReport();
				servletOutputStream.flush();
				servletOutputStream.close();
				 }
