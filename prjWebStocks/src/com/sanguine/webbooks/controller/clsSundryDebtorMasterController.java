...
//Open SundryDebtorMaster
	...
	public ModelAndView funOpenForm(Map<String,Object>model,HttpServletRequest request)
	{
		...
		ArrayList<String>listCurrencyType=new ArrayList<String>();
		listCurrencyType.add("Rs");
		listCurrencyType.add("Dollar");
		listCurrencyType.add("Pound");
		...
		model.put("listCurrencyType", listCurrencyType);
...
//Load Master Data On Form
	...
	public @ResponseBody clsSundryDebtorMasterModel funAssignFields(@RequestParam("debtorCode") String debtorCode,HttpServletRequest req)
	{
		...
		String sqlQuery = "select a.strAccountCode,a.strAccountName,a.dblOpeningbal,a.strCrDr "
				+ "FROM tblsundarydebtoropeningbalance a "
				+ "where a.strDebtorCode = '"+debtorCode+"'  and a.strClientCode='"+clientCode+"'";
