...
public class clsChargeMasterDaoImpl implements clsChargeMasterDao{
	...
	public List funGetChargeMaster(String chargeCode,String clientCode)
	{
		...
		Query query=webBooksSessionFactory.getCurrentSession().createQuery("from clsChargeMasterModel a,clsWebBooksAccountMasterModel b where a.strClientCode=b.strClientCode and "
				 + "a.strAcctCode=b.strAccountCode and a.strChargeCode=:chargeCode and a.strClientCode=:clientCode");
