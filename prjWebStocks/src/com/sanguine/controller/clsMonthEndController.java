...
public class clsMonthEndController {
	...
	@Autowired clsLocationMasterService objLocationMasterService;
	@Autowired
	...
	public @ResponseBody int funCheckMonthEnd(@RequestParam("locCode")  String locCode,@RequestParam("GRNDate")  String GRNDate,
