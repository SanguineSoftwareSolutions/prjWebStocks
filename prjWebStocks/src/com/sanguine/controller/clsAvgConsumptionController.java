...
// 		 String[] splDate=currDate.split("-"); 
 		...
 		String sqlProd =" ";
	 	 ...
	 	 for (int j = 0; j < listProdDtl.size(); j++)
		  {
		 		...
		 		String sqlStk =" select a.dblOpeningStk,a.dblClosingStk,a.dblMISOut,"
		 				+ " (a.dblGRN+dblSCGRN+a.dblStkTransIn+a.dblStkAdjIn+a.dblMISIn+a.dblQtyProduced+a.dblMaterialReturnIn) as Receipts, "
		 				...
		 				+ " from tblcurrentstock a where a.strLocCode='"+locCode+"' and a.strProdCode='"+pCode+"' and a.strClientCode='"+clientCode+"' and a.strUserCode='"+userCode+"' ";
				...
				if(issueQty<0)
				{
		 		...
		 		String sqlSuppName =" select a.strSuppCode,b.strPName  from tblprodsuppmaster a ,tblpartymaster b "
		 				+ " where  a.strSuppCode=b.strPCode and a.strProdCode='"+pCode+"' and a.strDefault='Y' and a.strClientCode='"+clientCode+"'  ";
...
//	            resp.setHeader( "Content-Disposition", "attachment;filename=rptAvgConsumptionReport"+objGlobal.funGetCurrentDateTime("yyyy-MM-dd")+".xls" );                        
