...
public class clsExciseMasterController {
	...
	//Save or Update Excise master function to save or update record of master into database and also validates all fields of form.
	...
	//Returns a single Excise master record by passing Excise code as primary key. Also generates next Excise Code if transaction is for Save Master
