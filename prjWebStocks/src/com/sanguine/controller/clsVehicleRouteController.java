...
public class clsVehicleRouteController {
	...
	//Open VehicleMaster
		...
		//Save or Update group master function to save or update record of master into database and also validates all fields of form.
		...
		{     
			...
			//	System.out.println(objVehicleMasterService.funGetListVehicleRouteModel("V000001", clientCode));
