...
public class clsStockLedgerController 
{
	...
	private ModelAndView funOpenStockLedgerFromStockFlash(@ModelAttribute("command") clsStockFlashBean objPropBean,BindingResult result,@RequestParam(value="param1") String paramForStkLedger,
	...
	private @ResponseBody List funShowStockDetailFlash(@RequestParam(value="param1") String param1,
			@RequestParam(value="fDate") String fDate,@RequestParam(value="tDate") String tDate,
...
//				String tempDate=arrObj[0].toString().split("-")[2]+"-"+arrObj[0].toString().split("-")[0]+"-"+arrObj[0].toString().split("-")[1];
//			
...
//				tempIssues+=Math.rint(Double.parseDouble(arrObj[4].toString().split(" ")[0].toString()));
			...
			if(totalOpStk<0)
			{
				if(qtyWithUOM.equals("No"))
				{
					...
					selectOpStk=" select '"+toDate+"' TransDate, 1 TransNo "
							+ ",'Opening Stk' TransType, 'OP' RefNo, 0 Receipt"
							+ ",'"+strOpStockWithUOM+"' Issue,'Opening Stk' Name, "+rate+" Rate, "
						    + " CONCAT_WS('!',b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM) UOMString  " 
							+ " from tblproductmaster b where b.strProdCode = '"+prodCode+"' "; 
				}
			}
			else
			{
				...
				}else
				{
					if(startDate.equals(fromDate))
					{	
					selectOpStk= "select a.dtCreatedDate TransDate,1 TransNo, 'Opening Stk' TransType, a.strOpStkCode RefNo"
							+ ", funGetUOM(ifnull(sum(b.dblQty),0),c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) Receipt, 0 Issue"
...
//							+ ", funGetUOM(ifnull(sum(b.dblQty),0),c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
							+ ", CONCAT_WS('!',c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
							+ " from tblinitialinventory a, tblinitialinvdtl b, tblproductmaster c "
							+ "where a.strOpStkCode  = b.strOpStkCode and b.strProdCode=c.strProdCode "
							...
							selectOpStk+= "and date(a.dtCreatedDate) >= '"+startDate+"' and date(a.dtCreatedDate) <= '"+toDate+"'  "
									+ "group by a.dtCreatedDate,b.strProdCode " ;
					}else
					{
						selectOpStk=" select '"+fromDate+"' TransDate, 1 TransNo "
								+ ",'Opening Stk' TransType, 'OP' RefNo, '"+strOpStockWithUOM+"' Receipt"
								+ ",0 Issue,'Opening Stk' Name, "+rate+" Rate, "
								+ " CONCAT_WS('!',b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM) UOMString  "
								+ " from tblproductmaster b where b.strProdCode = '"+prodCode+"' ";
							System.out.println(selectOpStk);
		...
		if(qtyWithUOM.equals("No"))
		{
			...
			}else
			{
				...
				sql+= "select a.dtCreatedDate TransDate,1 TransNo, 'Opening Stk' TransType, a.strOpStkCode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue "
				+ ",'Opening Stock' Name,dblCostPerUnit Rate "
				...
				sql+= "and date(a.dtCreatedDate) = '"+startDate+"'  "
						+ "group by a.dtCreatedDate,strProdCode "
				
				+ "union all ";
				
			}			
			sql+="select a.dtMISDate TransDate,3 TransNo, 'MIS In' TransType, a.strMISCode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue "
			+ ",c.strLocName Name ,b.dblUnitPrice Rate "
			+ "from tblmishd a, tblmisdtl b ,tbllocationmaster c "
			+ "where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
		    {
			...
			sql+= "and date(a.dtMISDate) >= '"+fromDate+"' and date(a.dtMISDate) <= '"+toDate+"' "
					+ " group by a.dtMISDate,a.strMISCode,a.strLocTo "
			+ ""
			...
			sql+= "and date(a.dtCreatedDate) >= '"+startDate+"' and date(a.dtCreatedDate) <= '"+toDate+"'  "
					+ "group by a.dtCreatedDate,strProdCode "
			
			+ "union all "
			*/
			
			+ "select a.dtGRNDate TransDate,2 TransNo, 'GRN' TransType, a.strGRNCode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue"
			+ ",c.strPName Name,b.dblUnitPrice Rate "
			...
			sql+= "and date(a.dtGRNDate) >= '"+fromDate+"' and date(a.dtGRNDate) <= '"+toDate+"' "
					+ "group by a.dtGRNDate , a.strGRNCode, a.strSuppCode, RefNo "
			
			+ "union all "
			
			+ "select a.dtSADate TransDate,11 TransNo, 'StkAdj In' TransType, a.strSACode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue"
			+ ",c.strLocName Name, b.dblRate Rate "
			+ "from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c "
			+ "where a.strSACode = b.strSACode and a.strLocCode=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' "
			+ "and b.strType='IN' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
			...
			sql+= "and date(a.dtSADate) >= '"+fromDate+"' and date(a.dtSADate) <= '"+toDate+"' "
					+ "group by a.dtSADate, a.strSACode, a.strLocCode "
			+ ""
						
			+ "union all "
			
			+ "select a.dtSTDate TransDate,4 TransNo, 'StkTrans In' TransType, a.strSTCode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue"
			+ ",c.strLocName Name,(b.dblTotalPrice/ifnull(sum(b.dblQty),1)) Rate "
			+ "from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c "
			+ "where a.strSTCode  = b.strSTCode and a.strToLocCode = c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
			...
			sql+= "and date(a.dtSTDate) >= '"+fromDate+"' and date(a.dtSTDate) <= '"+toDate+"' "
					+ "group by a.dtSTDate, a.strSTCode, a.strToLocCode "
			+ ""
					
			+ "union all "
			
			+ "select a.dtMRetDate TransDate,5 TransNo, 'Mat Ret In' TransType, a.strMRetCode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue"
			+ ",c.strLocName Name,'1' Rate "
			+ "from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c "
			+ "where a.strMRetCode  = b.strMRetCode and a.strLocTo=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strLocTo='"+locCode+"' ";
			...
			sql+= "and date(a.dtMRetDate) >= '"+fromDate+"' and date(a.dtMRetDate) <= '"+toDate+"' "
					+ "group by a.dtMRetDate, a.strMRetCode, a.strLocTo "
			+ ""
...
//            	sql+= "and a.strAuthorise='Yes' ";
//            }
//			sql+= "and date(a.dtPDDate) >= '"+fromDate+"' and date(a.dtPDDate) <= '"+toDate+"' "
//					+ "group by a.dtPDDate, a.strPDCode, a.strLocCode "
//			+ ""
					
			+ "union all "
			
			+ "select a.dtPRDate TransDate,7 TransNo, 'Purchase Ret' TransType, a.strPRCode RefNo, 0 Receipt, ifnull(sum(b.dblQty),0) Issue"
			+ ",c.strLocName Name,b.dblUnitPrice Rate "
			+ "from tblpurchasereturnhd a, tblpurchasereturndtl b,tbllocationmaster c "
			+ "where a.strPRCode  = b.strPRCode and a.strLocCode=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strLocCode='"+locCode+"' ";
			...
			sql+= "and date(a.dtPRDate) >= '"+fromDate+"' and date(a.dtPRDate) <= '"+toDate+"' "
					+ "group by a.dtPRDate,a.strPRCode,a.strLocCode  "
			+ ""
					
			+ "union all "

			+ "select a.dtSADate TransDate,12 TransNo, 'StkAdj Out' TransType, a.strSACode RefNo, 0 Receipt, ifnull(sum(b.dblQty),0) Issue "
			+ ",c.strLocName Name, b.dblRate Rate "
			+ "from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c "
			+ "where a.strSACode = b.strSACode and a.strLocCode=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' "
			...
			+ "select a.dtSTDate TransDate,8 TransNo, 'StkTrans Out' TransType, a.strSTCode RefNo, 0 Receipt, ifnull(sum(b.dblQty),0) Issue "
			+ ",c.strLocName Name,(b.dblPrice/ifnull(sum(b.dblQty),1)) Rate "
			+ "from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c "
			+ "where a.strSTCode  = b.strSTCode and a.strFromLocCode = c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
			...
			sql+= "and date(a.dtSTDate) >= '"+fromDate+"' and date(a.dtSTDate) <= '"+toDate+"' "
					+ "group by a.dtSTDate, a.strSTCode, a.strFromLocCode "
			+ ""
					
			+ "union all "
			
			+ "select a.dtMRetDate TransDate,9 TransNo, 'Mat Ret Out' TransType, a.strMRetCode RefNo, 0 Receipt, ifnull(sum(b.dblQty),0) Issue "
			+ ",c.strLocName Name,'1' Rate "
			+ "from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c "	
			+ "where a.strMRetCode  = b.strMRetCode and a.strLocFrom=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
			...
			sql+= "and date(a.dtMRetDate) >= '"+fromDate+"' and date(a.dtMRetDate) <= '"+toDate+"' "
					+ "group by a.dtMRetDate, a.strMRetCode, a.strLocFrom "
			+ ""
					
			+ "union all "
			
			+ "select a.dtMISDate TransDate,10 TransNo, 'MIS Out' TransType, a.strMISCode RefNo, 0 Receipt, ifnull(sum(b.dblQty),0) Issue "
			+ ",c.strLocName Name,b.dblUnitPrice Rate "
			+ "from tblmishd a, tblmisdtl b, tbllocationmaster c "
			+ "where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			...
			+ "select a.dteSRDate TransDate,11 TransNo, 'Sales Ret' TransType, a.strSRCode RefNo, 0 Receipt,  "
			+ "ifnull(sum(b.dblQty),0) Issue ,c.strLocName Name,d.dblUnitPrice Rate  " 
			+ "from tblsalesreturnhd a, tblsalesreturndtl b, tbllocationmaster c ,tblproductmaster d "
			+ "where a.strSRCode = b.strSRCode and a.strLocCode=c.strLocCode and b.strProdCode=d.strProdCode ";
			
			if(!locCode.equalsIgnoreCase("All"))
			{
				sql+= "and a.strLocCode = '"+locCode+"' ";
			}
			sql+= " and date(a.dteSRDate) >= '"+fromDate+"' and date(a.dteSRDate) <= '"+toDate+"' "
					+ "group by a.dteSRDate, a.strSRCode, a.strLocCode "
			+ ""
			...
			if(objSetup.getStrIndustryType().equalsIgnoreCase("Invoice"))
			{
			sql+= "	 SELECT a.dteInvDate TransDate,13 TransNo, 'Invoice' TransType, a.strInvCode RefNo, 0 Receipt,"
					+ " IFNULL(SUM(b.dblQty),0) Issue,c.strLocName Name,d.dblUnitPrice Rate "
					+ "  FROM tblinvoicehd a, tblinvoicedtl b, tbllocationmaster c,tblproductmaster d "
					+ " where a.strInvCode=b.strInvCode AND a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode AND "
					+ " b.strProdCode = '"+prodCode+"' " ;
					if(!locCode.equalsIgnoreCase("All"))
					{
						sql+= "and a.strLocCode = '"+locCode+"' ";
					}
					sql+=" AND DATE(a.dteInvDate) >= '"+fromDate+"' "
					+ " AND DATE(a.dteInvDate) <= '"+toDate+"'  GROUP BY a.dteInvDate, a.strInvCode, a.strLocCode " ;
			}else{
				
			
			sql+= "	 SELECT a.dteDCDate TransDate,13 TransNo, 'Delivery Chal.' TransType, a.strDCCode RefNo, 0 Receipt,"
				+ " IFNULL(SUM(b.dblQty),0) Issue,c.strLocName Name,d.dblUnitPrice Rate "
				+ "  FROM tbldeliverychallanhd a, tbldeliverychallandtl b, tbllocationmaster c,tblproductmaster d "
				+ " where a.strDCCode=b.strDCCode AND a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode AND "
				+ " b.strProdCode = '"+prodCode+"' " ;
				if(!locCode.equalsIgnoreCase("All"))
				{
					sql+= "and a.strLocCode = '"+locCode+"' ";
				}
				sql+=" AND DATE(a.dteDCDate) >= '"+fromDate+"' "
				+ " AND DATE(a.dteDCDate) <= '"+toDate+"'  GROUP BY a.dteDCDate, a.strDCCode, a.strLocCode "; 
				
			}
			
			sql+= "UNION ALL  ";
			sql+="select a.dteSRDate TransDate,14 TransNo, 'SC GRN' TransType, a.strSRCode RefNo, IFNULL(SUM(b.dblQty),0) Receipt, "
			    + "0 Issue,c.strLocName Name,b.dblPrice Rate "
			    + " from tblscreturnhd a,tblscreturndtl b ,tbllocationmaster c "
			    + "where a.strSRCode=b.strSRCode and a.strLocCode=c.strLocCode and b.strProdCode= '"+prodCode+"' ";
				if(!locCode.equalsIgnoreCase("All"))
				{
					sql+= "and a.strLocCode = '"+locCode+"' ";
				}
				sql+=" AND DATE(a.dteSRDate) >= '"+fromDate+"' "
				+ " AND DATE(a.dteSRDate) <= '"+toDate+"'  GROUP BY a.dteSRDate, a.strSRCode, a.strLocCode "
			
				+" UNION ALL  ";	
			
				
				sql+="select a.dteDNDate TransDate,15 TransNo, 'Delivery Note' TransType, a.strDNCode RefNo, 0 Receipt,"
						+ " IFNULL(SUM(b.dblQty),0)  Issue,c.strLocName Name,0 Rate " 
						+" from tbldeliverynotehd a,tbldeliverynotedtl b ,tbllocationmaster c	"
						+" where a.strDNCode=b.strDNCode and a.strLocCode=c.strLocCode   and b.strProdCode= '"+prodCode+"' ";
				
						if(!locCode.equalsIgnoreCase("All"))
						{
							sql+= "and a.strLocCode = '"+locCode+"' ";
						}
						sql+=" AND DATE(a.dteDNDate) >= '"+fromDate+"' "
						+ " AND DATE(a.dteDNDate) <= '"+toDate+"'  GROUP BY a.dteDNDate, a.strDNCode, a.strLocCode ";
				
			sql+= ") a "
			+ "where date(TransDate) IS NOT NULL "
		...
		else
		{
			...
			sql+="select a.dtMISDate TransDate,3 TransNo, 'MIS In' TransType, a.strMISCode RefNo"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt "
			+ ", 0 Issue ,c.strLocName Name "
			+ ",b.dblUnitPrice Rate"
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			...
			+ " from tblmishd a, tblmisdtl b ,tbllocationmaster c, tblproductmaster d "
			+ "where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
		    {
				sql+= "and a.strLocTo = '"+locCode+"' ";
			...
			if(startDate.equals(fromDate))
			{
					sql+= "select a.dtCreatedDate TransDate,1 TransNo, 'Opening Stk' TransType, a.strOpStkCode RefNo"
				+ ", funGetUOM(ifnull(sum(b.dblQty),0),c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) Receipt, 0 Issue"
				+ ",'Opening Stock' Name,dblCostPerUnit Rate"
	//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
				+ ", CONCAT_WS('!',c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
			...
			sql+= "select a.dtGRNDate TransDate,2 TransNo, 'GRN' TransType, a.strGRNCode RefNo"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt, 0 Issue "
			+ ",c.strPName Name,b.dblUnitPrice Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblgrnhd a, tblgrndtl b,tblpartymaster c, tblproductmaster d "
			+ "where a.strGRNCode = b.strGRNCode and a.strSuppCode=c.strPCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strLocCode='"+locCode+"' ";
			...
			+ "select a.dtSADate TransDate,11 TransNo, 'StkAdj In' TransType, a.strSACode RefNo"			
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt, 0 Issue "
			+ ",c.strLocName Name, b.dblRate Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c, tblproductmaster d "
			+ "where a.strSACode = b.strSACode and a.strLocCode=c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' "
			+ "and b.strType='IN' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
			...
			+ "select a.dtSTDate TransDate,4 TransNo, 'StkTrans In' TransType, a.strSTCode RefNo"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt, 0 Issue "
			+ ",c.strLocName Name,(b.dblTotalPrice/ifnull(sum(b.dblQty),1)) Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c, tblproductmaster d  "
			+ "where a.strSTCode  = b.strSTCode and a.strToLocCode = c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strToLocCode='"+locCode+"' ";
			...
			+ "select a.dtMRetDate TransDate,5 TransNo, 'Mat Ret In' TransType, a.strMRetCode RefNo"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt, 0 Issue "
			+ ",c.strLocName Name,'1' Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c, tblproductmaster d "
			+ "where a.strMRetCode  = b.strMRetCode and a.strLocTo=c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strLocTo='"+locCode+"' ";
...
//			+ ""
			...
			+ "select a.dtPRDate TransDate,7 TransNo, 'Purchase Ret' TransType, a.strPRCode RefNo, 0 Receipt"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Issue "			
			+ ",c.strLocName Name,b.dblUnitPrice Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblpurchasereturnhd a, tblpurchasereturndtl b,tbllocationmaster c, tblproductmaster d "
			+ "where a.strPRCode  = b.strPRCode and a.strLocCode=c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strLocCode='"+locCode+"' ";
			...
			+ "select a.dtSADate TransDate,12 TransNo, 'StkAdj Out' TransType, a.strSACode RefNo, 0 Receipt"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Issue "			
			+ ",c.strLocName Name, b.dblRate Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			...
			+ "select a.dtSTDate TransDate,8 TransNo, 'StkTrans Out' TransType, a.strSTCode RefNo, 0 Receipt"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Issue "			
			+ ",c.strLocName Name,(b.dblPrice/ifnull(sum(b.dblQty),1)) Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c, tblproductmaster d "
			+ "where a.strSTCode  = b.strSTCode and a.strFromLocCode = c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strFromLocCode='"+locCode+"' ";
			...
			+ "select a.dtMRetDate TransDate,9 TransNo, 'Mat Ret Out' TransType, a.strMRetCode RefNo, 0 Receipt"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Issue "
			+ ",c.strLocName Name,'1' Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ " from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c, tblproductmaster d "
			+ "where a.strMRetCode  = b.strMRetCode and a.strLocFrom=c.strLocCode and b.strProdCode=d.strProdCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
			if(!locCode.equalsIgnoreCase("All"))
            {
            	sql+= "and a.strLocFrom='"+locCode+"' ";
			...
			+ "select a.dtMISDate TransDate,10 TransNo, 'MIS Out' TransType, a.strMISCode RefNo, 0 Receipt"
			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Issue "
			+ ",c.strLocName Name,b.dblUnitPrice Rate "
//			+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
	...
	clsPropertySetupModel objSetup=objSetupMasterService.funGetObjectPropertySetup(propCode, clientCode);
			...
			if(objSetup.getStrIndustryType().equalsIgnoreCase("Invoice"))
			{
				...
				sql+= " SELECT a.dteInvDate TransDate,13 TransNo, 'Invoice' TransType, a.strInvCode RefNo, 0 Receipt,"
						...
						+ " CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
						+ " FROM  tblinvoicehd a, tblinvoicedtl b, tbllocationmaster c, tblproductmaster d "
						+ " WHERE  a.strInvCode=b.strInvCode AND a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode "
						+ " AND b.strProdCode = '"+prodCode+"' " ;
						if(!locCode.equalsIgnoreCase("All"))
						{
							sql+= " and a.strLocCode='"+locCode+"' ";
						}
						sql+= "AND DATE(a.dteInvDate) >= '"+fromDate+"' AND DATE(a.dteInvDate) <= '"+toDate+"' "
						+ " GROUP BY a.dteInvDate, a.strInvCode, a.strLocCode  ";
			}
			else{
				...
				sql+= " SELECT a.dteDCDate TransDate,13 TransNo, 'Delivery Chal.' TransType, a.strDCCode RefNo, 0 Receipt,"
						...
						+ " CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
						+ " FROM  tbldeliverychallanhd a, tbldeliverychallandtl b, tbllocationmaster c, tblproductmaster d "
						+ " WHERE  a.strDCCode=b.strDCCode AND a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode "
						+ " AND b.strProdCode = '"+prodCode+"' " ;
						if(!locCode.equalsIgnoreCase("All"))
						{
							sql+= " and a.strLocCode='"+locCode+"' ";
						}
						sql+= "AND DATE(a.dteDCDate) >= '"+fromDate+"' AND DATE(a.dteDCDate) <= '"+toDate+"' "
						+ " GROUP BY a.dteDCDate, a.strDCCode, a.strLocCode  ";
						
			}
	
			sql+= "UNION ALL  ";
			sql+="select a.dteSRDate TransDate,14 TransNo, 'SC GRN' TransType, a.strSRCode RefNo, funGetUOM(IFNULL(SUM(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt, "
			    + "0 Issue,c.strLocName Name,b.dblPrice Rate ,CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			    + " from tblscreturnhd a,tblscreturndtl b ,tbllocationmaster c ,tblproductmaster d "
			    + "where a.strSRCode=b.strSRCode and a.strLocCode=c.strLocCode and b.strProdCode= '"+prodCode+"' AND b.strProdCode=d.strProdCode ";
				if(!locCode.equalsIgnoreCase("All"))
				{
					sql+= "and a.strLocCode = '"+locCode+"' ";
				}
			...
			sql+="select a.dteDNDate TransDate,15 TransNo,  'Delivery Note' TransType, a.strDNCode RefNo, 0 Receipt,"
						+ " IFNULL(SUM(b.dblQty),0)  Issue,c.strLocName Name,0 Rate ,CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString " 
						+" from tbldeliverynotehd a,tbldeliverynotedtl b ,tbllocationmaster c,tblproductmaster d	"
...
//		      List listParentProdStkLedger=objGlobalService.funGetList(sql, "sql");
		      ...
		      sql="SELECT b.strChildCode,b.dblQty,a.strParentCode,c.dblRecipeConversion "
		      		+ " ,c.strReceivedUOM,c.strRecipeUOM "
		      		+ " ,c.dblCostRM ,CONCAT_WS('!',c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
		      		+ " from tblbommasterhd a ,tblbommasterdtl b,tblproductmaster c  "
		      		+ " where a.strBOMCode=b.strBOMCode and b.strChildCode='"+prodCode+"' "
		      		+ " and b.strChildCode=c.strProdCode and a.strClientCode=b.strClientCode "
		      		+ " and b.strClientCode=c.strClientCode and c.strClientCode='"+clientCode+"'  ";
		      ...
		      for(int cnt=0;cnt<listChildProdStkLedger.size();cnt++)
		      {
		    	  Object objParent[]=(Object[]) listChildProdStkLedger.get(cnt);
		    		...
		    		sql= "select DATE_FORMAT(a.dtPDDate,'%d-%m-%Y')  TransDate, 'Production' TransType, a.strPDCode RefNo, 0 Receipt, ifnull(sum(b.dblQtyProd),0) Issue"
		    		+ ",c.strLocName Name, (b.dblPrice/ifnull(sum(b.dblQtyProd),1)) Rate "
		    		+ "from tblproductionhd a, tblproductiondtl b, tbllocationmaster c "
		    		+ "where a.strPDCode  = b.strPDCode and a.strLocCode=c.strLocCode "
		    		...
		    		sql= "select DATE_FORMAT(a.dtPDDate,'%d-%m-%Y') TransDate, 'Production' TransType, a.strPDCode RefNo"
		    		+ ",0 Receipt,  funGetUOM(ifnull(sum(b.dblQtyProd),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Issue "			
		    		+ ",c.strLocName Name, (b.dblPrice/ifnull(sum(b.dblQtyProd),1)) Rate "
//		    		+ ", funGetUOM(ifnull(sum(b.dblQtyProd),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
		    		+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString  "
		    		+ " from tblproductionhd a, tblproductiondtl b, tbllocationmaster c, tblproductmaster d "
...
//		      			sql= "SELECT  count(*) from tblbommasterhd a where a.strParentCode='"+prodCode+"' ";
//		      			 List listParentProdStkLedger=objGlobalService.funGetList(sql, "sql");
//		      			 
...
//							
			    		...
			    		sql= "select DATE_FORMAT(a.dtPDDate,'%d-%m-%Y')  TransDate, 'Production' TransType, a.strPDCode RefNo, ifnull(sum(b.dblQtyProd),0) Receipt, 0 Issue"
			    		+ ",c.strLocName Name, (b.dblPrice/ifnull(sum(b.dblQtyProd),1)) Rate ,6 TransNo "
			    		+ "from tblproductionhd a, tblproductiondtl b, tbllocationmaster c "
			    		+ "where a.strPDCode  = b.strPDCode and a.strLocCode=c.strLocCode "
			    		+ "and b.strProdCode = '"+ prodCode+"' ";
			    		if(!locCode.equalsIgnoreCase("All"))
			    		...
			    		+ ",c.strLocName Name, (b.dblPrice/ifnull(sum(b.dblQtyProd),1)) Rate "
//			    		+ ", funGetUOM(ifnull(sum(b.dblQtyProd),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
			    		+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString ,6 TransNo "
			    		+ " from tblproductionhd a, tblproductiondtl b, tbllocationmaster c, tblproductmaster d "
			    		+ "where a.strPDCode  = b.strPDCode and a.strLocCode=c.strLocCode and b.strProdCode=d.strProdCode "
			    		+ "and b.strProdCode = '"+ prodCode+"' ";
			    		if(!locCode.equalsIgnoreCase("All"))
...
//					    }
	...
	private List funCalculateStock(String prodCode, String locCode, String fromDate, String toDate, String qtyWithUOM, Map hmAuthorisedForms, String startDate,HttpServletRequest req,HttpServletResponse resp)
	{
		...
		{
			sql="select DATE_FORMAT(date(TransDate),'%d-%m-%Y'),TransType,RefNo,Receipt,Issue,Name,Rate from ( ";		
			sql+="select a.dtMISDate TransDate,2 TransNo, 'MIS In' TransType, a.strMISCode RefNo, ifnull(sum(b.dblQty),0) Receipt, 0 Issue "
					+ ",c.strLocName Name ,b.dblUnitPrice Rate "
					+ "from tblmishd a, tblmisdtl b ,tbllocationmaster c "
					+ "where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode "
					+ "and b.strProdCode = '"+prodCode+"' ";
					...
					+ "select a.dtGRNDate TransDate,3 TransNo, 'GRN' TransType, a.strGRNCode RefNo, ifnull(sum(b.dblQty-b.dblRejected),0) Receipt, 0 Issue"
					+ ",c.strPName Name,b.dblUnitPrice Rate "
					+ "from tblgrnhd a, tblgrndtl b,tblpartymaster c "
					+ "where a.strGRNCode = b.strGRNCode and a.strSuppCode=c.strPCode "
					+ "and b.strProdCode = '"+prodCode+"' ";
...
//					+ ""
					...
					+ "ifnull(sum(b.dblQty),0) Issue ,c.strLocName Name,d.dblUnitPrice Rate  " 
					+ "from tblsalesreturnhd a, tblsalesreturndtl b, tbllocationmaster c ,tblproductmaster d "
					+ "where a.strSRCode = b.strSRCode and a.strLocCode=c.strLocCode and b.strProdCode=d.strProdCode and "
					+ " b.strProdCode = '"+prodCode+"' ";
		...
		{		
			...
			sql+="select a.dtMISDate TransDate,2 TransNo, 'MIS In' TransType, a.strMISCode RefNo"
					+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt "
					+ ", 0 Issue ,c.strLocName Name "
					+ ",b.dblUnitPrice Rate"
//					+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
					...
					+ "select a.dtCreatedDate TransDate,1 TransNo, 'Opening Stk' TransType, a.strOpStkCode RefNo"
					+ ", funGetUOM(ifnull(sum(b.dblQty),0),c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) Receipt, 0 Issue"
					+ ",'Opening Stock' Name,dblCostPerUnit Rate"
//					+ ", funGetUOM(ifnull(sum(b.dblQty),0),c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
					+ ", CONCAT_WS('!',c.dblRecipeConversion,c.dblIssueConversion,c.strReceivedUOM,c.strRecipeUOM) UOMString "
					...
					+ "select a.dtGRNDate TransDate,3 TransNo, 'GRN' TransType, a.strGRNCode RefNo"
					+ ", funGetUOM(ifnull(sum(b.dblQty-b.dblRejected),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) Receipt, 0 Issue "
					+ ",c.strPName Name,b.dblUnitPrice Rate "
//					+ ", funGetUOM(ifnull(sum(b.dblQty),0),d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
					+ ", CONCAT_WS('!',d.dblRecipeConversion,d.dblIssueConversion,d.strReceivedUOM,d.strRecipeUOM) UOMString "
					+ " from tblgrnhd a, tblgrndtl b,tblpartymaster c, tblproductmaster d "
...
//					    }
	...
	public Map<String,ArrayList<Object>> funCalculateStockForTrans(String prodCode,String locCode,String fromDate,String toDate,String clientCode,String transType, String startDate)
	{
		...
		switch(transType)
		{
			case "OPSTK":
				trans="Receipt";
				sql="select a.strOpStkCode,date(a.dtCreatedDate),sum(b.dblQty) "
					+ "from clsInitialInventoryModel a,clsOpeningStkDtl b "
					+ "where a.strOpStkCode=b.strOpStkCode and b.strProdCode='"+prodCode+"' "
					+ "and date(a.dtCreatedDate) between '"+startDate+"' and '"+toDate+"' ";
					if(!locCode.equalsIgnoreCase("All"))
		            {
		            	sql+= "and a.strLocCode='"+locCode+"' ";
			        }
			...
			case "GRN":
				trans="Receipt";
				sql="select a.strGRNCode,date(a.dtGRNDate),sum(b.dblQty-b.dblRejected) "
			...
			case "StkAdjIn":
				trans="Receipt";
				sql="select a.strSACode,date(a.dtSADate),sum(b.dblQty) "
			...
			case "StkTransIn":
				trans="Receipt";
				sql="select a.strSTCode,date(a.dtSTDate),sum(b.dblQty) "
			...
			case "MaterialReturnIn":
				trans="Receipt";
				sql="select a.strMRetCode,date(a.dtMRetDate),sum(b.dblQty) "
			...
			case "Production":
				trans="Receipt";
				sql="select a.strPDCode,date(a.dtPDDate),sum(b.dblQtyProd) "
			...
			case "PurchaseReturn":
				trans="Issue";
				sql="select a.strPRCode,date(a.dtPRDate),sum(b.dblQty) "
			...
			case "MISIn":
				trans="Receipt";
				flgQueryType="sql";
				sql="select a.strMISCode,date(a.dtMISDate),sum(b.dblQty) "
	...
	/*private ModelAndView funGetModelAndView1()
	{
		ModelAndView objModelView=new ModelAndView("frmStockLedgerFromStockFlash");
		
		Map<String, String> mapProperty= objGlobalService.funGetPropertyList("001");
		if(mapProperty.isEmpty())
		{
			mapProperty.put("", "");
		}
		objModelView.addObject("listProperty",mapProperty);
		Map<String, String> mapLocation= objGlobalService.funGetLocationList("001");
		if(mapLocation.isEmpty())
		{
			mapLocation.put("", "");
		}
	...
	private ModelAndView funExportStockLedger(@RequestParam(value="param1") String param1,
			@RequestParam(value="fDate") String fDate,@RequestParam(value="tDate") String tDate,
			HttpServletRequest req,HttpServletResponse resp)
	{
...
//		}
		...
		if(qtyWithUOM.equals("No"))
		{
			...
			*/
			...
			+ "select a.dtGRNDate TransDate,2 TransNo, 'GRN' TransType, a.strGRNCode RefNo, ifnull(sum(b.dblQty-b.dblRejected),0) Receipt, 0 Issue"
			+ ",c.strPName Name,b.dblUnitPrice Rate "
			+ "from tblgrnhd a, tblgrndtl b,tblpartymaster c "
			+ "where a.strGRNCode = b.strGRNCode and a.strSuppCode=c.strPCode "
			+ "and b.strProdCode = '"+prodCode+"' ";
...
//			DataList.add(arrObj[4].toString());//5
		   //	var cells1=tableRows[cnt].cells;
	    	...
	    	String finalBal="";
	    	double rate1=0.0;
	    	//double rate=parseFloat(rate1.substring(7,rate1.lastIndexOf("<")));
...
//	        	{
//	        		Double balWithUOM=Double.parseDouble(spBalance[1])*Double.parseDouble(recipeConv)*Double.parseDouble(issueConv);
	   			...
	   			if(listObj.get(1).toString().equals("Opening Stk"))	
	   			{
		   			...
		   			}else
		   			{
		   				...
		   				if(op.contains("."))
		   				{
		   					...
		   					//String restQty=new Double(dblshowBal-Integer.parseInt(arrAry[0]) ).toString();
		   			...
		   			if(rec.equals("0"))
		   		   	{
		   				...
		   				{ 
			   				...
			   				//	String restQty=new Double(dblRec-Integer.parseInt(arrAry[0]) ).toString();
...
//	   			String [] recArr=rec.split("");
	...
	private String funGetDispalyUOMQty(String strProdCode,double dblQty,String clientCode)
	{
		...
		}else
		{
			...
			strDispQty = spqty[0] +" "+objProdModel.getStrReceivedUOM()+"."+ 
					qtytemp+" "+objProdModel.getStrRecipeUOM();
		}
