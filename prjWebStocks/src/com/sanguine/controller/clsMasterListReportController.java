...
//				String selectedModuleNo=request.getSession().getAttribute("moduleNo").toString();
//				String masterSql="select strFormDesc from tbltreemast where strRootNode='Master' and strModule='"+selectedModuleNo+"' ";
//				
//				List listMasterName=  objGlobalFunctionsService.funGetDataList(masterSql, "sql");	
//				model.put("moduleName", listMasterName);
			...
			public  void funCallMasterList( String fromDate,String toDate,String tblName,HttpServletRequest req,HttpServletResponse res) {
	          ...
	          String MasterSql="select\t"+ code+" as code,"+Name+" as Name, date(dtCreatedDate) as CreateDate from "+tblName+" a where a.strClientCode='"+clientCode+"' and  "
	        		  		  +"date(a.dtCreatedDate) between'"+fromDate+"'and'"+toDate+"'";
