...
public class clsRequisitionServiceImpl implements clsRequisitionService{
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public List<clsRequisitionDtlModel> funGetDtlList(String reqCode,
			String clientCode) {
	...
	{
		objReqDao.funDeleteProductStandard(clientCode);
	}
	...
	{
		return objReqDao.funGetProductStandartList(clientCode);
	}
