...
public class clsMISServiceImpl implements clsMISService{
	...
	@Override
	public List funMISforMRDetails(String strLocFrom,
			String strLocTo,String strClientCode) {
		
		return objMISDao.funMISforMRDetails( strLocFrom,
				strLocTo,strClientCode);
	}
