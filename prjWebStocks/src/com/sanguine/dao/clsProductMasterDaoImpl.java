...
public class clsProductMasterDaoImpl implements clsProductMasterDao
{
	...
	{
		String hql="from clsProdSuppMasterModel a,clsSupplierMasterModel b "
				+ "where a.strProdCode= :prodCode and a.strSuppCode=b.strPCode and a.strClientCode= :clientCode";		
		Query query = sessionFactory.getCurrentSession().createQuery(hql);
		query.setParameter("prodCode", prodCode);
		query.setParameter("clientCode", clientCode);
		List list = query.list();
	...
	{
		String hql="from clsProdAttMasterModel a,clsAttributeMasterModel b "
				+ "where a.strProdCode= :prodCode and a.strAttCode=b.strAttCode and a.strClientCode= :clientCode";
		Query query = sessionFactory.getCurrentSession().createQuery(hql);
		query.setParameter("prodCode", prodCode);
		query.setParameter("clientCode", clientCode);
		List list = query.list();
	...
	{
		String hql="from clsProductReOrderLevelModel a,clsLocationMasterModel b "
				+ "where a.strProdCode= :prodCode and a.strLocationCode=b.strLocCode and a.strClientCode= :clientCode and b.strClientCode= :clientCode";
		Query query = sessionFactory.getCurrentSession().createQuery(hql);
		query.setParameter("prodCode", prodCode);
		query.setParameter("clientCode", clientCode);
		List list = query.list();
	...
	{
		String hql="from clsProdProcessModel a,clsProcessMasterModel b "
				+ "where a.strProdProcessCode= :prodCode and a.strProcessCode=b.strProcessCode and a.strClientCode= :clientCode";
		Query query = sessionFactory.getCurrentSession().createQuery(hql);
		query.setParameter("prodCode", prodCode);
		query.setParameter("clientCode", clientCode);
		List list = query.list();
	...
	{
		String hql="from clsAttributeMasterModel a,clsAttributeValueMasterModel b "
				+ "where a.strAttCode = :attCode and a.strAttCode=b.strAttCode and a.strClientCode= :clientCode";
		Query query=sessionFactory.getCurrentSession().createQuery(hql);
	...
	{
		sessionFactory.getCurrentSession().save(objProdReOrderModel);
	}
	...
	{
		String sql="from clsProdSuppMasterModel where strProdCode=:prodCode "
	...
	{ 
		Query query = sessionFactory.getCurrentSession().createQuery("select a.strProdCode, a.strProdName,c.strSGName,"
				+ "a.strUOM,a.dblCostRM,a.dblCostManu,a.dblListPrice,a.strLocCode,a.strSpecification,a.strBinNo "
				+ "from clsProductMasterModel a , clsLocationMasterModel b , clsSubGroupMasterModel c"
				+ " where a.strLocCode=b.strLocCode and a.strSGCode=c.strSGCode and a.strClientCode= :clientCode ");
	...
	{ 
		Query query = sessionFactory.getCurrentSession().createQuery("from clsProductMasterModel a ,clsProdSuppMasterModel b "
	...
	@Override
	public List<String> funGetTaxIndicator(String propertyCode,
			String clientCode) {
	...
	public clsProductMasterModel funGetImportedPOSItem(String strPartNo,String strProdName,String strClientCode,String sGCode ,String locCode)
	{
		List list = null;
		try{
			String sql="from clsProductMasterModel where strPartNo=:partNo and strProdName=:prodName and strSGCode=:sGCode and strLocCode=:locCode "
					+ " and strClientCode=:clientCode";
			Query query=sessionFactory.getCurrentSession().createQuery(sql);
	...
	{
		String sql="from clsProductMasterModel where strBarCode=:barCode "
				+ "and strClientCode=:clientCode";
		Query query=sessionFactory.getCurrentSession().createQuery(sql);
...
//					+ " and strCharCode='"+charCode+"' and strProcessCode='"+processCode+"' "
	...
	{
		//List<clsProdCharMasterModel> listProdCharModel=new ArrayList<clsProdCharMasterModel>();
		String sql="from clsProdCharMasterModel where strProdCode=:prodCode "
				+ "and strClientCode=:clientCode";
		Query query=sessionFactory.getCurrentSession().createQuery(sql);
		query.setParameter("prodCode",prodCode);
		query.setParameter("clientCode",clientCode);
...
//		}
	...
	public List funGetAllProduct(String clientCode)
	{
		Query query = sessionFactory.getCurrentSession().createQuery(""
				+ "from clsProductMasterModel a where a.strClientCode= :clientCode ");
	...
	{
		String sql="select a.strProdCode,a.dblLastCost,a.dblMargin,a.dblStandingOrder from tblprodsuppmaster a,tblproductmaster b "
				+ "where a.strSuppCode='"+suppCode+"' and a.strClientCode= '"+clientCode+"' and a.strProdCode=b.strProdCode order by b.strProdName ";		
	 ...
	 public List funGetProdSuppDtl(String prodCode,String strCustCode,String clientCode)
		{
			String sql="select a.strProdCode,a.dblLastCost,a.dblMargin from tblprodsuppmaster a "
					+ "where a.strSuppCode='"+strCustCode+"' and a.strProdCode='"+prodCode+"'and a.strClientCode= '"+clientCode+"' ";		
			List list = sessionFactory.getCurrentSession().createSQLQuery(sql).list();
		...
		{
			Query query = sessionFactory.getCurrentSession().createQuery(""
					+ "from clsProductMasterModel a where a.strClientCode= :clientCode and a.strProdType<> 'Procured' ");
		...
		{
			String hql="from clsProductMasterModel a "
					+ "where a.strNonStockableItem= :strNonStockableItem and  a.strClientCode= :clientCode";		
			Query query = sessionFactory.getCurrentSession().createQuery(hql);
			query.setParameter("strNonStockableItem", "Yes");
			query.setParameter("clientCode", clientCode);
			List list = query.list();
			return (List<clsProductMasterModel>)list;
		}
		...
		{
			String hql="from clsProductMasterModel a "
					+ "where a.strSGCode= :strSGCode and  a.strClientCode= :clientCode";		
			Query query = sessionFactory.getCurrentSession().createQuery(hql);
		...
		{
			String hql="from clsProductMasterModel a,clsSubGroupMasterModel b "
					+ "where a.strSGCode= b.strSGCode and b.strSGName = :strSGName and  a.strClientCode= :clientCode and  b.strClientCode= :clientCode ";		
			Query query = sessionFactory.getCurrentSession().createQuery(hql);
