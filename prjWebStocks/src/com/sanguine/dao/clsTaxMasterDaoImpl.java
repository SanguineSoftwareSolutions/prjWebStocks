...
public class clsTaxMasterDaoImpl implements clsTaxMasterDao
{
	...
	public clsTaxHdModel funGetObject(String code,String clientCode) {
		// TODO Auto-generated method stub
		//return (clsTaxHdModel) sessionFactory.getCurrentSession().get(clsTaxHdModel.class, new clsTaxHdModel_ID(code,clientCode));
	...
	{
		Query query = sessionFactory.getCurrentSession().createSQLQuery("select a.strTaxCode,a.strTaxDesc from tbltaxhd a "
				+ " where a.strClientCode='"+clientCode+"' and a.strTaxCode<> '"+taxCode+"'");
		@SuppressWarnings("rawtypes")
		List list = query.list();
		return list;
	...
	{
		Query query = sessionFactory.getCurrentSession().createSQLQuery("select a.strSGCode,a.strSGName "
			+ " from tblsubgroupmaster a where a.strClientCode='"+clientCode+"' ");
		@SuppressWarnings("rawtypes")
		List list = query.list();
		return list;
