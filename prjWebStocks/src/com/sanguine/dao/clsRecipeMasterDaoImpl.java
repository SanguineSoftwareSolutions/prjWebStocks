...
public class clsRecipeMasterDaoImpl implements clsRecipeMasterDao
{
	...
	public List<clsBomHdModel> funGetList(String bomCode,String clientCode)
	{
		// TODO Auto-generated method stub
		/*
		Query query = sessionFactory.getCurrentSession().createQuery("from clsBomHdModel where strBOMCode = :bomCode and strClientCode= :clientCode");
		query.setParameter("bomCode", bomCode);
		query.setParameter("clientCode", clientCode);
		List list = query.list();
		return (List<clsBomHdModel>) list;*/
	...
	public clsBomHdModel funGetObject(String bomCode,String clientCode) 
	{
		...
		query.setParameter("bomCode", bomCode);
		query.setParameter("clientCode", clientCode);
		return (clsBomHdModel)query.list();*/
	...
	{
		// TODO Auto-generated method stub
		String hql="from clsBomDtlModel a, clsProductMasterModel b "
				+ "where a.strBOMCode = :bomCode and a.strChildCode=b.strProdCode and a.strClientCode= :clientCode";
	...
	{
		//String sql="select a.strBOMCode from tblbommasterhd a where a.strParentCode='"+strParentCode+"' and a.strClientCode='"+strClientCode+"'";
		
		String hql="from clsBomHdModel a "
	...
	public List funGetBOMDtl(String strClientCode, String BOMCode)
	{
		...
		String hql="from clsBomDtlModel a "
				+ "where a.strClientCode= :clientCode and strBOMCOde= :bomCode";
