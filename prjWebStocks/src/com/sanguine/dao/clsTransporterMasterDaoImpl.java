...
public class clsTransporterMasterDaoImpl implements clsTransporterMasterDao {
		...
		{
			Query query = sessionFactory.getCurrentSession().createSQLQuery("delete from tbltransportermasterdtl "
					+ " where strTransCode='"+transCode+"' and strClientCode='"+clientCode+"' ");
			query.executeUpdate();
		}
