...
{	
    ...
    public List funGetDoc(String code,String fileNo,String clientCode) 
    {
        ...
        Query query = sessionFactory.getCurrentSession().createQuery("from clsAttachDocModel where strCode = :docCode and intId = :intId"
    ...
    {
    	Query query = sessionFactory.getCurrentSession().createQuery("Delete clsAttachDocModel "
    			+ "where strCode = :docCode and strActualFileName = :strActualFileName and strClientCode= :strClientCode");
...
//		Query query = sessionFactory.getCurrentSession().createQuery("delete clsMISDtlModel where strMISCode = :MISCode");
