...
public class clsStkPostingDaoImpl implements clsStkPostingDao
{
	...
	{
		Query query = sessionFactory.getCurrentSession().createQuery("from clsStkPostingHdModel a,clsLocationMasterModel b "
				+ "where a.strPSCode= :psCode and a.strLocCode=b.strLocCode and a.strClientCode= :clientCode and b.strClientCode= :clientCode");
	...
	{ 
		Query query = sessionFactory.getCurrentSession().createQuery("from clsStkPostingDtlModel a,clsProductMasterModel b "
				+ "where a.strPSCode = :psCode and a.strProdCode=b.strProdCode and a.strClientCode= :clientCode and b.strClientCode= :clientCode");
		query.setParameter("psCode", PSCode);
		query.setParameter("clientCode", clientCode);
		List list = query.list();
		return list;
	...
	@Override
	public clsStkPostingHdModel funGetModelObject(String strphyStkpostCode,
			String clientCode) 
	{
