...
public class clsManufactureMasterDaoImpl implements clsManufactureMasterDao{
	...
	@Override
	public clsManufactureMasterModel funGetObject(String strCode,
			String clientCode) {
		List list = new ArrayList();
		try{
			Query query = sessionFactory.getCurrentSession().createQuery("from clsManufactureMasterModel where strManufacturerCode = '"
