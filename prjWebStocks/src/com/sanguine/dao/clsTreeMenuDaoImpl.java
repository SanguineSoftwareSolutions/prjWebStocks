...
public class clsTreeMenuDaoImpl implements clsTreeMenuDao{
	...
	public List<clsTreeMasterModel> funGetMenuForm() {
		...
		String sql= "select strFormDesc,strType,strRequestMapping from clsTreeMasterModel where strModule='"+moduleCode+"'";
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<clsTreeRootNodeItemUtil> getRootNodeItems(String userCode,
			String clientCode, String rootNode ) {
		...
		String sql="select * from (select a.strFormDesc,a.strRequestMapping,a.strRootNode,a.strType,a.intFormNo "
				+ "from tbltreemast a ,tbluserdtl b where a.strFormName=b.strFormName and b.strUserCode='"+userCode+"' and b.strClientCode='"+clientCode
				+ "' and a.strRootNode='"+rootNode+"' and a.strModule='"+moduleCode+"' UNION ALL select a.strFormDesc,"
				+ "a.strRequestMapping,a.strRootNode,a.strType,a.intFormNo from tbltreemast a "
				+ "where a.strtype = 'O' and a.strRootNode='"+rootNode+"' and a.strModule='"+moduleCode+"' ) as a ORDER BY a.intFormNo";
	...
	public List<clsTreeRootNodeItemUtil> getRootNodeItems(String rootNode) {
		...
		String sql="select a.strFormDesc,a.strRequestMapping,a.strRootNode,a.strType from tbltreemast a where a.strRootNode='"+rootNode+"' and a.strModule='"+moduleCode+"' order by a.intFormNo";
		List<clsTreeRootNodeItemUtil> objTreeNode =(List<clsTreeRootNodeItemUtil>) sessionFactory.getCurrentSession().createSQLQuery(sql).list();
		return objTreeNode;
	}
	...
	public List<clsUserDesktopUtil> funGetForms() {	
		...
		String sql="select a.strFormName,a.strFormDesc,a.strImgName,a.strRequestMapping "
				+ "from tbltreemast a where a.strModule='"+moduleCode+"' and a.strRequestMapping <>'' ";
	...
	public List<clsUserDesktopUtil> funGetForms(String userCode,String clientCode) {
		...
		String sql="select a.strFormName,b.strFormDesc,b.strImgName,b.strRequestMapping "
				+ "from tbluserdtl a,tbltreemast b where a.strFormName=b.strFormName and b.strModule='"+moduleCode+"' "
	...
	public List<clsUserDesktopModel> getUserDesktopForm(String userCode) {
		...
		String sql="select b.strusercode,a.strformname from tbltreemast a,tbluserdesktop b "
				+ "where strUserCode='"+userCode+"' and b.strformname=a.strformname and a.strModule='"+moduleCode+"'";
	...
	public List<clsUserDesktopUtil> funGetDesktopForms(String userCode) {
		...
		String sql="select a.strFormName,a.strFormDesc,a.strImgName,a.strRequestMapping "
				+ "from tbltreemast a,tbluserdesktop b where a.strFormName=b.strformname and a.strModule='"+moduleCode+"' and b.strusercode='"+userCode+"'  ";
		List<clsUserDesktopUtil> objDesktopItem=sessionFactory.getCurrentSession().createSQLQuery(sql).list();
	...
	public List<clsUserDesktopUtil> funGetDesktopForms(String userCode,String clientCode) {
		...
		String sql="select a.strFormName,b.strFormDesc,b.strImgName,b.strRequestMapping "
				+ "from tbluserdtl a,tbltreemast b,tbluserdesktop c where a.strFormName=b.strFormName and b.strModule='"+moduleCode+"' and a.strUserCode=c.strusercode and b.strFormName=c.strformname and a.strUserCode='"+userCode+"' "
				+ "and a.strClientCode='"+clientCode+"'  and c.strusercode='"+userCode+"' ";
