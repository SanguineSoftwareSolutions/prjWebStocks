...
public class clsPurchaseIndentHdDaoImpl implements clsPurchaseIndentHdDao 
{
	...
	@Override
	public clsPurchaseIndentHdModel funGetPurchaseIndent(
			String PurchaseIndentCode) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List funGetDtlList(String PICode,String clientCode,String strLocCode) 
	{
		...
		String sql="from clsPurchaseIndentDtlModel a,clsProductMasterModel b,clsProductReOrderLevelModel c "
				+ "where a.strPICode = :PICode and a.strProdCode=b.strProdCode and b.strProdCode=c.strProdCode "
				+ "and c.strProdCode=a.strProdCode and c.strLocationCode=:strLocCode and c.strClientCode= :clientCode "
	...
	@SuppressWarnings({"rawtypes" })
	@Override
	public clsProductReOrderLevelModel funGetReOrderLevel(String strProdCode, String strLocCode,
			String clientCode) {
