...
public class clsStockDaoImpl implements clsStockDao
{
	...
	{
		String sql="delete clsOpeningStkDtl where strOpStkCode=:opStkCode "
	...
	{
		//return (clsInitialInventoryModel) sessionFactory.getCurrentSession().get(clsInitialInventoryModel.class, code);
		String sql="select a.strOpStkCode,a.strLocCode,b.strLocName,a.dtExpDate,a.dtCreatedDate,a.dtLastModified,a.strUserCreated,a.strUserModified,a.strConversionUOM "
				+ "from clsInitialInventoryModel a,clsLocationMasterModel b "
				+ "where a.strOpStkCode=:opStkCode "
				+ "and a.strLocCode=b.strLocCode and a.strClientCode=:clientCode and b.strClientCode=:clientCode";
		Query query=sessionFactory.getCurrentSession().createQuery(sql);
	...
	{
		String sql="select a.strProdCode,b.strProdName,a.dblQty,a.strUOM,a.dblCostPUnit,a.dblRevLvl"
				+ ",a.strLotNo,a.strDisplyQty,a.dblLooseQty "
				+ "from clsOpeningStkDtl a,clsProductMasterModel b "
				+ "where a.strOpStkCode=:opStkCode "
				+ "and a.strProdCode=b.strProdCode and a.strClientCode=:clientCode and b.strClientCode=:clientCode";
		Query query=sessionFactory.getCurrentSession().createQuery(sql);
		query.setParameter("opStkCode", code);
		query.setParameter("clientCode", clientCode);
		List list=query.list();
	...
	public List funInitialInventoryReport(String clientCode)
	{
		...
		Query query=sessionFactory.getCurrentSession().createQuery("from clsInitialInventoryModel a , clsProductMasterModel b, clsLocationMasterModel c "
				+ "where a.strProdCode=b.strProdCode and a.strLocCode =c.strLocCode and a.strClientCode =:clientCode and b.strClientCode=:clientCode and c.strClientCode=:clientCode ");
