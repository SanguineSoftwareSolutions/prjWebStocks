...
public class clsPurchaseOrderDaoImpl implements clsPurchaseOrderDao{
	...
	@Override
	public void funAddUpdatePurchaseOrderHd(
			clsPurchaseOrderHdModel PurchaseOrderHdModel) {
		sessionFactory.getCurrentSession().saveOrUpdate(PurchaseOrderHdModel);
		
	}

	@Override
	public void funAddUpdatePurchaseOrderDtl(
			clsPurchaseOrderDtlModel PurchaseOrderDtlModel) {
	...
	{	
		String sql="select a.strProdCode,a.dblOrdQty,a.dblPrice,a.dblWeight,a.strProdChar,a.strRemarks,a.strPICode,"
				+ " a.dblDiscount,a.strAmntNO,a.strUpdate,a.dtDelDate,c.strProdName,c.strUOM,c.dblCostRM,d.strPCode,d.strPName,a.dblAmount "
				+ " from clsPurchaseOrderDtlModel a,clsPurchaseOrderHdModel b,clsProductMasterModel c,clsSupplierMasterModel d "
				+ " where a.strPOCode=:POCode and a.strPOCode=b.strPOCode and b.strSuppCode=d.strPCode "
				+ " and a.strProdCode=c.strProdCode and a.strClientCode=:clientCode and b.strClientCode=:clientCode"
	...
	public List funGetHelpdataPIforPo(String clientCode,String strPropCode) {
		...
		String sql="select a.strPICode, date(a.dtPIDate),b.strLocName,a.strNarration "
			+ "from tblpurchaseindendhd a,tbllocationmaster b where strPICode IN "
			+ "(select a.strPICode from tblpurchaseindenddtl a left outer join "
			+ "(select b.strPICode, b.strProdCode,sum(dblOrdQty) POQty "
			...
			+ " and a.strLocCode=b.strLocCode and a.strClientCode='"+clientCode+"' "
	...
	@Override
	public List<clsPurchaseOrderDtlModel> funGetPODtlList(String strPOCode,
			String clientCode) {
	...
	public List funGetHdList(String fDate,String tDate,String clientCode)
	 {
		 String hql=" from  clsPurchaseOrderHdModel   where dtPODate between :fDate and :tDate "
