...
public class clsProductionOrderDaoImpl implements clsProductionOrderDao{
	...
	@Override
	public void funAddUpdateProductionHd(
			clsProductionOrderHdModel ProductionOrderHdModel) {
	...
	@Override
	public void funAddUpdateProductionDtl(
			clsProductionOrderDtlModel ProductionOrderDtlModel) {
	...
	@Override
	public List<clsProductionOrderDtlModel> funGetDtlList(String OPCode,
			String clientCode) {
