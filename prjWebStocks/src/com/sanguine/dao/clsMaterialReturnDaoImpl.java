...
public class clsMaterialReturnDaoImpl implements clsMaterialReturnDao
{
	...
	{
		Query query = sessionFactory.getCurrentSession().createQuery("delete clsMaterialReturnDtlModel where strMRetCode = :MRCode "
	...
	{
		Query query = sessionFactory.getCurrentSession().createQuery("from clsMaterialReturnHdModel  "
				+ "where strMRetCode= :mrCode and strClientCode= :clientCode");
		query.setParameter("mrCode", MRCode);
		query.setParameter("clientCode", clientCode);
		return query.list();
	}
	...
	{
		Query query = sessionFactory.getCurrentSession().createQuery("from clsMaterialReturnDtlModel "
				+ "where strMRetCode = :mrCode and strClientCode= :clientCode");
		query.setParameter("mrCode", MRCode);
		query.setParameter("clientCode", clientCode);
