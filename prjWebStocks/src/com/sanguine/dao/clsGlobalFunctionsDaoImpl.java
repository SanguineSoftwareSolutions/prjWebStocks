...
//	private SessionFactory CRMSessionFactory;
	...
	try
	{
	    String hql_query = "select new com.sanguine.bean.clsSecurityShellBean (frmTable.strFormName, frmTable.strFormDesc" + ", userTable.strAdd, userTable.strEdit , userTable.strDelete , userTable.strView " + ", userTable.strPrint , userTable.strGrant , userTable.strAuthorise , userTable.strFormType " + ", userTable.strDesktop) " + " from clsTreeMasterModel as frmTable ,clsSecurityShellMasterModel as userTable " + " where userTable.strUserCode =  '" + usercode + "'" + " and frmTable.strFormName = userTable.strFormName ";
