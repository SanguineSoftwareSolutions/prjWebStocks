...
//				+" ('frmStockLedgerReportCRM', 'Stock Ledger', 'SuB Contracting Report', 3, 'R', 83, 8, '1', 'default.png', '6', 1, '1', '1', 'NO', 'NO', 'frmStockLedgerReportCRM.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
		...
		/*----------------CRM Forms Only---------------------------*/	
			...
			sql=" CREATE TABLE IF NOT EXISTS `tbldeliverychallandtl` ( `strDCCode` varchar(15) NOT NULL, "
			...
			sql=" CREATE TABLE IF NOT EXISTS `tbldeliverychallanhd` ( "
					+ "  `strDCCode` varchar(15) NOT NULL,  `intid` bigint(20) NOT NULL, "
					+ " `dteDCDate` date NOT NULL DEFAULT '1900-01-01',  `strAgainst` varchar(20) NOT NULL DEFAULT '', "
					+ " `strSOCode` varchar(15) NOT NULL DEFAULT '',  `strCustCode` varchar(10) NOT NULL DEFAULT '', "
					+ " `strPONo` varchar(50) NOT NULL DEFAULT '', "
					+ " `strNarration` varchar(300) NOT NULL DEFAULT '',  `strPackNo` varchar(20) NOT NULL DEFAULT '', "
					+ " `strLocCode` varchar(15) NOT NULL DEFAULT '',  `strVehNo` varchar(20) NOT NULL DEFAULT '', "
					+ " `strMInBy` varchar(50) NOT NULL DEFAULT '',  `strTimeInOut` varchar(10) NOT NULL DEFAULT '', "
					+ " `strUserCreated` varchar(10) NOT NULL,  `dteCreatedDate` date NOT NULL DEFAULT '1900-01-01', "
					+ " `strUserModified` varchar(10) NOT NULL,  `dteLastModified` date NOT NULL DEFAULT '1900-01-01',  "
					+ " `strAuthorise` varchar(2) NOT NULL DEFAULT 'N',  `strDktNo` varchar(50) NOT NULL DEFAULT '', "
					+ "  `strSAdd1` varchar(50) NOT NULL DEFAULT '',  `strSAdd2` varchar(50) NOT NULL DEFAULT '', "
					+ " `strSCity` varchar(50) NOT NULL DEFAULT '',  `strSState` varchar(50) NOT NULL DEFAULT '', "
					+ " `strSCtry` varchar(50) NOT NULL DEFAULT '',  `strSPin` varchar(50) NOT NULL DEFAULT '', "
					+ " `strDCNo` varchar(50) NOT NULL DEFAULT '',  `strReaCode` varchar(15) NOT NULL DEFAULT '', "
					+ " `strSerialNo` varchar(50) NOT NULL DEFAULT '',  `strWarrPeriod` varchar(50) NOT NULL DEFAULT '', "
					+ " `strWarraValidity` varchar(50) NOT NULL DEFAULT '',  `strClientCode` varchar(20) NOT NULL, "
					+ "  PRIMARY KEY (`strDCCode`,`strClientCode`)) "
					+ " ENGINE=InnoDB DEFAULT CHARSET=latin1; ";
			funExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tbldeliverynotedtl` ( "
					+ " `intId` bigint(20) NOT NULL AUTO_INCREMENT,  `strDNCode` varchar(50) NOT NULL, "
					+ " `strProdCode` varchar(50) NOT NULL,  `strProcessCode` varchar(50) NOT NULL DEFAULT '', "
					+ " `dblQty` decimal(18,4) NOT NULL DEFAULT '0.0000',  `dblWeight` decimal(18,4) NOT NULL DEFAULT '0.0000', "
					+ " `dblRate` decimal(18,4) NOT NULL DEFAULT '0.0000',  `strProdChar` varchar(100) NOT NULL DEFAULT '', "
					+ " `strRemarks` varchar(1000) NOT NULL DEFAULT '', "
					+ " `strClientCode` varchar(50) NOT NULL,  PRIMARY KEY (`intId`)) "
					+ "ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=latin1; ";						
			funExecuteQuery(sql);
			
			sql =" CREATE TABLE IF NOT EXISTS `tbldeliverynotehd` ( "
					+ " `strDNCode` varchar(50) NOT NULL,  `intId` bigint(20) NOT NULL DEFAULT '0', "
					+ " `strTypeAgainst` varchar(10) NOT NULL DEFAULT '',  `strTypeCode` varchar(50) NOT NULL DEFAULT 'Enquiry', "
					+ " `dteDNDate` date NOT NULL,  `strDNType` varchar(50) NOT NULL DEFAULT 'GRN',"
					+ " `strGRNCode` varchar(50) NOT NULL DEFAULT '', `strJACode` varchar(50) NOT NULL, "
					+ " `strSCCode` varchar(50) NOT NULL,  `strFrom` varchar(50) NOT NULL DEFAULT '', "
					+ " `strLocCode` varchar(50) NOT NULL DEFAULT '',  `strSCAdd1` varchar(50) NOT NULL DEFAULT '', "
					+ " `strSCAdd2` varchar(50) NOT NULL DEFAULT '',  `strSCCity` varchar(50) NOT NULL DEFAULT '',"
					+ "  `strSCState` varchar(50) NOT NULL DEFAULT '',  `strSCCountry` varchar(50) NOT NULL DEFAULT '', "
					+ " `strSCPin` varchar(20) NOT NULL DEFAULT '',  `strFAdd1` varchar(50) NOT NULL DEFAULT '', "
					+ " `strFAdd2` varchar(50) NOT NULL DEFAULT '',  `strFCity` varchar(50) NOT NULL DEFAULT '', "
					+ " `strFState` varchar(50) NOT NULL DEFAULT '',  `strFCountry` varchar(50) NOT NULL DEFAULT '', "
					+ " `strFPin` varchar(20) NOT NULL DEFAULT '',  `dteExpDate` date NOT NULL, "
					+ " `strVehNo` varchar(1000) NOT NULL DEFAULT '',  `strNarration` varchar(200) NOT NULL DEFAULT '', "
					+ " `strMInBy` varchar(50) NOT NULL DEFAULT '',  `strTimeInOut` varchar(1000) NOT NULL DEFAULT '', "
					+ " `dblTotal` decimal(18,4) NOT NULL DEFAULT '0.0000',  `strExpDet` varchar(5) NOT NULL DEFAULT 'No', "
					+ " `strAuthorise` char(5) NOT NULL DEFAULT 'No',  `strUserCreated` varchar(50) NOT NULL, "
					+ " `dteCreatedDate` datetime NOT NULL,  `strUserModified` varchar(10) NOT NULL, "
					+ " `dteLastModified` datetime NOT NULL,  `strClientCode` varchar(50) NOT NULL DEFAULT '',"
					+ "  PRIMARY KEY (`strDNCode`,`strClientCode`)) ENGINE=InnoDB DEFAULT CHARSET=latin1; ";					
			funExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblsalesorderbom` ( "
					+ " `intId` bigint(20) NOT NULL AUTO_INCREMENT,  `strSOCode` varchar(20) NOT NULL, "
					+ " `strProdCode` varchar(20) NOT NULL,  `strProcessCode` varchar(20) NOT NULL, "
					+ " `strParentCode` varchar(20) NOT NULL,  `strParentProcessCode` varchar(20) NOT NULL, "
					+ " `strChildCode` varchar(20) NOT NULL,  `dblQty` decimal(18,4) NOT NULL DEFAULT '0.0000',  "
					+ "`dblWeight` decimal(18,4) NOT NULL DEFAULT '0.0000',  `intIndex` int(11) NOT NULL DEFAULT '0', "
					+ " `strRemarks` varchar(250) NOT NULL DEFAULT '',  `strUserCreated` varchar(20) NOT NULL,"
					+ "  `dteDateCreated` datetime NOT NULL,  `strUserModified` varchar(20) NOT NULL, "
					+ " `dteLastModified` datetime NOT NULL,  `strClientCode` varchar(20) NOT NULL, "
					+ " PRIMARY KEY (`intId`)) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1; ";
			funExecuteQuery(sql);
			
			sql="CREATE TABLE IF NOT EXISTS `tblsalesorderdtl` ( "
					+ " `strSOCode` varchar(15) NOT NULL,  `strProdCode` varchar(15) NOT NULL DEFAULT '', "
					+ " `dblQty` decimal(18,2) NOT NULL DEFAULT '0.00',  "
					+ "`dblDiscount` decimal(18,2) NOT NULL DEFAULT '0.00',  `strTaxType` varchar(20) NOT NULL DEFAULT '', "
					+ " `dblTaxableAmt` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblTax` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblTaxAmt` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblUnitPrice` decimal(18,2) NOT NULL DEFAULT '0.00',"
					+ "  `dblWeight` decimal(18,2) NOT NULL DEFAULT '0.00',  `strProdChar` varchar(255) NOT NULL DEFAULT '', "
					+ " `strRemarks` varchar(255) NOT NULL DEFAULT '',  `intindex` bigint(20) NOT NULL, "
					+ " `strClientCode` varchar(20) NOT NULL,  `intId` bigint(20) NOT NULL AUTO_INCREMENT,"
					+ "  PRIMARY KEY (`intId`)) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;";	
			funExecuteQuery(sql);
			
			sql="  CREATE TABLE IF NOT EXISTS `tblsalesorderhd` ( "
					+ " `strSOCode` varchar(15) NOT NULL,  `intid` bigint(20) NOT NULL,"
					+ "  `dteSODate` date NOT NULL,  `strCustCode` varchar(10) NOT NULL DEFAULT '', "
					+ " `strCustPONo` varchar(50) NOT NULL DEFAULT '',  `strStatus` varchar(20) NOT NULL DEFAULT '', "
					+ " `dteFulmtDate` date NOT NULL DEFAULT '1900-01-01',  `strLocCode` varchar(15) NOT NULL DEFAULT '', "
					+ " `strPayMode` varchar(50) NOT NULL DEFAULT '',  `strBAdd1` varchar(50) NOT NULL DEFAULT '', "
					+ " `strBAdd2` varchar(50) NOT NULL DEFAULT '',  `strBCity` varchar(20) NOT NULL DEFAULT '', "
					+ " `strBState` varchar(20) NOT NULL DEFAULT '',  `strBCountry` varchar(20) NOT NULL DEFAULT '', "
					+ " `strBPin` varchar(15) NOT NULL DEFAULT '',  `strSAdd1` varchar(50) NOT NULL DEFAULT '', "
					+ " `strSAdd2` varchar(50) NOT NULL DEFAULT '',  `strSCity` varchar(20) NOT NULL DEFAULT '',  "
					+ " `strSState` varchar(20) NOT NULL DEFAULT '',  `strSCountry` varchar(20) NOT NULL DEFAULT '',  "
					+ " `strSPin` varchar(15) NOT NULL DEFAULT '',  `dblSubTotal` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblDisRate` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblDisAmt` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblTaxAmt` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblExtra` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblTotal` decimal(18,2) NOT NULL DEFAULT '0.00',  `strNarration` varchar(250) NOT NULL DEFAULT '', "
					+ " `strUserCreated` varchar(10) NOT NULL,  `dteDateCreated` date NOT NULL, "
					+ " `strUserModified` varchar(10) NOT NULL,  `dteLastModified` date NOT NULL, "
					+ " `strBOMFlag` varchar(1) NOT NULL DEFAULT 'N',  `strAuthorise` varchar(1) NOT NULL DEFAULT '', "
					+ " `strImgName` varchar(100) NOT NULL DEFAULT '',  `dteCPODate` date NOT NULL DEFAULT '1900-01-01', "
					+ " `strSysModel` varchar(50) NOT NULL DEFAULT '',  `strCranenModel` varchar(50) NOT NULL DEFAULT '', "
					+ " `strMaxCap` varchar(50) NOT NULL DEFAULT '',  `strWipeRopeDia` varchar(50) NOT NULL DEFAULT '', "
					+ " `strNoFall` varchar(50) NOT NULL DEFAULT '',  `strSuppVolt` varchar(50) NOT NULL DEFAULT '', "
					+ " `strBoomLen` varchar(50) NOT NULL DEFAULT '',  `strCurrency` varchar(10) NOT NULL DEFAULT '', "
					+ " `strReaCode` varchar(15) NOT NULL DEFAULT '',  `strAgainst` varchar(50) NOT NULL DEFAULT '', "
					+ " `strCode` varchar(20) NOT NULL DEFAULT '',  `strWarrPeriod` varchar(50) NOT NULL DEFAULT '', "
					+ " `strWarraValidity` varchar(50) NOT NULL DEFAULT '',  `intwarmonth` bigint(20) NOT NULL, "
					+ " `dblConversion` decimal(18,2) NOT NULL DEFAULT '0.00',  `strCloseSO` varchar(1) NOT NULL DEFAULT 'N', "
					+ " `strClientCode` varchar(20) NOT NULL,  PRIMARY KEY (`strSOCode`)) ENGINE=InnoDB DEFAULT CHARSET=latin1; ";
			funExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblscreturndtl` ( "
					+ " `strSRCode` varchar(15) NOT NULL,  `intId` bigint(20) NOT NULL AUTO_INCREMENT, "
					+ " `strProdCode` varchar(10) NOT NULL DEFAULT '',  `dblQty` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblQtyRej` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblWeight` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblPrice` decimal(18,2) NOT NULL DEFAULT '0.00',  `strProdChar` varchar(50) NOT NULL DEFAULT '', "
					+ " `strDNProdCode` varchar(50) NOT NULL DEFAULT '',  `strDNProdName` varchar(50) NOT NULL DEFAULT '', "
					+ " `strDNProcess` varchar(50) NOT NULL DEFAULT '',  `dblDNQty` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblDNWeight` decimal(18,2) NOT NULL DEFAULT '0.00',  `strDNProdChar` varchar(50) NOT NULL DEFAULT '', "
					+ " `dblScrap` decimal(18,2) NOT NULL DEFAULT '0.00',  `strDNCode` varchar(50) NOT NULL DEFAULT '', "
					+ " `dblDCQty` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblExpQty` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `intExpIndex` bigint(20) NOT NULL DEFAULT '1',  `dblDCWt` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `strRemarks` varchar(50) NOT NULL DEFAULT '',  `dblQtyRbl` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblRblWt` bigint(20) NOT NULL DEFAULT '0',  `intIndex` bigint(20) NOT NULL DEFAULT '1', "
					+ " `strClientCode` varchar(20) NOT NULL,  PRIMARY KEY (`intId`)) "
					+ " ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;";
			funExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblscreturnhd` ( "
					+ "  `strSRCode` varchar(15) NOT NULL,  `strSRNo` varchar(50) NOT NULL DEFAULT '',"
					+ "  `intid` bigint(20) NOT NULL,  `dteSRDate` date NOT NULL,  `strSCCode` varchar(15) NOT NULL, "
					+ " `strSCDNCode` varchar(20) NOT NULL,  `strVerRemark` varchar(50) NOT NULL DEFAULT '', "
					+ " `strDispAction` varchar(255) NOT NULL DEFAULT '',  `strPartDel` varchar(3) NOT NULL DEFAULT '', "
					+ " `strLocCode` varchar(15) NOT NULL DEFAULT '',  `strJWCode` varchar(15) NOT NULL DEFAULT '', "
					+ " `strVehNo` varchar(15) NOT NULL DEFAULT '',  `strMInBy` varchar(50) NOT NULL DEFAULT '', "
					+ " `strTimeInOut` varchar(10) NOT NULL DEFAULT '',  `strAgainst` varchar(50) NOT NULL DEFAULT '', "
					+ " `strNo` varchar(50) NOT NULL DEFAULT '',  `strInRefNo` varchar(50) NOT NULL DEFAULT '', "
					+ " `dblTotQty` decimal(18,2) NOT NULL DEFAULT '0.00',  `dblTotWt` decimal(18,2) NOT NULL DEFAULT '0.00', "
					+ " `dblTotAmt` decimal(18,2) NOT NULL DEFAULT '0.00',  `dteInRefDate` date NOT NULL DEFAULT '1991-01-01', "
					+ " `dteSCDCDate` date NOT NULL DEFAULT '1991-01-01',  `strUserCreated` varchar(15) NOT NULL, "
					+ " `dteCreatedDate` date NOT NULL DEFAULT '1991-01-01',  `strUserModified` varchar(15) NOT NULL, "
					+ " `dteLastModified` date NOT NULL DEFAULT '1991-01-01',  `strAuthorise` varchar(1) NOT NULL DEFAULT 'N', "
					+ " `strClientCode` varchar(20) NOT NULL, "
					+ " PRIMARY KEY (`strSRCode`,`strClientCode`)) ENGINE=InnoDB DEFAULT CHARSET=latin1; ";	
			funExecuteQuery(sql);
			
			
			sql=" CREATE TABLE IF NOT EXISTS `tbljoborderhd` (   `strJOCode` varchar(20) NOT NULL,  "
					+ " `intId` bigint(20) NOT NULL,  `dteJODate` date NOT NULL, "
					+ " `strSOCode` varchar(20) NOT NULL DEFAULT '',  `strProdCode` varchar(20) NOT NULL, "
					+ " `dblQty` decimal(18,4) NOT NULL DEFAULT '0.0000',  `strParentJOCode` varchar(20) NOT NULL, "
					+ " `strStatus` varchar(30) NOT NULL,  `strUserCreated` varchar(20) NOT NULL,  `dteDateCreated` datetime NOT NULL, "
					+ " `strUserModified` varchar(20) NOT NULL,  `dteLastModified` datetime NOT NULL,  `strClientCode` varchar(20) NOT NULL, "
					+ " `strAuthorise` varchar(5) NOT NULL DEFAULT 'NA', "
					+ " PRIMARY KEY (`strJOCode`,`strClientCode`)) "
					+ " ENGINE=InnoDB DEFAULT CHARSET=latin1; ";			
			funExecuteQuery(sql);
			
						
			sql= " CREATE TABLE IF NOT EXISTS `tbljoborderallocationdtl` (  `intId` bigint(20) NOT NULL AUTO_INCREMENT, "
					+ " `strJACode` varchar(20) NOT NULL,  `strJOCode` varchar(20) NOT NULL,  `strProdCode` varchar(20) NOT NULL, "
					+ " `strNatureOfProcessing` varchar(50) NOT NULL DEFAULT '',  `dblQty` decimal(18,4) NOT NULL DEFAULT '0.0000', "
					+ " `strProdNo` varchar(50) NOT NULL DEFAULT '',  `strRemarks` varchar(250) NOT NULL DEFAULT '', "
					+ " `dblRate` decimal(18,4) NOT NULL DEFAULT '0.0000',  `intIndex` bigint(20) unsigned NOT NULL DEFAULT '0', "
					+ " `strClientCode` varchar(20) NOT NULL,  PRIMARY KEY (`intId`) )"
					+ "  ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1; ";
			funExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tbljoborderallocationhd` (  `strJACode` varchar(20) NOT NULL, "
					+ " `intId` bigint(20) NOT NULL,  `strJANo` varchar(50) NOT NULL,  `strSCCode` varchar(20) NOT NULL,"
					+ "  `dteJADate` date NOT NULL,  `strRef` varchar(50) NOT NULL DEFAULT '',  `dteRefDate` date NOT NULL, "
					+ " `strDispatchMode` varchar(50) NOT NULL DEFAULT '',  `strPayment` varchar(50) NOT NULL DEFAULT '', "
					+ " `strTaxes` varchar(50) NOT NULL DEFAULT '',  `dbltotQty` decimal(18,4) NOT NULL DEFAULT '0.0000', "
					+ " `strUserCreated` varchar(20) NOT NULL,  `dteDateCreated` datetime NOT NULL,  `strUserModified` varchar(20) NOT NULL, "
					+ " `dteLastModified` datetime NOT NULL,  `strClientCode` varchar(20) NOT NULL, "
					+ " `strAuthorise` char(5) NOT NULL DEFAULT 'false',  PRIMARY KEY (`strJACode`,`strClientCode`))"
					+ " ENGINE=InnoDB DEFAULT CHARSET=latin1; ";			
			funExecuteQuery(sql);
			
			
			sql = " CREATE TABLE  IF NOT EXISTS  `tbltranschardtl` (`strTransCode` VARCHAR(15) NOT NULL, "
					+ " `strProdCode` VARCHAR(15) NOT NULL, "
					+ "	`strCharCode` VARCHAR(15) NOT NULL,"
					+ "	`strSpecf` VARCHAR(15) NOT NULL,"
					+ "	`intId` BIGINT NOT NULL AUTO_INCREMENT,"
					+ "	PRIMARY KEY (`intId`))  "
					+ " COLLATE='latin1_swedish_ci'ENGINE=InnoDB; ";
			...
			sql=" CREATE TABLE  IF NOT EXISTS  `tblInvoicehd` ( "
					+ "	`strInvCode` VARCHAR(15) NOT NULL, "
					+ "	`intid` BIGINT(20) NOT NULL, `dteInvDate` DATE NOT NULL DEFAULT '1900-01-01', "
					...
					+ "	`strAuthorise` VARCHAR(2) NOT NULL DEFAULT 'N',"
			...
			sql =" CREATE TABLE  IF NOT EXISTS  `tblInvoicedtl` ("
					+ "	`strInvCode` VARCHAR(15) NOT NULL,"
					+ "	`strProdCode` VARCHAR(10) NOT NULL DEFAULT '',	"
					+ "`dblQty` DECIMAL(18,2) NOT NULL DEFAULT '0.00',"
					+ "	`dblPrice` DECIMAL(18,2) NOT NULL DEFAULT '0.00',"
			...
			sql="CREATE TABLE  IF NOT EXISTS  `tblinvtaxdtl` ( "
			  + " `intId` BIGINT(20) NOT NULL AUTO_INCREMENT, "
			...
			sql="CREATE TABLE IF NOT EXISTS `tblsalesreturnhd` ( "
			  + " `strSRCode` varchar(20) NOT NULL,  "
			  + " `dteSRDate` datetime NOT NULL, "
			  + " `strAgainst` varchar(50) NOT NULL, "
 			  + " `strDCCode` varchar(20) NOT NULL, "
			  + " `strCustCode` varchar(10) NOT NULL, "
 			  + " `strLocCode` varchar(10) NOT NULL, "
			  + " `dblTotalAmt` decimal(18,2) NOT NULL, "
			  + " `strUserCreated` varchar(10) NOT NULL, "
			  + " `strUserEdited` varchar(10) NOT NULL, "
			  + " `dteDateCreated` datetime NOT NULL, "
			  + " `dteDateEdited` datetime NOT NULL, "
			  + " `strClientCode` varchar(20) NOT NULL, "
			  + " PRIMARY KEY (`strSRCode`,`strClientCode`) "
			  + " ) ENGINE=InnoDB DEFAULT CHARSET=latin1; "; 
			funExecuteQuery(sql);
			
			
			sql="CREATE TABLE IF NOT EXISTS `tblsalesreturndtl` ( "
				   +"`strSRCode` varchar(20) NOT NULL, "
				   +"`strProdCode` varchar(10) NOT NULL, "
				   +"`dblQty` decimal(18,2) NOT NULL, "
				   +"`dblPrice` decimal(18,2) NOT NULL, "
				   +"`dblWeight` decimal(18,2) NOT NULL, "
				   +"`strRemarks` varchar(200) NOT NULL DEFAULT '', "
				   +"`strClientCode` varchar(10) NOT NULL "
				   +") ENGINE=InnoDB DEFAULT CHARSET=latin1; ";
			funExecuteQuery(sql);
			
			sql="CREATE TABLE IF NOT EXISTS `tblsalesreturntaxdtl` ( "
				   +" `intId` BIGINT(20) NOT NULL AUTO_INCREMENT, "
				   +" `strClientCode` VARCHAR(255) NULL DEFAULT NULL, "
				   +" `strSRCode` VARCHAR(255) NOT NULL DEFAULT '', "
				   +" `strTaxAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
				   +" `strTaxCode` VARCHAR(255) NOT NULL DEFAULT '', "
				   +" `strTaxDesc` VARCHAR(255) NOT NULL DEFAULT '', "
				   +" `strTaxableAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
			...
			sql=" CREATE TABLE IF NOT EXISTS `tblsaleschar` (	"
					+ " `strSOCode` VARCHAR(15) NOT NULL,"
					+ "  `strProdCode` VARCHAR(15) NOT NULL,"
					+ "	`strCharCode` VARCHAR(15) NOT NULL,	"
					+ " `strCharValue` VARCHAR(255) NOT NULL,	"
					+ " PRIMARY KEY (`strSOCode`, `strProdCode`, `strCharCode`)) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB;   ";
			funExecuteQuery(sql);
			
			
			sql="CREATE TABLE IF NOT EXISTS `tblexcisemaster` ( "
				 + " `strExciseCode` VARCHAR(10) NOT NULL, "
				 + " `strExciseChapterNo` VARCHAR(20) NOT NULL DEFAULT '', "
				 + " `strSGCode` VARCHAR(10) NOT NULL DEFAULT '', "
				 + " `dblExcisePercent` DOUBLE(18,2) NOT NULL DEFAULT '0.0', "
				 + " `strCessTax` VARCHAR(10) NOT NULL DEFAULT 'N', "
				 + " `strRank` VARCHAR(10) NOT NULL DEFAULT '', "
				 + " `strDesc` VARCHAR(255) NOT NULL DEFAULT '', "
				 + " `strClientCode` VARCHAR(15) NOT NULL, "
				 + " PRIMARY KEY (`strExciseCode`, `strClientCode`) "
				 + " ) "
				 +  " COLLATE='latin1_swedish_ci' "
				 + " ENGINE=InnoDB;" ;
			funExecuteQuery(sql);
			...
			sql="CREATE TABLE IF NOT EXISTS `tblinvprodtaxdtl` ( 	`strInvCode` VARCHAR(20) NOT NULL, "
					+ "	`strCustCode` VARCHAR(20) NOT NULL, `strProdCode` VARCHAR(20) NOT NULL, "
			...
			sql = " CREATE TABLE IF NOT EXISTS `tblinvsalesorderdtl` ( "
			...
			sql = " CREATE TABLE `tblinvtaxgst` (  	`strInvCode` VARCHAR(15) NOT NULL, "
					+ " 	`strTaxCode` VARCHAR(15) NOT NULL DEFAULT '', "
					+ " 	`strProdCode` VARCHAR(15) NOT NULL DEFAULT '', "
					+ " 	`dblTaxableAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ " 	`dblCGSTPer` DECIMAL(18,4) NOT NULL DEFAULT '0.0000',  "
					+ "	`dblCGSTAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`dblSGSTPer` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`dblSGSTAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`dblIGSTCGSTPer` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`dblIGSTCGSTAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000',  "
					+ "	`dblIGSTSGSTPer` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`dblIGSTSGSTAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`strClientCode` VARCHAR(20) NOT NULL DEFAULT '', "
					+ "	PRIMARY KEY (`strInvCode`,`strTaxCode`, `strProdCode`, `strClientCode`) ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; ";
			
			funExecuteQuery(sql);
			
			
			sql=" CREATE TABLE IF NOT EXISTS `tblinvsettlementdtl` ( "
					+ "	`strInvCode` VARCHAR(15) NOT NULL DEFAULT '',  "
					+ "	`strSettlementCode` VARCHAR(10) NOT NULL, "
					+ "	`dblSettlementAmt` DECIMAL(18,2) NOT NULL, "
					+ "	`dblPaidAmt` DECIMAL(18,2) NULL DEFAULT '0.00', "
					+ "	`strExpiryDate` VARCHAR(15) NOT NULL DEFAULT '', "
					+ "	`strCardName` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`strRemark` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`strClientCode` VARCHAR(10) NOT NULL DEFAULT '0', "
					+ "	`strCustomerCode` VARCHAR(15) NULL DEFAULT NULL, "
					+ "	`dblActualAmt` DECIMAL(18,2) NOT NULL DEFAULT '0.00', "
					+ "	`dblRefundAmt` DECIMAL(18,2) NOT NULL DEFAULT '0.00', "
					+ "	`strGiftVoucherCode` VARCHAR(50) NULL DEFAULT '', "
					+ "	`strDataPostFlag` VARCHAR(1) NOT NULL DEFAULT  'N', "
					+ "	`strFolioNo` VARCHAR(10) NOT NULL DEFAULT '', "
					+ "	`strRoomNo` VARCHAR(10) NOT NULL DEFAULT '', "
					+ "	`dteInvDate` DATE NOT NULL, "
					+ "	PRIMARY KEY (`strInvCode`, `strClientCode`, `dteInvDate`, `strSettlementCode`), "
					+ "  INDEX `strInvCode` (`strInvCode`) ) "
			...
			sql="ALTER TABLE `tblexcisemaster`ADD COLUMN `strUserCreated` VARCHAR(50) NOT NULL DEFAULT '' AFTER `strClientCode`, "
			   +" ADD COLUMN `dtCreatedDate` DATE NOT NULL AFTER `strUserCreated`, "
			   +" ADD COLUMN `strUserModified` VARCHAR(50) NOT NULL DEFAULT '' AFTER `dtCreatedDate`, "
			   +" ADD COLUMN `dtLastModified` DATE NOT NULL AFTER `strUserModified`;";
			...
			sql= " ALTER TABLE `tblinvtaxdtl` 	CHANGE COLUMN `strTaxAmt` `dblTaxAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' "
				+ " AFTER `strInvCode`,  CHANGE COLUMN `strTaxableAmt` `dblTaxableAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `strTaxDesc`;  ";
			funExecuteQuery(sql);
			...
			sql =" ALTER TABLE `tblinvoicedtl` "
					+ " 	ADD COLUMN `strUOM` VARCHAR(15) NOT NULL DEFAULT '' AFTER `strCustCode`, "
					+ "	ADD COLUMN `dblUOMConversion` DOUBLE NOT NULL DEFAULT '1.00' AFTER `strUOM`; ";
			funExecuteQuery(sql);
	
			

			sql="CREATE TABLE IF NOT EXISTS `tblmanufacturemaster` ( "
				 + " `strManufacturerCode` VARCHAR(10) NOT NULL, "
				 + " `strManufacturerName` VARCHAR(100) NOT NULL, "
				 + " `strUserCreated` VARCHAR(20) NOT NULL, "
				 + " `dteDateCreated` DATETIME NOT NULL, "
				 + " `strUserModified` VARCHAR(20) NOT NULL, "
				 + " `dteLastModified` DATETIME NOT NULL, "
				 + " `intGId` BIGINT(20) NOT NULL, "
				 + " `strClientCode` VARCHAR(20) NOT NULL, "
				 + " PRIMARY KEY (`strManufacturerCode`, `strClientCode`) "
				 + " ) "
				 +  " COLLATE='latin1_swedish_ci' "
				 + " ENGINE=InnoDB;" ;
			funExecuteQuery(sql);
			...
			sql= " CREATE TABLE IF NOT EXISTS `tbldayend` ( "
					+ "	`strLocCode` VARCHAR(10) NOT NULL, "
					+ "	`strDayEnd` VARCHAR(15) NOT NULL, "
					+ "	`dtDateCreated` VARCHAR(25) NOT NULL DEFAULT '', "
					+ "	`dtLastModified` VARCHAR(25) NOT NULL DEFAULT '', "
					+ "	`strClientCode` VARCHAR(25) NOT NULL DEFAULT '', "
					+ "	`strUserCreated` VARCHAR(255) NOT NULL DEFAULT '', "
					+ "	`strUserModified` VARCHAR(25) NOT NULL DEFAULT '', "
					+ "	PRIMARY KEY (`strLocCode`, `strDayEnd`, `strClientCode`) ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; "; 
...
//				+" ('frmAgeingReport', 'Ageing Rport', 'Sub Contracting Report', 3, 'R', 73, 1, '1', 'default.png', '6', 1, '1', '1', 'No', 'No', 'frmAgeingReport.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), ";
		...
		sql=" INSERT INTO `tbltreemast` (`strFormName`, `strFormDesc`, `strRootNode`, `intRootIndex`, `strType`, `intFormKey`, `intFormNo`, `strImgSrc`, `strImgName`, `strModule`, `strTemp`, `strActFile`, `strHelpFile`, `strProcessForm`, `strAutorisationForm`, `strRequestMapping`, `strAdd`, `strAuthorise`, `strDelete`, `strDeliveryNote`, `strDirect`, `strEdit`, `strGRN`, `strGrant`, `strMinimumLevel`, `strOpeningStock`, `strPrint`, `strProductionOrder`, `strProject`, `strPurchaseIndent`, `strPurchaseOrder`, `strPurchaseReturn`, `strRateContractor`, `strRequisition`, `strSalesOrder`, `strSalesProjection`, `strSalesReturn`, `strServiceOrder`, `strSubContractorGRN`, `strView`, `strWorkOrder`, `strAuditForm`, `strMIS`) VALUES "
				+ " ('frmInovice', 'Inovice', 'Sales', 2, 'T', 69, 10, '1', 'default.png', '6', 1, '1', '1', 'NO', 'NO', 'frmInovice.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),"
		...
		sql= " CREATE TABLE IF NOT EXISTS `tblpermitmaster`"
				+ " (  `intId` bigint(20) NOT NULL AUTO_INCREMENT, "
				+ "  `strPermitCode` varchar(20) NOT NULL,  "
				+ " `strPermitName` varchar(150) NOT NULL,  "
				+ " `strPermitNo` varchar(30) NOT NULL, "
				+ "  `StrPermitPlace` varchar(100) NOT NULL, "
				+ "  `dtePermitIssue` date NOT NULL, "
				+ "  `dtePermitExp` date NOT NULL,  "
				+ " `strPermitStatus` varchar(5) NOT NULL, "
				+ "  `dtePermitEdited` datetime NOT NULL,  "
				+ " `strPermitUserCode` varchar(20) NOT NULL, "
				+ "  `strClientCode` varchar(10) NOT NULL DEFAULT '1', "
				+ "   PRIMARY KEY (`intId`)  ) "
		...
		sql="CREATE TABLE IF NOT EXISTS `tbllocwiseuser` (`strUserCode` VARCHAR(10) NOT NULL"
				+ ",`strLocCode` VARCHAR(10) NOT NULL,`strPropCode` VARCHAR(10) NOT NULL"
				+ ",`strClientCode` VARCHAR(10) NOT NULL) "
				+ "COLLATE='latin1_swedish_ci' ENGINE=InnoDB;";
		funExecuteQuery(sql);
		...
		sql="CREATE TABLE IF NOT EXISTS `tbltaxsubgroupdtl` (`strTaxCode` VARCHAR(20) NOT NULL"
				+ ",`strSGCode` VARCHAR(20) NOT NULL,`strClientCode` VARCHAR(20) NOT NULL)"
				+ " COLLATE='latin1_swedish_ci'ENGINE=InnoDB;";
		funExecuteQuery(sql);
...
//		
		...
		sql=" CREATE TABLE IF NOT EXISTS `tblbudget` ("
				+ "	`strAccCode` VARCHAR(10) NOT NULL,"
				+ "	`strAccName` VARCHAR(50) NOT NULL DEFAULT '',"
				+ "	`strMonth` VARCHAR(25) NOT NULL,"
				+ " 	`strYear` VARCHAR(10) NOT NULL,"
				+ " 	`dblBudgetAmt` DECIMAL(18,4) NOT NULL DEFAULT '0.0000',"
				+ "  	`intID` BIGINT(20) NOT NULL AUTO_INCREMENT, "
				+ "	`strClientCode` VARCHAR(10) NOT NULL, "
				+ "	PRIMARY KEY (`intID`, `strClientCode`) ) "
		...
		sql= " CREATE TABLE IF NOT EXISTS `tblscbillhd`  "
				+ " (	`strVoucherNo` VARCHAR(15) NOT NULL,"
				+ "	`strSuppCode` VARCHAR(15) NOT NULL,	"
				+ "	`strSuppName` VARCHAR(255) NOT NULL,	"
				+ " `strBillNo` VARCHAR(50) NOT NULL,"
				+ "	`dteBillDate` DATE NOT NULL,"
				+ "	`dteDueDate` DATE NOT NULL,	`dblTotalAmount` DOUBLE NOT NULL,"
				+ "	`strModuleType` VARCHAR(10) NOT NULL,"
				+ "	`dteVoucherDate` DATE NOT NULL,	`strUserCreated` VARCHAR(10) NOT NULL,"
				+ "	`strUserEdited` VARCHAR(10) NOT NULL,"
				+ "	`dteDateCreated` DATETIME NOT NULL,	`dteDateEdited` DATETIME NOT NULL,"
				+ "	`strClientCode` VARCHAR(10) NOT NULL,"
				+ "	`strPropertyCode` VARCHAR(10) NOT NULL,	"
				+ " `strNarration` VARCHAR(255) NOT NULL DEFAULT '',"
				+ "	`intVouchNum` VARCHAR(10) NOT NULL,"
				+ "	`intVoucherMonth` INT(2) NOT NULL, "
				+ " `strAcCode` VARCHAR(10) NOT NULL,  "
				+ "	`strAcName` VARCHAR(255) NOT NULL, "
				+ "	PRIMARY KEY (`strVoucherNo`, `strClientCode`) )"
				+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB; ";
		funExecuteWebBooksQuery(sql);


			sql="CREATE TABLE IF NOT EXISTS `tblscbilldtl` "
					+ " (	`strVoucherNo` VARCHAR(15) NOT NULL,	"
					+ " `strClientCode` VARCHAR(10) NOT NULL,	"
					+ " `strACCode` VARCHAR(15) NOT NULL,	"
					+ " `strACName` VARCHAR(255) NOT NULL,	"
					+ " `strCrDr` VARCHAR(2) NOT NULL,	"
					+ " `dblCrAmt` DOUBLE(18,4) NOT NULL,	"
					+ " `dblDrAmt` DOUBLE(18,4) NOT NULL,	"
					+ " `strNarration` VARCHAR(255) NOT NULL DEFAULT '',	"
					+ " `strPropertyCode` VARCHAR(10) NOT NULL)  "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; ";
			funExecuteWebBooksQuery(sql);
			
			sql= "CREATE TABLE IF NOT EXISTS `tblscbillgrndtl`"
					+ " (	`strVoucherNo` VARCHAR(15) NOT NULL,	"
					+ "`strClientCode` VARCHAR(10) NOT NULL,	"
					+ "`strGRNCode` VARCHAR(15) NOT NULL,	"
					+ "`dteGRNDate` DATE NOT NULL,	"
					+ "`dblGRNAmt` DOUBLE(18,4) NOT NULL DEFAULT '0.00',	"
					+ "`dteGRNDueDate` DATE NOT NULL,	"
					+ "`strGRNBIllNo` VARCHAR(50) NOT NULL DEFAULT '',	"
					+ "`strPropertyCode` VARCHAR(2) NOT NULL ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; ";
			funExecuteWebBooksQuery(sql);	
			
			sql="CREATE TABLE IF NOT EXISTS `tblpaymentgrndtl` ( "
					+ "	`strClientCode` VARCHAR(255) NOT NULL, "
					+ "	`strVouchNo` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`dblGRNAmt` DOUBLE NOT NULL, "
					+ "	`dteBillDate` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`dteGRNDate` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`dteGRNDueDate` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`strGRNBIllNo` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`strGRNCode` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`strPropertyCode` VARCHAR(255) NULL DEFAULT NULL ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ;  ";
			funExecuteWebBooksQuery(sql);	
			
			
			sql =" CREATE TABLE IF NOT EXISTS `tblsundarycreditormaster` ( "
					+ "	`intGId` BIGINT(20) NOT NULL AUTO_INCREMENT, "
					+ "	`strCreditorCode` VARCHAR(20) NOT NULL, "
					+ "	`strPrefix` VARCHAR(10) NOT NULL, "
					+ "	`strFirstName` VARCHAR(50) NOT NULL, "
					+ "	`strMiddleName` VARCHAR(50) NOT NULL, "
					+ "	`strLastName` VARCHAR(50) NOT NULL, "
					+ "	`strCategoryCode` VARCHAR(100) NOT NULL, "
					+ "	`strAddressLine1` VARCHAR(200) NOT NULL, "
					+ "	`strAddressLine2` VARCHAR(200) NOT NULL, "
					+ "	`strAddressLine3` VARCHAR(200) NOT NULL, "
					+ "	`strCity` VARCHAR(100) NOT NULL, "
					+ "	`longZipCode` VARCHAR(50) NOT NULL, "
					+ "	`strTelNo1` VARCHAR(50) NOT NULL, "
					+ "	`strTelNo2` VARCHAR(50) NOT NULL, "
					+ "	`strFax` VARCHAR(50) NOT NULL, "
					+ "	`strArea` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strEmail` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactPerson1` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactDesignation1` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactEmail1` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactTelNo1` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactPerson2` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactDesignation2` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactEmail2` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strContactTelNo2` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strLandmark` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strCreditorFullName` VARCHAR(100) NOT NULL DEFAULT '', "
					+ "	`strExpired` VARCHAR(5) NOT NULL DEFAULT 'No', "
					+ "	`strExpiryReasonCode` VARCHAR(20) NOT NULL DEFAULT 'NA', "
					+ "	`strECSYN` VARCHAR(5) NOT NULL DEFAULT 'N', "
					+ "	`strAccountNo` VARCHAR(100) NOT NULL, "
					+ "	`strHolderName` VARCHAR(100) NOT NULL, "
					+ "	`strMICRNo` VARCHAR(100) NOT NULL, "
					+ "	`dblECS` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`strSaveCurAccount` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strAlternateCode` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dblOutstanding` DECIMAL(18,4) NOT NULL DEFAULT '0.0000', "
					+ "	`strStatus` VARCHAR(20) NOT NULL DEFAULT '', "
					+ "	`intDays1` VARCHAR(50) NOT NULL DEFAULT '0', 	"
					+ "`intDays2` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`intDays3` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`intDays4` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`intDays5` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`dblCrAmt` DECIMAL(18,2) NOT NULL DEFAULT '0.00',  "
					+ "	`dblDrAmt` DECIMAL(18,2) NOT NULL DEFAULT '0.00', "
					+ "	`dteLetterProcess` DATETIME NOT NULL DEFAULT '1900-01-01 00:00:00', "
					+ "	`strReminder1` VARCHAR(15) NOT NULL DEFAULT '', "
					+ "	`strReminder2` VARCHAR(15) NOT NULL DEFAULT '', "
					+ "	`strReminder3` VARCHAR(15) NOT NULL DEFAULT '', "
					+ "	`strReminder4` VARCHAR(15) NOT NULL DEFAULT '', "
					+ "	`strReminder5` VARCHAR(15) NOT NULL DEFAULT '', "
					+ "	`dblLicenseFee` VARCHAR(50) NOT NULL DEFAULT '0.0000', "
					+ "	`dblAnnualFee` VARCHAR(50) NOT NULL DEFAULT '0.0000', "
					+ "	`strRemarks` VARCHAR(200) NOT NULL DEFAULT 'NA', "
					+ "	`strClientApproval` VARCHAR(5) NOT NULL DEFAULT 'No', "
					+ "	`strAMCLink` VARCHAR(200) NOT NULL DEFAULT '', "
					+ "	`strCurrencyType` VARCHAR(20) NOT NULL DEFAULT '', "
					+ "	`strAccountHolderCode` VARCHAR(20) NOT NULL DEFAULT '', "
					+ "	`strAccountHolderName` VARCHAR(100) NOT NULL DEFAULT '', "
					+ "	`strAMCCycle` VARCHAR(20) NOT NULL DEFAULT '',  "
					+ "	`dteStartDate` DATETIME NOT NULL, "
					+ "	`strAMCRemarks` VARCHAR(200) NOT NULL DEFAULT 'NA', "
					+ "	`strClientComment` VARCHAR(200) NOT NULL DEFAULT 'NA', "
					+ "	`strBillingToCode` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dblAnnualFeeInCurrency` VARCHAR(50) NOT NULL DEFAULT '0.0000', "
					+ "	`dblLicenseFeeInCurrency` VARCHAR(50) NOT NULL DEFAULT '0.0000', "
					+ "	`strState` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strRegion` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strCountry` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`strConsolidated` VARCHAR(5) NOT NULL DEFAULT 'No', "
					+ "	`intCreditDays` VARCHAR(50) NOT NULL DEFAULT '0', "
					+ "	`strCreditorStatusCode` VARCHAR(10) NOT NULL DEFAULT '', "
					+ "	`longMobileNo` VARCHAR(50) NOT NULL, "
					+ "	`strECSActivate` VARCHAR(3) NOT NULL DEFAULT '', "
					+ "	`strReminderStatus1` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dteRemainderDate1` VARCHAR(50) NOT NULL DEFAULT '1900-01-01', "
					+ " 	`strReminderStatus2` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dteRemainderDate2` VARCHAR(50) NOT NULL DEFAULT '1900-01-01', "
					+ "	`strReminderStatus3` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dteRemainderDate3` VARCHAR(50) NOT NULL DEFAULT '1900-01-01', "
					+ " 	`strReminderStatus4` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dteRemainderDate4` VARCHAR(50) NOT NULL DEFAULT '1900-01-01', "
					+ "	`strReminderStatus5` VARCHAR(50) NOT NULL DEFAULT '', "
					+ "	`dteRemainderDate5` VARCHAR(50) NOT NULL DEFAULT '1900-01-01', "
					+ "	`strAllInvoiceHeader` VARCHAR(500) NOT NULL DEFAULT '', "
					+ "	`strUserCreated` VARCHAR(10) NOT NULL, "
					+ "	`strUserEdited` VARCHAR(10) NOT NULL, "
					+ "	`dteDateCreated` DATETIME NOT NULL, "
					+ "	`dteDateEdited` DATETIME NOT NULL, "
					+ "	`strClientCode` VARCHAR(20) NOT NULL, "
					+ "	`strPropertyCode` VARCHAR(10) NOT NULL, "
					+ "	`strBlocked` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	PRIMARY KEY (`strCreditorCode`, `strClientCode`), "
					+ "	INDEX `intGId` (`intGId`) ) COLLATE='latin1_swedish_ci' "
					+ " ENGINE=InnoDB AUTO_INCREMENT=13 ;  ";

			funExecuteWebBooksQuery(sql);	
			
			
			sql = " CREATE TABLE IF NOT EXISTS   `tblledgersummary` ( "
					+ "	`dteVochDate` VARCHAR(100) NOT NULL,  	"
					+ "`strVoucherNo` VARCHAR(100) NOT NULL,  "
					+ "	`strTransType` VARCHAR(50) NOT NULL,  "
					+ "	`strChequeBillNo` VARCHAR(50) NOT NULL,  "
					+ "	`dteBillDate` VARCHAR(100) NOT NULL,  "
					+ "	`dblDebitAmt` DOUBLE NOT NULL DEFAULT '0.00',  "
					+ "	`dblCreditAmt` DOUBLE NOT NULL DEFAULT '0.00',  "
					+ "	`dblBalanceAmt` DOUBLE NOT NULL DEFAULT '0.00',  "
					+ "	`strBalCrDr` VARCHAR(50) NOT NULL DEFAULT '',  "
					+ "	`strNarration` VARCHAR(100) NOT NULL DEFAULT '',  "
					+ "	`strTransTypeForOrderBy` VARCHAR(100) NOT NULL DEFAULT '',  "
					+ "	`strUserCode` VARCHAR(100) NOT NULL,  "
					+ "	`strPropertyCode` VARCHAR(10) NOT NULL,  "
					+ "	`strClientCode` VARCHAR(100) NOT NULL,  "
					+ "	PRIMARY KEY (`strVoucherNo`, `strClientCode`,`strTransType`)  ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; ";
			
			funExecuteWebBooksQuery(sql);	
			
			sql = " CREATE TABLE IF NOT EXISTS  `tblcurrentaccountbal` ( "
					+ "	`strAccountCode` VARCHAR(50) NOT NULL, "
					+ "	`strAccountName` VARCHAR(50) NOT NULL, "
					+ "	`strDrCrCode` VARCHAR(50) NOT NULL, "
					+ "	`dteBalDate` VARCHAR(50) NOT NULL,  "
					+ "	`dblCrAmt` DOUBLE NOT NULL DEFAULT '0.00',  "
					+ "	`dblDrAmt` DOUBLE NOT NULL DEFAULT '0.00',  "
					+ "	`dblBalAmt` DOUBLE NOT NULL DEFAULT '0.00', "
					+ "	`strTransecType` VARCHAR(50) NOT NULL DEFAULT '', "
					+ " 	`strUserCode` VARCHAR(50) NOT NULL, "
					+ "	`strPropertyCode` VARCHAR(50) NOT NULL, "
					+ "	`strClientCode` VARCHAR(50) NOT NULL,  "
					+ "	PRIMARY KEY (`strAccountCode`, `strClientCode`) ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; ";
			funExecuteWebBooksQuery(sql);
			
			
			
			sql = " CREATE TABLE IF NOT EXISTS  `tblsundarycreditoropeningbalance` ( 			"
					+ "		`strCreditorCode` VARCHAR(50) NOT NULL, 		"
					+ "		`strAccountCode` VARCHAR(50) NOT NULL, 			"
					+ "		`strAccountName` VARCHAR(150) NOT NULL, 		"
					+ "			`dblOpeningbal` DOUBLE NOT NULL DEFAULT '0.00', 			"
					+ "		`strCrDr` VARCHAR(50) NOT NULL, 		"
					+ "			`strClientCode` VARCHAR(50) NOT NULL, 		"
					+ "			PRIMARY KEY (`strCreditorCode`, `strClientCode`) 		"
					+ "		) 				COLLATE='latin1_swedish_ci' 		"
					+ "		ENGINE=InnoDB ;	 ";
			...
			sql = "	CREATE TABLE IF NOT EXISTS  `tblsundarydebtoropeningbalance` ( 		"
					+ "			`strDebtorCode` VARCHAR(50) NOT NULL, 		"
					+ "			`strAccountCode` VARCHAR(50) NOT NULL, 		"
					+ "			`strAccountName` VARCHAR(150) NOT NULL, 	"
					+ "				`dblOpeningbal` DOUBLE NOT NULL DEFAULT '0.00', 	"
					+ "				`strCrDr` VARCHAR(50) NOT NULL, 	"
					+ "				`strClientCode` VARCHAR(50) NOT NULL, 		"
					+ "			PRIMARY KEY (`strDebtorCode`, `strClientCode`) 		"
					+ "		) 				COLLATE='latin1_swedish_ci' 		"
					+ "		ENGINE=InnoDB ; " ;
			funExecuteWebBooksQuery(sql);
			
			sql = " CREATE TABLE IF NOT EXISTS `tblreceiptinvdtl` ( "
					+ "	`strClientCode` VARCHAR(255) NOT NULL, "
					+ "	`strVouchNo` VARCHAR(255) NOT NULL, 	"
					+ "`dblInvAmt` DOUBLE NULL DEFAULT NULL, "
					+ "	`dteBillDate` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`dteInvDate` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`dteInvDueDate` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`strInvBIllNo` VARCHAR(255) NULL DEFAULT NULL,"
					+ " 	`strInvCode` VARCHAR(255) NULL DEFAULT NULL, "
					+ "	`strPropertyCode` VARCHAR(255) NULL DEFAULT NULL,   "
					+ "	`dblPayedAmt` DOUBLE NOT NULL DEFAULT '0' "
					+ " ) COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; "; 
			funExecuteWebBooksQuery(sql);
			...
			sql=" CREATE TABLE IF NOT EXISTS `tblsundarycreditoropeningbalance` ( "
					...
					+ "`strAccountCode` VARCHAR(50) NOT NULL, "
					+ "	`strAccountName` VARCHAR(150) NOT NULL, "
					+ "	`dblOpeningbal` DOUBLE NOT NULL DEFAULT '0', "
					+ "	`strCrDr` VARCHAR(50) NOT NULL, "
					+ "	`strClientCode` VARCHAR(50) NOT NULL, "
					+ "	PRIMARY KEY (`strCreditorCode`, `strClientCode`) ) "
					+ " COLLATE='latin1_swedish_ci' ENGINE=InnoDB ; ";
			...
			sql=" ALTER TABLE `tblpaymentdtl` "
					+ " ADD COLUMN `strDebtorCode` VARCHAR(10) NOT NULL DEFAULT '' AFTER `strPropertyCode` ";
			
			funExecuteWebBooksQuery(sql);
			
			sql =" ALTER TABLE `tblpaymentgrndtl` "
					+ "	ADD COLUMN `dblPayedAmt` DOUBLE NOT NULL DEFAULT '0.00' AFTER `strPropertyCode`; ";
			
			funExecuteWebBooksQuery(sql);
			
			sql =" ALTER TABLE `tblauditdtl` "
					+ "	CHANGE COLUMN `strAccountName` "
					+ " `strAccountName` VARCHAR(100) NOT NULL AFTER `strAccountCode`;  ";
			funExecuteWebBooksQuery(sql);
			
			sql = " ALTER TABLE `tblaudithd` "
					+ "	CHANGE COLUMN `strTransType` `strTransType` "
					+ " VARCHAR(10) NOT NULL DEFAULT '' AFTER `strMasterPOS`;  ";
			funExecuteWebBooksQuery(sql);
			
			sql =" ALTER TABLE `tblscbillhd` "
					+ "	ADD COLUMN `strCreditorCode` VARCHAR(10) NOT NULL AFTER `strSuppName`;";
			funExecuteWebBooksQuery(sql);
		...
		sql= " INSERT INTO `tbltreemast` (`strFormName`, `strFormDesc`, `strRootNode`, `intRootIndex`, `strType`, `intFormKey`, `intFormNo`, `strImgSrc`, `strImgName`, `strModule`, `strTemp`, `strActFile`, `strHelpFile`, `strProcessForm`, `strAutorisationForm`, `strRequestMapping`, `strAdd`, `strAuthorise`, `strDelete`, `strDeliveryNote`, `strDirect`, `strEdit`, `strGRN`, `strGrant`, `strMinimumLevel`, `strOpeningStock`, `strPrint`, `strProductionOrder`, `strProject`, `strPurchaseIndent`, `strPurchaseOrder`, `strPurchaseReturn`, `strRateContractor`, `strRequisition`, `strSalesOrder`, `strSalesProjection`, `strSalesReturn`, `strServiceOrder`, `strSubContractorGRN`, `strView`, `strWorkOrder`, `strAuditForm`, `strMIS`) VALUES "
			//	+ " ('frmAPGLAccountHolderMaster', 'APGL Account Holder Master', 'Master', '2', 'M', '2', '2', '1', 'default.png', '5', '1', '1', '1', 'NO', 'NO', 'frmAccountHolderMaster.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
			//	+ " ('frmAPGLGroupMaster', 'APGL Group Master', 'Master', '4', 'M', '4', '4', '1', 'default.png', '5', '1', '1', '1', 'NO', 'NO', 'frmACGroupMaster.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
			...
			//	+ " ('frmAPGLPayment', 'APGL Payment', 'Transaction', '5', 'T', '5', '1', '12', 'default.png', '5', '1', '1', '1', 'NO', '1', 'frmPayment.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),"
			//	+ " ('frmAPGLBudgetMaster', 'Budget Master', 'Master', '5', 'M', '5', '5', '1', 'default.png', '5', '1', '1', '1', 'NO', 'NO', 'frmAPGLBudgetMaster.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),"
			//	+ " ('frmAPGLJV', 'APGL JV', 'Transaction', '5', 'T', '6', '1', '12', 'default.png', '5', '1', '1', '1', 'NO', '1', 'frmJV.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
			//	+ " ('frmAPGLReceipt', 'APGL Receipt', 'Transaction', '5', 'T', '6', '1', '12', 'default.png', '5', '1', '1', '1', 'NO', '1', 'frmAPGLReceipt.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
                ...
                + " ('frmCreditorsOutStandingBillsReport', 'Creditors Out Standing Bills Report', 'Reports', '6', 'R', '7', '7', '1', 'default.png', '5', '1', '1', '1', 'NO', 'NO', 'frmCreditorsOutStandingBillsReport.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) ," 
		      ...
		      //  + " ('frmCreditorTrialBalanceReport', 'Creditor Trial Balance List', 'Reports', '6', 'R', '9', '9', '1', 'default.png', '5', '1', '1', '1', 'NO', 'NO', 'frmCreditorTrialBalanceReport.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) ,"
			...
			//	+ " ('frmAPGLSecurityShell', 'Security Shell', 'Master', 7, 'M', 12, 12, '1', 'Security-Shell.png', '5', 1, '1', '1', 'NO', 'YES', 'frmAPGLSecurityShell.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
		...
		sql=" ALTER TABLE `tblroomcancelation` "
				+ "	CHANGE COLUMN `strReservationNo` `strReservationNo` VARCHAR(12) NOT NULL FIRST;  ";
		
		funExecutePMSQuery(sql);	
		
		
		sql=" ALTER TABLE `tblreservationhd` "
			+ "	ADD COLUMN `strNoRoomsBooked` VARCHAR(10) NOT NULL DEFAULT '1' AFTER `intNoOfChild`; ";
		funExecutePMSQuery(sql);	
		
		sql=" ALTER TABLE `tblreservationdtl`"
				+ "	ADD COLUMN `strPayee` VARCHAR(1) NOT NULL AFTER `strGuestCode`; ";
		
		funExecutePMSQuery(sql);
		
		
		sql= " ALTER TABLE `tblfoliohd` "
			+ "	ADD COLUMN `strWalkInNo` VARCHAR(15) NOT NULL DEFAULT '' AFTER `strGuestCode`; ";
		
		funExecutePMSQuery(sql);
		
		sql= "  ALTER TABLE `tblreceipthd` "
			+ "	ADD COLUMN `strFlagOfAdvAmt` VARCHAR(3) NOT NULL DEFAULT 'N' AFTER `strClientCode`; ";
		
		funExecutePMSQuery(sql);
		
		sql= " ALTER TABLE `tblreservationhd` 	"
				+ "	ADD COLUMN `strGuestcode` VARCHAR(15) NOT NULL AFTER `strNoRoomsBooked`; ";
		
		funExecutePMSQuery(sql);
		
		sql=" ALTER TABLE `tblbilldtl` "
				+ "	CHANGE COLUMN `strRevenueType` `strRevenueType` VARCHAR(255) NOT NULL AFTER `strPerticulars`; ";
	
		funExecutePMSQuery(sql);
		 
		sql = " ALTER TABLE `tblbillhd` "
			+ "	ADD COLUMN `strBillSettled` VARCHAR(1) NOT NULL DEFAULT 'N' AFTER `strClientCode`; ";
		funExecutePMSQuery(sql);
		
		
		sql="  ALTER TABLE `tblpropertysetup` "
				+ "	ADD COLUMN `strSMSProvider` VARCHAR(50) NOT NULL DEFAULT '' AFTER `tmeCheckOutTime`, "
				+ "	ADD COLUMN `strSMSAPI` VARCHAR(50) NOT NULL DEFAULT '' AFTER `strSMSProvider`, "
				+ "	ADD COLUMN `strReservationSMSContent` VARCHAR(500) NOT NULL DEFAULT '' AFTER `strSMSAPI`, "
				+ "	ADD COLUMN `strCheckInSMSContent` VARCHAR(500) NOT NULL DEFAULT '' AFTER `strReservationSMSContent`, "
				+ "	ADD COLUMN `strAdvAmtSMSContent` VARCHAR(500) NOT NULL DEFAULT '' AFTER `strCheckInSMSContent`, "
				+ "	ADD COLUMN `strCheckOutSMSContent` VARCHAR(500) NOT NULL DEFAULT '' AFTER `strAdvAmtSMSContent`; ";
		funExecutePMSQuery(sql);
		...
		sql= " INSERT INTO `tbltreemast` (`strFormName`, `strFormDesc`, `strRootNode`, `intRootIndex`, `strType`, `intFormKey`, `intFormNo`, `strImgSrc`, `strImgName`, `strModule`, `strTemp`, `strActFile`, `strHelpFile`, `strProcessForm`, `strAutorisationForm`, `strRequestMapping`, `strAdd`, `strAuthorise`, `strDelete`, `strDeliveryNote`, `strDirect`, `strEdit`, `strGRN`, `strGrant`, `strMinimumLevel`, `strOpeningStock`, `strPrint`, `strProductionOrder`, `strProject`, `strPurchaseIndent`, `strPurchaseOrder`, `strPurchaseReturn`, `strRateContractor`, `strRequisition`, `strSalesOrder`, `strSalesProjection`, `strSalesReturn`, `strServiceOrder`, `strSubContractorGRN`, `strView`, `strWorkOrder`, `strAuditForm`, `strMIS`) VALUES "
				...
				+" ('frmCancelationReport', 'Cancelation Report', 'Reports', 3, 'R', 3, 6, '6', 'default.png', '3', 1, '1', '1', 'NO', 'NO', 'frmCancelationReport.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
	...
	private int funExecuteWebBooksQuery(String sql) {
		try {
			Query query = webBooksSessionFactory.getCurrentSession()
					.createSQLQuery(sql);
			query.executeUpdate();
		} catch (Exception e) {
		} finally {
	...
	private int funExecutePMSQuery(String sql) {
		try {
			Query query = webPMSSessionFactory.getCurrentSession()
					.createSQLQuery(sql);
			query.executeUpdate();
		} catch (Exception e) {
		} finally {
