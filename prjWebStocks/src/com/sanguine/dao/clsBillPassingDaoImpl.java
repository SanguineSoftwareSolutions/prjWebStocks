...
public class clsBillPassingDaoImpl implements clsBillPassingDao{
	...
	@Override
	public void funDeleteBillPassingDtlData(String billNo,
			String clientCode) {
	...
	@Override
	public clsBillPassHdModel funGetObject(String billNo,
			String clientCode) {
	...
	@Override
	public List<clsBillPassDtlModel> funGetDtlList(String billNo,
			String clientCode) {
