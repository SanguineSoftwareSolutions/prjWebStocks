...
public class clsSupplierMasterDaoImpl implements clsSupplierMasterDao
{
	...
	public List<clsSupplierMasterModel> funGetList(String clientCode)
	{
		...
		//return (List<clsSupplierMasterModel>) sessionFactory.getCurrentSession().createCriteria(clsSupplierMasterModel.class,clientCode).list();		
	}
	...
	@Override
	public void funAddPartyTaxDtl(
			clsPartyTaxIndicatorDtlModel objPartyTaxIndicator) {
	...
	public void funExciseUpdate(String partyCode, String clientCode,String exSuppCode)
	{
		...
		int updatedEntities = sessionFactory.getCurrentSession().createQuery( hqlUpdate )
		        .setString( "clientCode", clientCode )
		        .setString( "pCode", partyCode )
		        .setString( "exSuppCode", exSuppCode )
		        .executeUpdate();
	}
