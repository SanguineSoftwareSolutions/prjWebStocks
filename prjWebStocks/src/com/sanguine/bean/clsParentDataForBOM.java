...
/*	public String getStrBOMCreated() {
		return strBOMCreated;
	}

	public void setStrBOMCreated(String strBOMCreated) {
		this.strBOMCreated = (String) setDefaultValue(strBOMCreated,"N"); 
	}*/
