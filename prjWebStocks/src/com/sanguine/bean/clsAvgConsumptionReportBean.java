...
public class clsAvgConsumptionReportBean {
	...
	public clsAvgConsumptionReportBean(  String strProdCode, String strProdName,String strUom,double dblRecConverstion,
			double dblOpeningStk,double dblConsump, double dblAvgConsump,double dblCurrentStock,
			double dblMinOrderQty,String strSuppName,String strSuppCode,double dblRecipts,double dblIssue )
	{
