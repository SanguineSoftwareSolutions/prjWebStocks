...
public class clsSetupMasterBean {
	...
	public void setListclsWorkFlowForSlabBasedAuth(
			List<clsWorkFlowForSlabBasedAuth> listclsWorkFlowForSlabBasedAuth) {
	...
	public void setListProcessSetupForm(
			List<clsTreeMasterModel> listProcessSetupForm) {
	...
	public void setListProcessSetupModel(
			List<clsProcessSetupModel> listProcessSetupModel) {
