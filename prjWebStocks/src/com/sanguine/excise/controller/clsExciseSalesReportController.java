...
public class clsExciseSalesReportController {
	...
	private ModelAndView funSaleeReportExcelExport(@ModelAttribute("command") @Valid clsExciseFLR4ReportBean objbean, HttpServletResponse resp,HttpServletRequest req)
	{
		...
		String sqlPurchase="select a.dteBillDate,b.intSalesHd,c.strBrandName,d.strSizeName ,b.intBtl,b.intPeg,b.intML "
						  +"from tblmanualsaleshd a,tblmanualsalesdtl b ,tblbrandmaster c,tblsizemaster d "
						  +"where a.intId=b.intSalesHd and b.strBrandCode=c.strBrandCode and c.strSizeCode=d.strSizeCode "
						  +" AND a.dteBillDate BETWEEN '"+fromDate+"' AND '"+toDate+"' AND a.strClientCode='"+clientCode+"' "
						  +"ORDER BY a.dteBillDate,b.intSalesHd,c.strBrandName ";
