...
//Open POSLinkUp
	...
	public ModelAndView funOpenForm(@ModelAttribute("command")clsPOSExciseLinkUpBean objBean,Map<String,Object> model,HttpServletRequest req){
		...
		try
		{
			String sql="select distinct a.strPOSItemCode,a.strPOSItemName,a.strBrandCode,a.strBrandName,a.intConversionFactor "
					+ " from tblexciseposlinkup a where a.strClientCode='"+clientCode+"' order by a.strBrandCode  ";			
...
//						objModel.setStrPOSItemName("");
				...
				sql_Update = "update tblexcisepossale set strBrandCode='"+objModel.getStrBrandCode()+"' "
