		...
		if (!result.hasErrors()) {
			...
			if (success) {
				...
				req.getSession().setAttribute("successMessage",
						"Supplier Number : ".concat(objModel.getStrSupplierName()));
...
//			objModel.setStrSupplierNo(objBean.getStrSupplierNo());
	...
	public @ResponseBody clsExciseSupplierMasterModel funAssignFieldsForForm(
				@RequestParam("supplierCode") String supplierCode,HttpServletRequest req) {
