...
public class clsExciseStkFlash {
	...
	private @ResponseBody List funShowStockDetailsFlash(@RequestParam(value="param1") String param1,
...
//		String strReasonCode=spParam1[3];
		...
		String sql="select  a.strSalesCode, a.dteBillDate,a.strLicenceCode,a.strPOSItem , a.strItemCode,b.strBrandName ,a.strUserCreated ,a.strRemark,sum(a.intTotalPeg),sum(a.intQty),a.strSourceEntry,a.intBillNo,a.dblTotalAmt   "      
				  +" from tblexcisesaledata a ,tblbrandmaster b  where a.strClientCode='"+clientCode+"' and a.strItemCode=b.strBrandCode "
		...
		}//posQty:1posItemPrice:550.0posItemName:CHIVAS REGAL 12 YR WHKY (L)-PCL
    ...
    private void funCallReportBeanWise(String rptSaleID,String type,HttpServletRequest req,HttpServletResponse resp)	
    {
		...
		try
		{
			...
			String sql="SELECT a.strSalesCode, a.dteBillDate,a.strLicenceCode,a.strPOSItem, a.strItemCode,b.strBrandName,a.strUserCreated,a.strRemark, "
					+" sum(a.intTotalPeg), sum(a.intQty),a.strSourceEntry,a.intBillNo,c.strSubCategoryCode,c.strSubCategoryName,d.strCategoryCode,d.strCategoryName,e.strLicenceNo,a.dblTotalAmt "
					...
					+" AND a.strItemCode=b.strBrandCode and a.strSalesCode='"+rptSaleID+"'  and b.strSubCategoryCode=c.strSubCategoryCode and c.strCategoryCode=d.strCategoryCode and a.strLicenceCode=e.strLicenceCode  "
...
//    	    JRBeanCollectionDataSource beanCollectionDataSource = new JRBeanCollectionDataSource(listStockBean);
