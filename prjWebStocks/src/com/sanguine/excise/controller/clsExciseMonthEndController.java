...
public class clsExciseMonthEndController {
	...
	public @ResponseBody int funCheckMonthEnd(@RequestParam("licenceCode")  String licenceCode,@RequestParam("date")  String date,@RequestParam("formName")  String formName,
