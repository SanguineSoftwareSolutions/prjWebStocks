...
public class clsExciseStkPostingController
{
		...
		public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsExciseStockPostingBean objBean,
		...
		public ModelAndView funExportExcel(@ModelAttribute("command") @Valid clsExciseStockPostingBean objBean,
							BindingResult result,HttpServletRequest request){
			String urlHits="1";
		...
		if (!result.hasErrors()) {
			...
			String header="SR. No.,Brand Code,Brand Name,Size In ML,Peg Size In ML,MRP,System Btl,System ML,System Peg,"
					+ "Physical Btl,Physical ML,Physical Peg,Variance In ML";
