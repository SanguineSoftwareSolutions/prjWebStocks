...
//		}
										...
										for (clsExciseManualSaleDtlModel objSalesDtl : listSalesdtl){
							            		...
							            		if(objSalesDtl.getStrBrandCode() !=null){
							            			...
							            			String sql_BrandList="select a.strBrandCode,a.strSizeCode,a.strShortName,b.intQty,a.intPegSize,a.strBrandName "
							            					...
							            					+ " where a.strBrandCode='"+objSalesDtl.getStrBrandCode()+"' and a.strSizeCode=b.strSizeCode  "
							            			...
							            			String sql_OpData="select c.intOpBtls,c.intOpPeg,c.intOpML from tblbrandmaster a,tblopeningstock c "
							            								+ " where a.strBrandCode='"+objSalesDtl.getStrBrandCode()+"' and a.strBrandCode=c.strBrandCode  "
				...
				for(int i=0;i<objDtlList.size();i++)
			        {
						...
						String sql_BrandList="select a.strBrandCode,a.strSizeCode,a.strShortName,b.intQty,a.intPegSize "
								+ "  from tblbrandmaster a, tblsizemaster b "
								+ " where a.strBrandCode='"+brandMaster.getStrBrandCode()+"' and a.strSizeCode=b.strSizeCode  "
				  				+ " and  a.strClientCode='"+tempBrandClientCode+"' and b.strClientCode='"+tempSizeClientCode+"' ORDER BY b.intQty DESC";			
						...
						String sql_OpData="select c.intOpBtls,c.intOpPeg,c.intOpML from tblbrandmaster a,tblopeningstock c "
											+ " where a.strBrandCode='"+brandMaster.getStrBrandCode()+"' and a.strBrandCode=c.strBrandCode  "
											+ " and  a.strClientCode='"+tempBrandClientCode+"' and  c.strClientCode='"+clientCode+"' and c.strLicenceCode='"+licenceCode+"' ";
	...
	public void funAuditSale(clsExciseManualSaleHdModel objModel){
		...
		String countSql="select count(*) from dbwebmms.tblaudithd "
				           + "where left(strTransCode,"+cnt+")='"+objModel.getIntId()+"' and strClientCode='"+objModel.getStrClientCode()+"'";
	...
	public void funAuditSaleDtl(clsExciseManualSaleDtlModel objSaleDtl,HttpServletRequest req){
		...
		String countSql="select count(*) from dbwebmms.tblauditdtl "
				           + "where left(strTransCode,"+cntTransCode+")='"+objSaleDtl.getIntSalesHd()+"' and left(strProdCode,"+cntBrandCode+")='"+objSaleDtl.getStrBrandCode()+"' and strClientCode='"+objSaleDtl.getStrClientCode()+"'";
