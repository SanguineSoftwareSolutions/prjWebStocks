...
@RequestMapping(value = "/loadExciseTPMasterData", method = RequestMethod.GET)
	public @ResponseBody clsTransportPassPBean funAssignFieldsForForm(
			@RequestParam("tpCode") String tpCode,HttpServletRequest request) {
			String clientCode = request.getSession().getAttribute("clientCode").toString();
		...
		public void funAuditTpHd(clsTransportPassModel objModel){
    	   ...
    	   String count=objModel.getStrTPCode().toString();
   		   ...
   		   String countSql="select count(*) from dbwebmms.tblaudithd "
   				           + "where left(strTransCode,"+cnt+")='"+objModel.getStrTPCode()+"' and strClientCode='"+objModel.getStrClientCode()+"'";
		 ...
		 public void funAuditTpDtl(clsTransportPassDtlModel objdtlModel,HttpServletRequest req){
        		...
        		String countSql="select count(*) from dbwebmms.tblaudithd "
        		           + "where left(strTransCode,"+cntTransCode+")='"+objdtlModel.getStrTPCode()+"' and strClientCode='"+objdtlModel.getStrClientCode()+"'";
