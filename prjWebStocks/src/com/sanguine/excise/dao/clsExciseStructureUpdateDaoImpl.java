...
public void  funExciseUpdateStructure(String clientCode){
		     ...
		     String sql="";
		     sql="CREATE TABLE IF NOT EXISTS `tblbrandmaster` ( "
			    +"`strBrandCode` varchar(20) NOT NULL, "
			    +"`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
			    +"`strBrandName` varchar(200) NOT NULL, "
			    +"`intPegSize` int(10) unsigned NOT NULL DEFAULT '0', "
			    +"`dblStrength` decimal(18,3) NOT NULL DEFAULT '0.000', "
			    +"`dblMRP` decimal(18,3) NOT NULL DEFAULT '0.000', "
			    +"`dblPegPrice` decimal(18,3) NOT NULL DEFAULT '0.000', "
			    +"`strShortName` varchar(50) DEFAULT NULL, "
			    +"`strSubCategoryCode` varchar(20) NOT NULL, "
			    +"`strSizeCode` varchar(50) NOT NULL, "
			    ...
			    +"PRIMARY KEY (`strBrandCode`,`strClientCode`),"
			    +"KEY `intId` (`intId`) "
			    +") ENGINE=InnoDB AUTO_INCREMENT=948 DEFAULT CHARSET=utf8;";
		
		     funExciseExecuteQuery(sql);
		 	
		 	 sql="CREATE TABLE IF NOT EXISTS `tblcategorymaster` ( "
		 	    +"`strCategoryCode` varchar(20) NOT NULL, "
		 	    +"`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
		 	    +"`strCategoryName` varchar(200) NOT NULL, "
		 	    +"`strUserCreated` varchar(20) NOT NULL, "
		 	    +"`strUserEdited` varchar(20) NOT NULL, " 
		 	    +"`dteDateCreated` datetime NOT NULL,"
		 	    +"`dteDateEdited` datetime NOT NULL, "
		 	    +"`strClientCode` varchar(20) NOT NULL, "
		 	    +"PRIMARY KEY (`strCategoryCode`,`strClientCode`), "
		 	    +"KEY `intId` (`intId`) "
		 	...
		 	sql="CREATE TABLE IF NOT EXISTS `tblcitymaster` ( "
		 	   +"`strCityCode` varchar(20) NOT NULL, "
		 	   +"`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
		 	   +"`strCityName` varchar(200) NOT NULL, "
		 	   +"`strUserCreated` varchar(20) NOT NULL, "
		 	   +"`strUserEdited` varchar(20) NOT NULL, "
		 	   +"`dteDateCreated` datetime NOT NULL, "
		 	   +"`dteDateEdited` datetime NOT NULL, "
		 	...
		 	funExciseExecuteQuery(sql);
		 	sql="CREATE TABLE IF NOT EXISTS `tblexciselocationmaster` ( "
		 	   +"`strLocCode` varchar(10) NOT NULL, "
		 	   +"`intId` bigint(20) NOT NULL DEFAULT '0', "
		 	   +"`strLocName` varchar(150) NOT NULL DEFAULT '', "
		 	   +"`strLocDesc` varchar(150) NOT NULL DEFAULT '', "
			   +"`strAvlForSale` char(1) NOT NULL DEFAULT 'N', " 
			   +"`strExciseNo` varchar(30) NOT NULL DEFAULT '', "
			   +"`strType` varchar(15) NOT NULL DEFAULT '', "
			   +"`strPickable` char(1) NOT NULL DEFAULT 'N', " 
			   +"`strReceivable` varchar(255) DEFAULT NULL, " 
			   +"`strPropertyCode` varchar(10) NOT NULL DEFAULT '', "
			   +"`strExternalCode` varchar(50) NOT NULL DEFAULT '', "
			   +"`strMonthEnd` varchar(10) DEFAULT '', "
			   +"`strActive` char(1) NOT NULL DEFAULT 'N', "
			   ...
			   +"`strLocPropertyCode` varchar(255) DEFAULT NULL, "
			   +"PRIMARY KEY (`strLocCode`,`strClientCode`) "
			   +") ENGINE=InnoDB DEFAULT CHARSET=utf8;";
		 	
		 	funExciseExecuteQuery(sql);
		 	sql="CREATE TABLE IF NOT EXISTS `tblexcisepermitmaster` ( "
		 	   +"`strPermitCode` varchar(20) COLLATE latin1_general_ci NOT NULL, "
			   +"`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
			   +"`strPermitName` varchar(150) COLLATE latin1_general_ci NOT NULL, "
			   +"`strPermitNo` varchar(30) COLLATE latin1_general_ci NOT NULL, "
			   +"`dtePermitExp` varchar(50) COLLATE latin1_general_ci NOT NULL DEFAULT 'Life Time', "
			   +"`strPermitType` varchar(50) COLLATE latin1_general_ci NOT NULL, "
			   +"`strUserCreated` varchar(20) COLLATE latin1_general_ci NOT NULL, "
			   +"`strUserEdited` varchar(20) COLLATE latin1_general_ci NOT NULL, "
			   +"`dteDateCreated` datetime NOT NULL, "
			   +"`dteDateEdited` datetime NOT NULL, "
			   +"`strClientCode` varchar(20) COLLATE latin1_general_ci NOT NULL, "
			   +"PRIMARY KEY (`strPermitCode`,`strClientCode`), "
			   +"KEY `intId` (`intId`) "
			   +") ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;"; 
		 	
		 	funExciseExecuteQuery(sql);
		 	sql="CREATE TABLE IF NOT EXISTS `tblexciseposlinkup` ( "
		 	   +"`strPOSItemCode` varchar(20) NOT NULL, "
		 	   +"`strPOSItemName` varchar(100) NOT NULL, "
			   +"`strBrandCode` varchar(20) NOT NULL DEFAULT '', "
			   +"`strBrandName` varchar(100) NOT NULL DEFAULT '', "
			   +"`intConversionFactor` int(11) NOT NULL DEFAULT '1', "
			   +"`strClientCode` varchar(20) NOT NULL, "
			   +"PRIMARY KEY (`strPOSItemCode`,`strClientCode`) "
			   +") ENGINE=InnoDB DEFAULT CHARSET=utf8;";
		 	
		 	funExciseExecuteQuery(sql);
		 	sql="CREATE TABLE IF NOT EXISTS `tblexcisepossale` ( "
		 	   +"`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
		 	   +"`strPOSCode` varchar(20) NOT NULL, "
		 	   +"`strPOSItemCode` varchar(20) NOT NULL, "
		 	   +"`strPOSItemName` varchar(100) NOT NULL, "
		 	   +"`dteBillDate` datetime NOT NULL, "
		 	   +"`intQuantity` bigint(11) unsigned NOT NULL DEFAULT '0', "
		 	   +"`strBrandCode` varchar(255) DEFAULT NULL, "
		 	   +"`strBillNo` varchar(30) NOT NULL DEFAULT '', "
		 	...
		 	funExciseExecuteQuery(sql);
		 	sql="CREATE TABLE IF NOT EXISTS `tblexcisepropertymaster` ( "
		 	   +"`strClientCode` varchar(20) NOT NULL, "
			   +"`strBrandMaster` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strSizeMaster` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strSubCategory` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strCategory` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strSupplier` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strRecipe` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strCity` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +"`strPermit` varchar(20) NOT NULL DEFAULT 'Custom', "
			   +" strUserCreated` varchar(20) NOT NULL, "
			   +"`strUserEdited` varchar(20) NOT NULL, "
			   +"`dteDateCreated` datetime NOT NULL, "
			   +"`dteDateEdited` datetime NOT NULL, "
			...
			sql="CREATE TABLE IF NOT EXISTS `tblexciserecipermasterdtl` ( "
			   +"`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
			   +"`strRecipeCode` varchar(20) NOT NULL, "
			   +"`strBrandCode` varchar(10) NOT NULL DEFAULT '', "
			   +"`dblQty` decimal(18,3) NOT NULL DEFAULT '0.000', "
			   +"`strClientCode` varchar(10) NOT NULL, "
			   +"PRIMARY KEY (`intId`) "
		       +") ENGINE=InnoDB DEFAULT CHARSET=utf8; ";
			...
			sql="CREATE TABLE IF NOT EXISTS `tblexciserecipermasterhd` ( "
			   +"`strRecipeCode` varchar(20) NOT NULL, "
			   +"`intId` bigint(20) NOT NULL DEFAULT '0', "
			   +"`strParentCode` varchar(10) NOT NULL DEFAULT '', "
			   +"`strParentName` varchar(100) NOT NULL DEFAULT '', "
			   ...
			   +"`dteLastModified` datetime NOT NULL, "
			   +"`strClientCode` varchar(10) NOT NULL, "
			   +"PRIMARY KEY (`strRecipeCode`,`strClientCode`) "
			   +") ENGINE=InnoDB DEFAULT CHARSET=utf8;";
			funExciseExecuteQuery(sql);		
			
			sql="CREATE TABLE IF NOT EXISTS `tblexcisesaledata` ( "
			   +"`intBillNo` bigint(20) NOT NULL, "
			   +"`dteBillDate` datetime NOT NULL, "
			   +"`strLicenceCode` varchar(10) NOT NULL, "
			   +"`strSalesCode` varchar(20) NOT NULL, "
			   +"`strItemCode` varchar(20) NOT NULL, "
			   +"`intTotalPeg` int(10) NOT NULL, "
			   +"`intQty` int(11) NOT NULL DEFAULT '0', "
			   +"`strPermitCode` varchar(20) NOT NULL, "
			   +"`dblTotalAmt` decimal(18,4) NOT NULL DEFAULT '0.0000', "
			   +"`strUserCreated` varchar(10) NOT NULL, "
			   +"`dteCreatedDate` datetime NOT NULL, "
			   +"`strUserModified` varchar(10) NOT NULL, "
			   +"`dteLastModified` datetime NOT NULL, "
			   +"`strClientCode` varchar(10) NOT NULL, "
			   +"`strSourceEntry` varchar(50) NOT NULL DEFAULT 'Manual', "
			   +"PRIMARY KEY (`intBillNo`,`strClientCode`) "
			   +") ENGINE=InnoDB DEFAULT CHARSET=utf8;"; 
			funExciseExecuteQuery(sql);
			sql= " CREATE TABLE IF NOT EXISTS `tblexcisestockpostingdtl` (   "
				+ "`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
				+ "  `strPSPCode` varchar(20) NOT NULL, "
				+ "  `strBrandCode` varchar(10) NOT NULL, "
				+ "  `intSysBtl` bigint(20) unsigned NOT NULL DEFAULT '0',  "
				+ " `intSysML` bigint(20) unsigned NOT NULL DEFAULT '0',  "
				+ " `intSysPeg` bigint(20) unsigned NOT NULL DEFAULT '0',  "
				+ " `intPhyBtl` bigint(20) unsigned NOT NULL DEFAULT '0',  "
				+ " `intPhyML` bigint(20) unsigned NOT NULL DEFAULT '0',  "
				+ " `intPhyPeg` bigint(20) unsigned NOT NULL DEFAULT '0',  "
				+ " `strClientCode` varchar(10) NOT NULL, "
				+ "  PRIMARY KEY (`intId`)  ) "
				+ " ENGINE=InnoDB DEFAULT CHARSET=utf8; " ;
			funExciseExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblexcisestockpostinghd` (  "
				+ "`strPSPCode` varchar(20) NOT NULL,  "
				+ "`intId` bigint(20) NOT NULL,  `dtePostingDate` datetime NOT NULL,  "
				+ "`strLicenceCode` varchar(20) NOT NULL,  `strUserCreated` varchar(10) NOT NULL,  "
				+ "`dteDateCreated` datetime NOT NULL,"
				+ "  `strUserModified` varchar(10) NOT NULL,  "
				+ " `dteDateEdited` datetime NOT NULL,    "
				+ "`strClientCode` varchar(10) NOT NULL, "
				+ "  PRIMARY KEY (`strPSPCode`,`strClientCode`) "
				+ ") ENGINE=InnoDB DEFAULT CHARSET=utf8; ";
			funExciseExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tbllicencemaster` ( "
					+ "  `strLicenceCode` varchar(5) NOT NULL,  "
					+ " `intId` bigint(20) NOT NULL AUTO_INCREMENT,  "
					+ " `strLicenceNo` varchar(50) NOT NULL,   "
					+ "`strLicenceName` varchar(100) NOT NULL,  "
					+ " `strCity` varchar(100) NOT NULL DEFAULT 'C00001',   "
					+ "`strAddress1` varchar(200) NOT NULL DEFAULT '',  "
					+ " `strAddress2` varchar(200) NOT NULL DEFAULT '',  "
					+ " `strAddress3` varchar(200) NOT NULL DEFAULT '',  "
					+ " `strExternalCode` varchar(50) NOT NULL DEFAULT '',  "
					+ " `strContactPerson` varchar(100) NOT NULL DEFAULT '',   "
					+ "`longTelephoneNo` bigint(20) NOT NULL,   "
					+ "`strEmailId` varchar(100) NOT NULL DEFAULT '',  "
					+ " `strBusinessCode` varchar(100) NOT NULL DEFAULT '',  "
					+ " `strVATNo` varchar(100) NOT NULL DEFAULT '',  "
					+ " `strTINNo` varchar(100) NOT NULL DEFAULT '', "
					+ "  `strPINCode` varchar(50) NOT NULL DEFAULT '',   "
					...
					+ " `dteDateEdited` datetime NOT NULL,   "
					+ "`strClientCode` varchar(20) NOT NULL, "
					+ "  PRIMARY KEY (`strLicenceCode`,`strClientCode`), "
					+ "  KEY `intId` (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8;";
			funExciseExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblmanualsalesdtl` (  "
					+ "`intId` bigint(20) NOT NULL AUTO_INCREMENT, "
					+ "   `intSalesHd` bigint(20) NOT NULL,  "
					+ " `strBrandCode` varchar(20) NOT NULL,  "
					+ " `intBtl` int(11) NOT NULL DEFAULT '0',  "
					+ " `intPeg` int(11) NOT NULL DEFAULT '0',  "
					+ " `intML` int(11) NOT NULL DEFAULT '0',  "
					+ " `strBillGenFlag` char(2) NOT NULL DEFAULT 'N', "
					+ "  `strClientCode` varchar(20) NOT NULL,  "
					+ " PRIMARY KEY (`intId`)) ENGINE=InnoDB AUTO_INCREMENT=53929 DEFAULT CHARSET=utf8; "; 	
			funExciseExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblmanualsaleshd` (  "
					+ " `intId` bigint(20) NOT NULL AUTO_INCREMENT,  "
					+ "`strLicenceCode` varchar(20) NOT NULL, "
					+ " `dteBillDate` date NOT NULL,   "
					+ " `strUserCreated` varchar(20) NOT NULL, "
					+ "  `strUserEdited` varchar(20) NOT NULL,   "
					+ " `dteDateCreated` datetime NOT NULL,  "
					+ " `dteDateEdited` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,   "
					+ "`strClientCode` varchar(20) NOT NULL,  "
					+ " `strSourceEntry` varchar(50) NOT NULL DEFAULT 'Manual', "
			...
			sql=" CREATE TABLE IF NOT EXISTS `tblonedaypass` ("
					+ "   `intId` bigint(20) NOT NULL AUTO_INCREMENT,  "
					+ " `dteDate` date NOT NULL,  "
					+ " `intFromNo` bigint(20) NOT NULL, "
					+ "  `intToNo` bigint(20) NOT NULL,  "
					+ " `strUserCreated` varchar(20) COLLATE latin1_general_ci NOT NULL,  "
					+ " `strUserEdited` varchar(20) COLLATE latin1_general_ci NOT NULL,  "
					+ " `dteDateCreated` datetime NOT NULL,  "
					+ " `dteDateEdited` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,  "
					+ " `strClientCode` varchar(20) COLLATE latin1_general_ci NOT NULL, "
					+ "  PRIMARY KEY (`intId`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci; ";
			funExciseExecuteQuery(sql);
			
			sql="CREATE TABLE IF NOT EXISTS `tblopeningstock` (   "
					+ " `intId` bigint(20) NOT NULL AUTO_INCREMENT,  "
					+ " `strBrandCode` varchar(20) NOT NULL, "
					+ "  `intOpBtls` int(11) NOT NULL DEFAULT '0',  "
					+ " `intOpPeg` int(11) NOT NULL DEFAULT '0',  "
					+ " `intOpML` int(11) NOT NULL DEFAULT '0',   "
					+ "`strUserCreated` varchar(20) NOT NULL,   "
					+ "`strUserEdited` varchar(20) NOT NULL, "
					+ "  `dteDateCreated` datetime NOT NULL,   "
					+ "`dteDateEdited` datetime NOT NULL,   "
					+ "`strClientCode` varchar(20) NOT NULL,  "
					+ " PRIMARY KEY (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=1543 DEFAULT CHARSET=utf8;a";
			funExciseExecuteQuery(sql);
			...
			sql=" CREATE TABLE IF NOT EXISTS `tblpermitmaster` (   "
					...
					+ "PRIMARY KEY (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=1608 DEFAULT CHARSET=utf8; ";
			funExecuteQuery(sql);
			
			sql=" CREATE TABLE IF NOT EXISTS `tblratemaster` ( "
					+ "  `strBrandCode` varchar(20) COLLATE latin1_general_ci NOT NULL"
					+ ", `dblRate` decimal(18,3) NOT NULL DEFAULT '0.000', "
					+ "  `strUserCreated` varchar(20) COLLATE latin1_general_ci NOT NULL, "
					+ "  `strUserEdited` varchar(20) COLLATE latin1_general_ci NOT NULL, "
					+ "  `dteDateCreated` datetime NOT NULL, "
					+ "  `dteDateEdited` datetime NOT NULL, "
			...
			sql="CREATE TABLE IF NOT EXISTS `tblsizemaster` ( "
					+ "  `strSizeCode` varchar(20) NOT NULL, "
					+ "  `intId` bigint(20) NOT NULL AUTO_INCREMENT, "
					+ "  `strSizeName` varchar(200) NOT NULL, "
					+ "  `intQty` int(11) NOT NULL DEFAULT '0',"
					...
					+ "  `strClientCode` varchar(20) NOT NULL,  "
					+ " PRIMARY KEY (`strSizeCode`,`strClientCode`),  "
					+ " KEY `intId` (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;  ";
			funExciseExecuteQuery(sql);
			
			sql="CREATE TABLE IF NOT EXISTS `tblsubcategorymaster` ( "
					+ "  `strSubCategoryCode` varchar(20) NOT NULL,"
					+ "   `intId` bigint(20) NOT NULL AUTO_INCREMENT,"
					+ "   `strSubCategoryName` varchar(200) NOT NULL, "
					+ "  `intPegSize` int(11) NOT NULL DEFAULT '30',  "
					+ " `strCategoryCode` varchar(20) NOT NULL, "
					+ "  `intMaxSaleQty` int(10) unsigned NOT NULL DEFAULT '0',"
					+ "   `intAvailableSizes` int(10) unsigned NOT NULL DEFAULT '0', "
					+ "  `strIsDecimal` varchar(50) NOT NULL DEFAULT 'decimal',  "
					+ " `strUserCreated` varchar(20) NOT NULL, "
					+ "  `strUserEdited` varchar(20) NOT NULL, "
					+ "  `dteDateCreated` datetime NOT NULL, "
					+ "  `dteDateEdited` datetime NOT NULL,  "
					+ " `strClientCode` varchar(20) NOT NULL, "
					+ "  PRIMARY KEY (`strSubCategoryCode`,`strClientCode`),  "
					+ " KEY `intId` (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;  ";
		
			funExciseExecuteQuery(sql);
            sql=" CREATE TABLE IF NOT EXISTS `tblsuppliermaster` ("
            		+ "  `strSupplierCode` varchar(20) NOT NULL, "
            		+ " `intId` bigint(20) NOT NULL AUTO_INCREMENT,"
            		+ "   `strSupplierName` varchar(100) NOT NULL,"
            		+ "   `strAddress` varchar(500) NOT NULL DEFAULT '', "
            		+ "  `strVATNo` varchar(100) NOT NULL DEFAULT '',  "
            		+ " `strTINNo` varchar(100) NOT NULL DEFAULT '', "
            		+ "  `strCityCode` varchar(100) NOT NULL DEFAULT '',  "
            		+ " `strPINCode` varchar(50) NOT NULL DEFAULT '', "
            		+ "  `strContactPerson` varchar(100) NOT NULL DEFAULT '', "
            		+ "  `longTelephoneNo` bigint(20) NOT NULL, "
            		+ "  `strEmailId` varchar(100) NOT NULL DEFAULT '', "
            		...
            		+ " KEY `intId` (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8; ";
            		
            funExciseExecuteQuery(sql);

           sql=" CREATE TABLE IF NOT EXISTS `tbltpdtl` ("
           		+ "  `intId` bigint(20) unsigned NOT NULL AUTO_INCREMENT, "
           		+ "  `strTPCode` varchar(20) NOT NULL,  "
           		+ " `strBrandCode` varchar(20) NOT NULL,  "
           		+ " `intBottals` int(11) NOT NULL DEFAULT '0', "
           		+ "  `dblBrandTotal` decimal(18,3) NOT NULL DEFAULT '0.000',  "
           		+ " `dblBrandTax` decimal(18,3) NOT NULL DEFAULT '0.000', "
           		+ "  `dblBrandFee` decimal(18,3) NOT NULL DEFAULT '0.000', "
           		+ "  `intBrandCases` int(11) NOT NULL DEFAULT '0', "
           		+ "  `strBrandBatchNo` varchar(100) DEFAULT '''''', "
           		+ "  `monofmfg` varchar(50) DEFAULT '''''',  "
           		+ " `strRemark` varchar(500) DEFAULT '''''',  "
           		+ " `strClientCode` varchar(20) NOT NULL, "
           		+ "  PRIMARY KEY (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=4345 DEFAULT CHARSET=utf8; "; 	
           funExciseExecuteQuery(sql);
           
           sql=" CREATE TABLE IF NOT EXISTS `tbltphd` (  "
           		+ " `strTPCode` varchar(20) NOT NULL, "
           		+ "  `intId` bigint(20) NOT NULL AUTO_INCREMENT, "
           		+ "  `strSupplierCode` varchar(20) NOT NULL,  "
           		+ " `strLicenceCode` varchar(20) NOT NULL, "
           		+ "  `strTPNo` varchar(20) NOT NULL,"
           		+ "   `dblTotalPurchase` decimal(18,3) NOT NULL DEFAULT '0.000',"
           		+ "   `strInvoiceNo` varchar(100) NOT NULL,  "
           		+ " `strTpDate` date NOT NULL,  "
           		+ " `dblTotalTax` decimal(18,3) NOT NULL DEFAULT '0.000', "
           		+ "  `dblTotalFees` decimal(18,3) NOT NULL DEFAULT '0.000', "
           		+ "  `dblTotalBill` decimal(18,3) NOT NULL DEFAULT '0.000', "
           		+ "  `strUserCreated` varchar(20) NOT NULL,  "
           		+ " `strUserEdited` varchar(20) NOT NULL,  "
           		+ " `dteDateCreated` datetime NOT NULL,  "
           		+ " `dteDateEdited` datetime NOT NULL,  "
           		+ " `strClientCode` varchar(20) NOT NULL,  "
           		+ " `Column 17` varchar(20) NOT NULL,  "
           		+ " PRIMARY KEY (`strTPCode`,`strClientCode`),  "
           		+ " KEY `intId` (`intId`) ) ENGINE=InnoDB AUTO_INCREMENT=2020 DEFAULT CHARSET=utf8; "; 
           funExciseExecuteQuery(sql);
           
           sql="CREATE TABLE IF NOT EXISTS `tblmonthend` ( "
        	+ " `strLocCode` VARCHAR(255) NOT NULL, "
        	+ " `strMonthEnd` VARCHAR(255) NOT NULL, "
        	...
        	+ " PRIMARY KEY (`strLocCode`, `strMonthEnd`) "
        	+ " ) "
  ...
  /* 		sql= " DELETE FROM `tbltreemast`; " ;
   	...
   	//indexing Entry
   	   ...
   	   sql="ALTER TABLE `tblopeningstock` "
  	   		  + "ADD COLUMN `strLicenceCode` VARCHAR(20) NOT NULL AFTER `intId`;";
        funExciseExecuteQuery(sql);
       
       sql="ALTER TABLE `tbllicencemaster` ADD COLUMN `strPropertyCode` VARCHAR(10) NOT NULL AFTER `strClientCode`, "
	       +" DROP PRIMARY KEY, ADD PRIMARY KEY (`strLicenceCode`, `strClientCode`, `strPropertyCode`); ";
        funExciseExecuteQuery(sql);
       
       sql = " ALTER TABLE `tblcompanymaster`	DROP PRIMARY KEY, DROP INDEX `intId`,	ADD PRIMARY KEY (`intId`); ";
		funExecuteQuery(sql);
		
	   sql="ALTER TABLE `tbllicencemaster` "
		   +"ADD COLUMN `strMonthEnd` VARCHAR(10) NULL DEFAULT '' AFTER `strPropertyCode`;";
	   funExciseExecuteQuery(sql);
	   
		sql="ALTER TABLE `tblexcisesaledata` "
				 + " ADD COLUMN `strPOSItem` VARCHAR(25) NOT NULL DEFAULT '' AFTER `strSourceEntry`,"
				 + " ADD COLUMN `strRemark` VARCHAR(75) NOT NULL DEFAULT '' AFTER `strPOSItem` ";
