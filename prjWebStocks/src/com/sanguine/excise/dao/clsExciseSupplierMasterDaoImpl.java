...
public class clsExciseSupplierMasterDaoImpl implements clsExciseSupplierMasterDao{
	...
	public List funGetObject(String code,String clientCode)
	{
		...
		try{
			Session currentSession=exciseSessionFactory.getCurrentSession();
			Query query = currentSession.createQuery("from clsExciseSupplierMasterModel a,clsCityMasterModel b "
					+ "where a.strSupplierCode= :supplierCode and a.strCityCode=b.strCityCode and a.strClientCode= :clientCode");
