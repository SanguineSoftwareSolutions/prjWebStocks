...
public class clsSubCategoryMasterDaoImpl implements clsSubCategoryMasterDao{
	...
	public List funGetObject(String code, String clientCode) {		
		...
		try{
			Session currentSession=exciseSessionFactory.getCurrentSession();
			Query query = currentSession.createQuery("from clsSubCategoryMasterModel a,clsCategoryMasterModel b "
					+ "where a.strSubCategoryCode= :subCategoryCode and a.strCategoryCode=b.strCategoryCode and a.strClientCode= :clientCode");
