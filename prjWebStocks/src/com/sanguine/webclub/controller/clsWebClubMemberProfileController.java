...
//			String memberCode ="";
//			String custID = objMemberProfileService.funGetCustomerID(mpModel.getStrCustomerCode(), clientCode);
//			if(mpModel.getStrCustomerID()=="01")
//			{
//				
//				memberCode = memProfileBean.getStrMemberCode() + " "+mpModel.getStrCustomerID();
...
//			}
		...
		private void funPrepardDependentModel(clsWebClubMemberProfileBean memProfileBean,clsWebClubMemberProfileModel objMemberProfile  ,HttpServletRequest req)
		{
			...
			//clsWebClubDependentMasterModel objDependentMasterModel = new clsWebClubDependentMasterModel();
...
//		//Open MemberProfile
//				@RequestMapping(value = "/saveMemberPreProfile", method = RequestMethod.GET)
//				public ModelAndView funOpenFormMenberProfile(Map<String,Object> model ,HttpServletRequest request){
//					String urlHits="1";
//					try{
//						urlHits=request.getParameter("saddr").toString();
//					}catch(NullPointerException e){
