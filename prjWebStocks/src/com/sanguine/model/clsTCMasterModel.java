...
{	
	...
	public void setStrTCName(String strTCName) {
		this.strTCName = (String) funSetDefaultValue(strTCName, "");
	}
	...
	public void setStrApplicable(String strApplicable) {
		this.strApplicable =  (String) funSetDefaultValue(strApplicable, "N");
	}
	...
	public void setIntMaxLength(int intMaxLength) {
		this.intMaxLength =  (int) funSetDefaultValue(intMaxLength, "0");
	}*/
