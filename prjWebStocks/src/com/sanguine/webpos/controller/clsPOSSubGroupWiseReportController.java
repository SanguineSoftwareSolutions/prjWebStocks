...
public class clsPOSSubGroupWiseReportController {
	...
	/*
	public JSONArray funGetAllSubGroup(String strClientCode)
	{
		List sglist=new ArrayList<String>();
		JSONArray jArry = new JSONArray();
		String posUrl = "http://localhost:8080/prjSanguineWebService/APOSMastersIntegration/funGetAllSubGroup";
		try {
		    ...
		    jArry = (JSONArray) jObj.get("allSGData");
		}catch(Exception ex)
		{
			ex.printStackTrace();
		}
