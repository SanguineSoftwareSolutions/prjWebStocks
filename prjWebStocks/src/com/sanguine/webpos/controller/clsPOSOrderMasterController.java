...
//Open POSOrderMaster
	...
	public @ResponseBody clsPOSOrderMasterBean funSetSearchFields(@RequestParam("orderCode") String orderCode,HttpServletRequest req)
	{
		...
		/*String posUrl = "http://localhost:8080/prjSanguineWebService/APOSSearchIntegration/funGetPOSSearchData"
			+ "?masterName=POSOrderMaster&searchCode="+orderCode+"&clientCode="+clientCode;*/
		String posUrl = "http://localhost:8080/prjSanguineWebService/APOSMastersIntegration/funGetOrderMasterData"
				+ "?orderCode="+orderCode+"&clientCode="+clientCode;
