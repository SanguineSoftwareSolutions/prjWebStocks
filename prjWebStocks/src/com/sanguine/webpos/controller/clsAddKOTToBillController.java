...
public class clsAddKOTToBillController {
	...
	public @ResponseBody clsAddKOTToBillBean funGetBilList(HttpServletRequest req)
	{
	 ...
	 private clsAddKOTToBillBean funGetTableList(String posCode)
	 {
			...
			String posUrl = clsPOSGlobalFunctionsController.POSWSURL+"/APOSMastersIntegration/funGetTableList"
					+ "?posCode="+posCode;
	 ...
	 private clsAddKOTToBillBean funGetKOTList(String tableName,String posCode)
	 {
			...
			String posUrl = clsPOSGlobalFunctionsController.POSWSURL+"/WebPOSTransactions/funGetKOTListForAddKOTToBill"
					+ "?posCode="+posCode+"&tableName="+tableName;
	 ...
	 private clsAddKOTToBillBean funGetBilList(String posCode)
	 {
			...
			String posUrl = clsPOSGlobalFunctionsController.POSWSURL+"/WebPOSTransactions/funGetUnsettleBillListForAddKOTToBill"
					+ "?posCode="+posCode;
