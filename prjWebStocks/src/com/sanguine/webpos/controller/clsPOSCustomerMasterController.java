...
//Open POSCustomerMaster
	...
	public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsPOSCustomerMasterBean objBean,BindingResult result,HttpServletRequest req)
	{
		...
		try
		{
			...
			//jObjCustomerMaster.put("strOfficeLandmark", objBean.getStrOfficeLandmark());
			...
			//jObjCustomerMaster.put("strOfficeAddress", objBean.getStrOfficeAddress());
            ...
            conn.disconnect();		
		// jSONObject=objGlobal.funPOSTMethodUrlJosnObjectData(posURL, jObjCustomerTypeMaster);
			//String result1=objGlobal.funPOSTMethodUrlJosnObjectData(posURL, jObjCustomerTypeMaster);
	...
	public @ResponseBody clsPOSCustomerMasterBean funSetSearchFields(@RequestParam("POSCustomerCode") String CustomerCode,HttpServletRequest req)
	{
		...
		String posUrl = clsPOSGlobalFunctionsController.POSWSURL+"/APOSMastersIntegration/funLoadCustomeMasterData"
			+ "?searchCode="+CustomerCode+"&clientCode="+clientCode;
