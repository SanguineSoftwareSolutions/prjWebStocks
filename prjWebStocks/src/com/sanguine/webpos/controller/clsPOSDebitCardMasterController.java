...
//Save or Update DebitCardMaster
	...
	public @ResponseBody clsPOSDebitCardMasterBean funSetSearchFields(@RequestParam("cardTypeCode") String cardTypeCode,HttpServletRequest req)
	{
		...
		String posUrl = "http://localhost:8080/prjSanguineWebService/APOSMastersIntegration/funGetDebitCardMasterData"
			+ "?cardTypeCode="+cardTypeCode+"&clientCode="+clientCode;
...
//		JSONArray jObjSearchDetails=(JSONArray) jObjSearchDetails.get("POSDebitCardMaster");
...
//			objPOSDebitCardMaster.setStrSetExpiryDt((String) jObjSearchDetails.get(""));
	...
	public @ResponseBody List<clsSettlementDetailsBean> funLoadSettlmentData(@RequestParam("cardTypeCode") String cardTypeCode,HttpServletRequest req)
	{
		...
		String posUrl = "http://localhost:8080/prjSanguineWebService/APOSMastersIntegration/funGetDebitCardSettlementDtl"
			+ "?clientCode="+clientCode+"&cardTypeCode="+cardTypeCode;
