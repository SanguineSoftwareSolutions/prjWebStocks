...
//Open ShiftMaster
	...
	public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsPOSShiftMasterBean objBean,BindingResult result,HttpServletRequest req)
	{
		...
		//	SONObject objJson=objGlobal.funPOSTMethodUrlJosnObjectData(posURL, jObjCustomerTypeMaster);
	...
	public @ResponseBody clsPOSShiftMasterBean funSetSearchFields(@RequestParam("POSShiftCode") String shiftCode,HttpServletRequest req)
	{
		...
		JSONObject jObjSearchDetails = objGlobal.funGETMethodUrlJosnObjectData(clsPOSGlobalFunctionsController.POSWSURL+"/APOSMastersIntegration/funLoadShiftMasterData"
				+ "?searchCode="+shiftCode+"&clientCode="+clientCode);
