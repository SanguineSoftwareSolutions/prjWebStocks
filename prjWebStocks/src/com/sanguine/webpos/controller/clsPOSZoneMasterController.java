...
public class clsPOSZoneMasterController{
	...
	public @ResponseBody clsPOSZoneMasterBean funSetSearchFields(@RequestParam("POSZoneCode") String ZoneCode,HttpServletRequest req)
	{
		...
		JSONObject jObjSearchDetails = objGlobal.funGETMethodUrlJosnObjectData(clsPOSGlobalFunctionsController.POSWSURL+"/APOSMastersIntegration/funLoaddZoneMasterData"
				+ "?searchCode="+ZoneCode+"&clientCode="+clientCode);
