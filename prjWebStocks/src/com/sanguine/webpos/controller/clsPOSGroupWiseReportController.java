...
//			list.add(jObjtemp.get("dblAmtWithTax"));
	...
	{
		String posCode="";
		String posUrl = "http://localhost:8080/prjSanguineWebService/WebPOSPOSMaster/funGetPOSNameData";
...
/*	
	public String funGetSGCode(String strSGName)
	{
		String sgCode="";
		String posUrl = "http://localhost:8080/prjSanguineWebService/WebPOSSGMaster/funGetSGNameData";
		try {
			JSONObject objRows = new JSONObject();
		    objRows.put("strSGName", strSGName);
		    
		    JSONObject jObj = objGlobalFunctions.funPOSTMethodUrlJosnObjectData(posUrl,objRows);
		    sgCode= jObj.get("strSubGroupCode").toString();
//			URL url = new URL(posUrl);
//		
//			HttpURLConnection conn = (HttpURLConnection) url.openConnection();
//			 	conn.setRequestMethod("POST");
...
//		listPos.add("ALL");
//		String posUrl = "http://localhost:8080/prjSanguineWebService/APOSIntegration/funGetPOS";
//			
//		System.out.println(posUrl);
//		
//		try {
