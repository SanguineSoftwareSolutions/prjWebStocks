...
//				
//				
//				map.put(josnObjRet.get("strCardName"), josnObjRet.get("strCardTypeCode"));
//			}
//			
//		model.put("cardTypeList",cardTypeList);
		
//		Map<String, String> cardName= objPOSGlobal.funGetAllDebitCardForMaster(clientCode);
//		if(cardName.isEmpty())
//		{
//			cardName.put(0, "");
//		}		
...
//		public  @ResponseBody boolean funCheckCustomerName(@RequestParam("strCustomerCode")  String Name,HttpServletRequest req) 
//		{
//			String clientCode =req.getSession().getAttribute("clientCode").toString();
//			int count=objPOSGlobal.funCheckName(Name,"",clientCode,"POSRegisterDebitCardMasterForCustomer");
//			if(count>0)
//			 return false;
//			else
//				return true;
...
//	
	 ...
	 @RequestMapping(value ="/checkCardString" ,method =RequestMethod.GET)
		...
		{
		 	String clientCode =req.getSession().getAttribute("clientCode").toString();	
		 	String posUrl = "http://localhost:8080/prjSanguineWebService/APOSMastersIntegration/funCheckCardString"
		 		+ "?cardString="+cardString+"&clientCode="+clientCode;
