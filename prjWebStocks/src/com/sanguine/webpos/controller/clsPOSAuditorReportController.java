...
public class clsPOSAuditorReportController {
	...
	//for pos date
        ...
        /*  listOperatorDtl=(List<clsPOSAuditorReportBean>) jObj.get("listOfOperatorDtl");
          listSettleDetail=(List<clsPOSAuditorReportBean>) jObj.get("listOfBillSettleDtl");
          listVoidBillDetail=(List<clsPOSAuditorReportBean>) jObj.get("listOfVoidBillDtl");
          */
      
          Gson gson = new Gson();
          Type listType = new TypeToken<List<clsPOSAuditorReportBean>>() {}.getType();
