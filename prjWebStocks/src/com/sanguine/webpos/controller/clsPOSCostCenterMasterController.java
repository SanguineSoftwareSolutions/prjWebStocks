...
//				printerList.add(" ");
	...
	//Assign filed function to set data onto form for edit transaction.
		...
		public @ResponseBody clsCostCenterBean funSetSearchFields(@RequestParam("POSCostCenterCode") String costCenterCode,HttpServletRequest req)
		{
			...
			String posUrl = "http://localhost:8080/prjSanguineWebService/APOSMastersIntegration/funGetCostCenterMasterData"
				+ "?costCenterCode="+costCenterCode+"&clientCode="+clientCode;
