...
public class clsPOSCustomerTypeMasterController {
	...
	public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsPOSCustomerTypeMasterBean objBean,BindingResult result,HttpServletRequest req)
	{
		...
		try
		{
			...
			jObjGroupMaster.put("Operational", "N");
			jObjGroupMaster.put("OperationType", objBean.getStrOperationType());*/
           ...
           HttpURLConnection conn = (HttpURLConnection) url.openConnection();
			...
			//sString result1=objGlobal.funPOSTMethodUrlJosnObjectData(posURL, jObjCustomerTypeMaster);
	...
	//Assign filed function to set data onto form for edit transaction.
			...
			public @ResponseBody clsPOSCustomerTypeMasterBean funSetSearchFields(@RequestParam("POSCustomerTypeCode") String CustomerTypeCode,HttpServletRequest req)
			{
				...
				JSONObject jObjSearchDetails = objGlobal.funGETMethodUrlJosnObjectData(clsPOSGlobalFunctionsController.POSWSURL+"/APOSMastersIntegration/funLoadCustomerTypeMasterData"
						+ "?searchCode="+CustomerTypeCode+"&clientCode="+clientCode);
