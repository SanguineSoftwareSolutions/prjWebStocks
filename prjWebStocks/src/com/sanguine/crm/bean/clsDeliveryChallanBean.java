...
public class clsDeliveryChallanBean{
//Variable Declaration
	...
	private List<clsDeliveryChallanModelDtl> listclsDeliveryChallanModelDtl;
	
	private List<clsInvoiceBean> listclsInvoiceBean;
//Setter-Getter Methods
	...
	public List<clsDeliveryChallanModelDtl> getListclsDeliveryChallanModelDtl() {
		return listclsDeliveryChallanModelDtl;
	}
	public void setListclsDeliveryChallanModelDtl(
			List<clsDeliveryChallanModelDtl> listclsDeliveryChallanModelDtl) {
		this.listclsDeliveryChallanModelDtl = listclsDeliveryChallanModelDtl;
	}
	...
	public List<clsInvoiceBean> getListclsInvoiceBean() {
		return listclsInvoiceBean;
	}
	public void setListclsInvoiceBean(List<clsInvoiceBean> listclsInvoiceBean) {
		this.listclsInvoiceBean = listclsInvoiceBean;
	}
