...
private clsGlobalFunctionsService objGlobalFunctionsService;
	...
	//Open Intent Status
			...
			public ModelAndView funOpenSOIntentStausModal(@RequestParam("soCode") String soCode,HttpServletRequest req,HashMap<String,Object> model){
				...
				String sql="select e.strPIcode,a.strPOCode,DATE_FORMAT(a.dtPODate,'%d-%m-%Y'), a.strSuppCode,d.strPName, "
						+ " b.strProdCode,c.strPartNo,c.strProdName, "
						+ " c.strUOM,b.dblOrdQty,b.dblOrdQty,b.dblPrice,0.00,'Complete' "
						+ "  from tblpurchaseorderhd a,tblpurchaseorderdtl b,tblproductmaster c,"
						+ " tblpartymaster d,tblpurchaseindendhd e "
						+ " where a.strPOCode=b.strPOCode and b.strProdCode=c.strProdCode and a.strSuppCode=d.strPCode "
						+ "  and a.strSOCode=e.strPIcode  and a.strClientCode='"+clientCode+"' "
			...
			public  ArrayList<Object> funSetDataSOPurchaseStatusModal(@RequestParam("soCode") String soCode,HttpServletRequest req)
			{
				...
				String sqlData="select a.strSGCode,a.dtCreatedDate, a.strProdCode ,a.strProdName ,a.strPartNo,a.dblCostRM,a.dtLastModified, "
						   +"a.strSaleNo,a.strUOM,a.dtCreatedDate,a.dblBatchQty,a.dblBatchQty,a.strSpecification,a.strProdCode "
