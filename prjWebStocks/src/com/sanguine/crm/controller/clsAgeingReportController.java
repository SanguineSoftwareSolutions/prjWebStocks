...
//Open ExciseChallan
	...
	private void funCallReportAgeingReport(String SCCode,String dNCode , String fromDate,String  toDate,String  dNType,String  orderBy,String  permissionType,String  exporttype,HttpServletResponse resp,HttpServletRequest req)
	{
		try {
		   ...
		   String sqlDtl=" SELECT CONCAT(c.strPName,' ',c.strSAdd1,' ',c.strSAdd2,' ',c.strSCity,' ',c.strSPin,' ',c.strSState,' ',c.strSCountry) AS subContractingDtl "
            		+ " ,b.strJACode,b.dteJADate,d.dteExpDate,e.dteSRDate,e.strSRNo, "
            		...
            		+ " WHERE b.strSCCode=c.strPCode AND b.strJACode=d.strJACode AND d.strDNCode=e.strSCDNCode and "
            		+ " Date(b.dteJADate) between '"+fromDate+"' and '"+toDate+"' "
            		+ " and b.strClientCode=c.strClientCode "
            		+ " and b.strClientCode=d.strClientCode "
            		+ " and b.strClientCode=e.strClientCode "
