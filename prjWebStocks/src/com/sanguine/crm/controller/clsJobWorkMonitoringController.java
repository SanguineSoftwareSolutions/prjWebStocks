...
public class clsJobWorkMonitoringController {
	...
	public ModelAndView funOpenDueDateMonitoringReport(Map<String,Object> model ,HttpServletRequest request)
	{
		...
		if ("2".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmJobWorkMonitoringReport_1", "command",
					new clsReportBean());
		} else {
			
			
			
			return new ModelAndView("frmJobWorkMonitoringReport", "command",
					new clsReportBean());
		}
	...
	private void funCallSCrapGenratedReport(String dNCode,String SCCode,String type,String fromDate,String toDate,HttpServletResponse resp,HttpServletRequest req )
	{
		try{
			...
			String sqlDtl= " select k.strProdName as RawProd,e.dblQty,e.dblQty*e.dblWeight,b.strRef,b.dteJADate,j.strPName,"
					+ " j.strSAdd1,j.strSAdd2,j.strSCity,j.strSState,j.strSCountry,c.strNatureOfProcessing,f.dteSRDate,"
					+ " l.strProdName as FiniProd,g.dblAcceptQty,(g.dblQtyRbl-g.dblAcceptQty) as pendingQty,d.dteExpDate "
					+ " from tbljoborderallocationhd b , tbljoborderallocationdtl c,tbldeliverynotehd d,tbldeliverynotedtl e, "
					+ " tblscreturnhd f,tblscreturndtl g, tblpartymaster j,tblproductmaster k,tblproductmaster l "
