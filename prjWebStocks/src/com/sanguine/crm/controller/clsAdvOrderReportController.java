...
import com.sanguine.util.clsReportBean;
	...
	public class clsAdvOrderReportController {
	  ...
	  @RequestMapping(value = "/frmAdvanceOrderReports", method = RequestMethod.GET)
		public ModelAndView funOpenAdvanceOrderReport(
			...
			if ("2".equalsIgnoreCase(urlHits)) {
				return new ModelAndView("frmAdvanceOrderReports_1", "command",
						new clsReportBean());
			} else {
				return new ModelAndView("frmAdvanceOrderReports", "command",
						new clsReportBean());
			}
...
//	  		 sqlAdvOrd ="select i.strSGName,   g.strProdCode,g.strProdName,SUM(b.dblQty) AS dblQty, SUM(b.dblWeight*b.dblQty) AS dblWeight,b.strSOCode,c.strCharCode, "
...
//	  		 sqlAdvOrd = " select i.strSGName,   g.strProdCode,g.strProdName,b.dblQty AS dblQty, b.dblWeight AS dblWeight,b.strSOCode,c.strCharCode, "
...
//	  	  else{
//	  		  
//	 		 sqlAdvOrd ="  select i.strSGName,   g.strProdCode,g.strProdName,b.dblQty AS dblQty, b.dblWeight AS dblWeight,b.strSOCode,c.strCharCode,  c.strCharValue,e.strPName,  DATE_FORMAT(a.dteSODate,'%d-%m-%Y'),b.strRemarks,d.strCharName "
...
//	 		 		+ " ORDER BY a.strSOCode,e.strPName,b.strProdCode,b.dblWeight,h.strGName,i.strSGName,c.strCharCode  " ; 
	  		 ...
	  		 sqlAdvOrd = " select i.strSGName,   g.strProdCode,g.strProdName,b.dblQty AS dblQty, b.dblWeight AS dblWeight,b.strSOCode,ifnull(c.strCharCode,''), "
		  		 		+ " ifnull(c.strCharValue,''),e.strPName,  DATE_FORMAT(a.dteSODate,'%d-%m-%Y'),b.strRemarks,ifnull(d.strCharName,''),IfNull(g.strProdCode,'') "
		  		 		+ " from tblsalesorderhd a "
		  		 		+ " left outer join tblsalesorderdtl b on a.strSOCode=b.strSOCode "
		  		 		+ " left outer join  tblsaleschar c on c.strSOCode=a.strSOCode and c.strProdCode=b.strProdCode and b.strRemarks=c.strAdvOrderNo "
		  		 		+ " left outer join tblcharacteristics d on c.strCharCode=d.strCharCode "
		  		 		+ "  left outer join tblpartymaster e on a.strCustCode=e.strPCode "
		  		 		+ " left outer join tblproductmaster g on b.strProdCode=g.strProdCode "
		  		 		+ " left outer join tblsubgroupmaster i on g.strSGCode=i.strSGCode "
		  		 		+ " left outer join tblgroupmaster h on h.strGCode=i.strGCode "
		  		 		+ " inner join tblattachdocument f on f.strCode=a.strSOCode and f.strActualFileName=g.strProdCode "
		  		 		+ " Where h.strGCode IN   "+strGCodes+"  "
		  		 		+ " AND i.strSGCode IN "+strSGCodes+"  "
		  		 		+ " and a.strStatus='"+orderType+"' "
		  		 		+ " AND DATE(a.dteFulmtDate) BETWEEN '"+dteFromDate+"' AND '"+dteToDate+"' "
		  		 		+ " GROUP BY c.strCharCode, b.strProdCode,b.dblWeight,h.strGName,i.strSGName, e.strPName ,b.strRemarks "
		 		 ...
		 		 sqlAdvOrd ="  select i.strSGName,   g.strProdCode,g.strProdName,b.dblQty AS dblQty, b.dblWeight AS dblWeight,b.strSOCode,ifnull(c.strCharCode,''),  ifnull(c.strCharValue,''),e.strPName,  DATE_FORMAT(a.dteSODate,'%d-%m-%Y'),b.strRemarks,ifnull(d.strCharName,'') "
		 		 		+ " from tblsalesorderhd a left outer join tblsalesorderdtl b on a.strSOCode=b.strSOCode   "
		 		 		+ " left outer join  tblsaleschar c on c.strSOCode=a.strSOCode and c.strProdCode=b.strProdCode and b.strRemarks=c.strAdvOrderNo "
		 		 		+ " left outer join tblcharacteristics d on c.strCharCode=d.strCharCode "
		 		 		+ " left outer join tblpartymaster e on a.strCustCode=e.strPCode "
		 		 		+ " left outer join tblproductmaster g on b.strProdCode=g.strProdCode "
		 		 		+ " left outer join tblsubgroupmaster i on g.strSGCode=i.strSGCode "
		 		 		+ " left outer join tblgroupmaster h on h.strGCode=i.strGCode  "
		 		 		+ " left outer join tblattachdocument f on f.strCode!=a.strSOCode "
		 		 		+ " where h.strGCode IN  "+strGCodes+" "
		 		 		+ " AND i.strSGCode IN "+strSGCodes+" "
		 		 		+ "  and a.strStatus='"+orderType+"' "
		 		 		+ " AND DATE(a.dteFulmtDate) BETWEEN '"+dteFromDate+"' AND '"+dteToDate+"' "
		 		 		+ " GROUP BY a.strSOCode,b.strProdCode,b.dblWeight,c.strCharCode, h.strGName,i.strSGName, e.strPName ,b.strRemarks "
					 ...
					 Blob image = null;
						byte[ ] imgData = null ;
					  	...
					  	try{
							...
							try{
							imgData=Base64.getDecoder().decode(imgData);//decoding of byte
							}catch(Exception ex)
							{
							ex.printStackTrace();	
							}
	...
	}  catch(Exception ex)
		{
		  ...
		  @RequestMapping(value = "/frmProductionAdvOrderReport", method = RequestMethod.GET)
			public ModelAndView funOpenProductionAdvanceOrderReport(
					Map<String, Object> model, HttpServletRequest request) {
				...
				if ("2".equalsIgnoreCase(urlHits)) {
					return new ModelAndView("frmProductionAdvOrderReport_1", "command",
							new clsReportBean());
				} else {
					return new ModelAndView("frmProductionAdvOrderReport", "command",
							new clsReportBean());
				}
...
//		String sqlAdvOrd = " select i.strSGName,   g.strProdCode,g.strProdName,b.dblQty AS dblQty, b.dblWeight AS dblWeight,b.strSOCode,c.strCharCode, "
//	  		 		+ " c.strCharValue,e.strPName,  DATE_FORMAT(a.dteSODate,'%d-%m-%Y'),b.strRemarks,d.strCharName,IfNull(g.strPartNo,'') "
//	  		 		+ " from tblsalesorderhd a "
//	  		 		+ " inner join tblsalesorderdtl b on a.strSOCode=b.strSOCode "
//	  		 		+ " inner join  tblsaleschar c on c.strSOCode=a.strSOCode and c.strProdCode=b.strProdCode "
...
//	  		 		+ " ORDER BY e.strPName,b.strProdCode,b.dblWeight,h.strGName,i.strSGName,c.strCharCode  ";	 
		...
		String sqlAdvOrd = " select i.strSGName,   g.strProdCode,g.strProdName,b.dblQty AS dblQty, b.dblWeight AS dblWeight,b.strSOCode,ifnull(c.strCharCode,''), "
	  		 		+ " ifnull(c.strCharValue,''),e.strPName,  DATE_FORMAT(a.dteSODate,'%d-%m-%Y'),b.strRemarks,ifnull(d.strCharName,''),IfNull(g.strProdCode,'') "
	  		 		+ " from tblsalesorderhd a "
	  		 		+ " left outer join tblsalesorderdtl b on a.strSOCode=b.strSOCode "
	  		 		+ " left outer join  tblsaleschar c on c.strSOCode=a.strSOCode and c.strProdCode=b.strProdCode and b.strRemarks=c.strAdvOrderNo "
...
//					}
//					
//					File fileUserImage = new File(System.getProperty("user.dir") + "\\ProductImageIcon\\" + objProdBean.getStrRemark()+"_"+objProdBean.getStrProdCode()+"_"+objProdBean.getDblWeight()+ ".jpg");
					//prodImage=System.getProperty("user.dir") + "\\ProductImageIcon";
...
//                  fos.close();
		   ...
		   try {
		      ...
		      //  byte[] buffer = new byte[DEFAULT_BUFFER_SIZE];
		            ...
		            {
		            	//File downloadFile = new File(prodImage+"\\"+strImgNmae);
