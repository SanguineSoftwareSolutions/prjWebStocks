...
private clsGlobalFunctionsService objGlobalFunctionsService;
	...
	//Open Intent Status
			...
			public  ArrayList<Object> funSetDataSOIntentStatusModal(@RequestParam("soCode") String soCode,HttpServletRequest req)
			{
				...
				String sqlData=" select a.strPIcode,b.strProdCode,c.strProdName,c.strPartNo,b.strInStock,b.dblQty,DATE_FORMAT(b.dtReqDate,'%d-%m-%Y') "
						+ " from tblpurchaseindendhd a,tblpurchaseindenddtl b ,tblproductmaster c "
						+ " where a.strPIcode=b.strPIcode and  a.strDocCode='"+soCode+"' "
