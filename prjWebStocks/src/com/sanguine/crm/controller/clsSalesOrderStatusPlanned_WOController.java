...
private clsGlobalFunctionsService objGlobalFunctionsService;
	...
	//Open Intent Status
			...
			/*	String sqlData="select a.strSGCode,a.dtCreatedDate, a.strProdCode ,a.strProdName ,a.strPartNo,a.dblCostRM,a.dtLastModified, "
				...
				String sqlData=" select a.strPDCode,DATE_FORMAT(a.dtPDDate,'%d-%m-%Y'),b.strProdCode,d.strProdName,d.strPartNo, "
						+ " b.dblQtyProd,a.strWOCode,DATE_FORMAT(c.dtWODate,'%d-%m-%Y') ,c.dblQty "
						+ " from tblproductionhd a,tblproductiondtl b,tblworkorderhd c ,tblproductmaster d "
						+ " where a.strPDCode=b.strPDCode  and a.strWOCode=c.strWOCode "
						+ " and b.strProdCode=d.strProdCode  and c.strSOCode='"+soCode+"'  "
