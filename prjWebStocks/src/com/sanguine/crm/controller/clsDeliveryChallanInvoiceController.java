...
public class clsDeliveryChallanInvoiceController {
	...
	private void funCallDeliveryNoteReport(String dNCode,String type,String fromDate,String toDate,String strReportType,HttpServletResponse resp,HttpServletRequest req )
	{
		...
		try{
			...
			String sqlHd=" select a.dteDNDate,a.strVehNo,b.strPName,b.strSAdd1,b.strSAdd2,b.strSCity,b.strSState,b.strSPin,b.strSCountry  "
						+" from tbldeliverynotehd a, tblpartymaster b where a.strDNCode='"+dNCode+"' and a.strSCCode=b.strPCode  "
...
//			  String sqlDtl="select b.intId,a.strProdCode,b.strPartNo,b.strProdName,a.dblQty,b.strUOM "
...
//			            +   "   and c.dteDNDate between '"+fromDate+"' and '"+toDate+"'";
			...
			String sqlDtl=" select b.strProdCode as ProdCode,c.strPartNo as PartNo,c.strProdName as ProductName,b.dblQty as Qty, "
	...
	private void funCallDeliveryNoteInnvoiceReport(String dNCode,String type,String fromDate,String toDate,String strReportType,HttpServletResponse resp,HttpServletRequest req )
	{
		...
		try{
			...
			String sqlHd="  select a.dteDNDate,a.strVehNo,b.strPName,b.strSAdd1,b.strSAdd2,b.strSCity,b.strSState,b.strSPin,b.strSCountry,  "
					+ " a.strJACode as JW,c.strDispatchMode as modeofTransp  "
					+ " from tbldeliverynotehd a, tblpartymaster b, tbljoborderallocationhd c "
					+ " where a.strDNCode='"+dNCode+"' and a.strSCCode=b.strPCode  "
					+ " and a.strJACode=c.strJACode  and a.strClientCode='"+clientCode+"' "
					+ " and a.strClientCode=b.strClientCode  "; 
...
//	            jd.setQuery(newHDQuery); 
			...
			String sqlHdtable=" select c.strProdName,c.strPartNo as PartNo,b.dblQty as Qty "
					+ " from tbldeliverynotehd a,tbldeliverynotedtl b,tblproductmaster c,"
					+ " tbljoborderallocationdtl d where a.strDNCode=b.strDNCode "
					+ " and b.strProdCode=c.strProdCode and a.strDNCode='"+dNCode+"' "
					+ " and a.strJACode=d.strJACode and a.strClientCode =b.strClientCode "
			...
			String sqlDtl=" select c.strPartNo as PartNo,c.strProdName as ProductName,"
					+ " d.strNatureOfProcessing as Processing,b.dblQty as Qty, b.dblQty*b.dblWeight as Weight,"
					+ " (b.dblQty*b.dblRate) as Amount "
					+ " from tbldeliverynotehd a,tbldeliverynotedtl b,tblproductmaster c, tbljoborderallocationdtl d "
					+ " where a.strDNCode=b.strDNCode and b.strProdCode=c.strProdCode and a.strDNCode='"+dNCode+"' "
					+ " and a.strJACode=d.strJACode and a.strClientCode =b.strClientCode "
					+ " and b.strClientCode = c.strClientCode  and a.strClientCode='"+clientCode+"' ";
