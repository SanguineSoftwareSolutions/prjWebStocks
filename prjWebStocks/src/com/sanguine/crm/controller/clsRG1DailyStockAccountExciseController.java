...
public class clsRG1DailyStockAccountExciseController extends AbstractExcelView {
	...
	private clsGlobalFunctions objGlobalFunctions;
	  ...
	  public ModelAndView funOpenRG1DailyStockAccount(
				...
				if ("2".equalsIgnoreCase(urlHits)) {
					return new ModelAndView("frmRG-1DailyStockAccount_1", "command",
							new clsReportBean());
				} else {
					return new ModelAndView("frmRG-1DailyStockAccount", "command",
							new clsReportBean());
				}
		 }
	    ...
	    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response)
			...
			String SqlchaptoerNo = "select a.strExciseChapter,a.strSGDescHeader from tblsubgroupmaster a "
			...
			//HashMap <String ,ArrayList<clsRG1DailyStockAccountReportDtl>>	hmRG1rpt=new HashMap<String,ArrayList<clsRG1DailyStockAccountReportDtl>>();
...
//					String sqlProdChaptorWise=" select b.strProdCode,b.strProdName "
//							+ " from tblsubgroupmaster a,tblproductmaster b "
//							+ " where a.strSGCode=b.strSGCode and a.strExciseChapter='"+chp+"' ";
//					List listProdChaptorWise = objGlobalFunctionsService.funGetDataList(sqlProdChaptorWise,"sql");
//				
				...
				clsRG1DailyStockAccountReportDtl objDummyModel = new clsRG1DailyStockAccountReportDtl();
				 sql="  select date(d.dtSTDate),b.strExciseChapter,sum(c.dblQty) "
				 		+ "from tblproductmaster a "
				 		+ " inner join tblsubgroupmaster b on a.strSGCode=b.strSGCode "
				 		+ " left outer join tblstocktransferdtl c on a.strProdCode=c.strProdCode "
				 		+ " left outer join tblstocktransferhd d on c.strSTCode=d.strSTCode "
				 		+ " where b.strExciseChapter='"+chp+"' "
				 		+ " and date(d.dtSTDate) between '"+fromDate+"' and '"+toDate+"' "
				 		+ " group by d.dtSTDate,b.strExciseChapter order by date(d.dtSTDate) " ;
				 ...
				 sql="   select date(d.dteInvDate),b.strExciseChapter,sum(c.dblQty),sum(c.dblAssValue) "
				 		+ " from tblproductmaster a "
				 		+ " inner join tblsubgroupmaster b on a.strSGCode=b.strSGCode "
				 		+ " left outer join tblinvoicedtl c on a.strProdCode=c.strProdCode "
				 		+ " left outer join tblinvoicehd d on c.strInvCode=d.strInvCode "
				 		+ " where b.strExciseChapter='"+chp+"' and "
				 		+ " date(d.dteInvDate) between '"+fromDate+"' and '"+toDate+"' "
				 		+ " group by date(d.dteInvDate),b.strExciseChapter  "
				 		+ "order by date(d.dteInvDate); " ;
					 ...
					 for(int days=0; days<=diffDays;days++)
						{
						  ...
						  sql=" select sum(a.dblOpeningStk) from tblcurrentstock a ,tblsubgroupmaster b,tblproductmaster c "
						  		+ " where a.strProdCode=c.strProdCode "
						  		+ " and c.strSGCode=b.strSGCode and a.strLocCode='"+locCode+"' and a.strLocCode='"+locCode+"' "
						  		+ " and a.strUserCode='"+userCode+"' and b.strExciseChapter='"+chp+"' "
						  		+ " group by a.strLocCode,a.strUserCode;  ";
...
//					 for (Map.Entry<String, clsRG1DailyStockAccountReportDtl> entryOpeningMain : hmRG1rpt.entrySet()) 
//			           	{
//						 
//						 String keyOpeningMainOpeningMain =entryOpeningMain.getKey().toString();
//						 clsRG1DailyStockAccountReportDtl objMain =entryOpeningMain.getValue();
//					
//							 for (Map.Entry<String, clsRG1DailyStockAccountReportDtl> entryMFG : hmMFG.entrySet()) 
//					           	{
//								 
...
//								 
//								 for (Map.Entry<String, clsRG1DailyStockAccountReportDtl> entryINV : hmINV.entrySet()) 
//							           	{
//											 String keyINV = entryINV.getKey().toString();
//											 clsRG1DailyStockAccountReportDtl objINV = entryINV.getValue();
...
//								clsRG1DailyStockAccountReportDtl objINV =hmINV.get(eachfDate);
								...
								if(opQty>0.00 || mfgQty>0.00 || invQty>0.00 )
								{
									objMain.setDateInv(eachfDate);
									 ...
									 String sqlInvExTaxes=" select a.strInvCode,d.dblPercent,sum(c.dblTaxAmt) from tblinvoicehd a, tblinvoicedtl b,tblinvtaxdtl c,  "
...
//						 {
//							clsRG1DailyStockAccountReportDtl objRGModel=new clsRG1DailyStockAccountReportDtl();
...
//								openingStock=objGlobalFunctions.funCalculateStockForTrans(prodCode, locCode,startDate,lcForStockfromDate,clientCode, userCode,0.00);
...
//							List listMfgQty =  objGlobalFunctionsService.funGetDataList(sql,"sql");
...
//							}
//							
//							sql= " select Sum(b.dblQty),sum(b.dblAssValue) from tblinvoicehd a,tblinvoicedtl b "
//									+ " where  a.strInvCode=b.strInvCode and  b.strProdCode='"+prodCode+"' "
//									+ " and date(a.dteInvDate)='"+QueryfromDate+"'"
//									+ " group by b.strProdCode ";
//							List listInvQty =  objGlobalFunctionsService.funGetDataList(sql,"sql");
...
//								
//								
//								String sqlInvExTaxes="select a.strInvCode,d.dblPercent,c.dblTaxAmt from tblinvoicehd a, tblinvoicedtl b,tblinvtaxdtl c,tbltaxhd d "
...
////						List listOpBal =  objGlobalFunctionsService.funGetDataList(sql,"sql");
//						
...
//					}
				// hmRG1rpt.put(chp, listOBjModel);
			       ...
			       ///Bold Font
					...
					sheet.addMergedRegion(new CellRangeAddress(////Merging col 0to4 and row 0
					            0, //first row (0-based)
					            0, //last row  (0-based)
					...
					/////////// SecondRow/////////
					 ...
					 sheet.addMergedRegion(new CellRangeAddress(////Merging col 0to2 and row 1
					            1, //first row (0-based)
					            1, //last row  (0-based)
					            0, //first column (0-based)
					 ...
					 sheet.addMergedRegion(new CellRangeAddress(////Merging col 0to1 and row 2
					            2, //first row (0-based)
					            2, //last row  (0-based)
					            0, //first column (0-based)
			        ...
			        data=tblthirdRow.split(",");
					 ...
					 sheet.addMergedRegion(new CellRangeAddress(////Merging col 4to9 and row 8 
					            8, //first row (0-based)
					            8, //last row  (0-based)
	...
	//						 
	                ...
	                data=tblfouthRow.split(",");
					 ...
					 ///////////////Start Merging First row of table header////////
					  for(int i=0;i<4;i++)///////////
		              {
					  sheet.addMergedRegion(new CellRangeAddress(////Merging row 6to9and col 1,2,2,4 Table header
					            6, //first row (0-based)
					            9, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(///Merging col 4to 11 and row no is 6
					            6, //first row (0-based)
					            6, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(///Merging col 12to 13 and row no is 6
					            6, //first row (0-based)
					            6, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging col 14to 15 and row no is 6
					            6, //first row (0-based)
					            6, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging row  6 to 9 and col 16 
					            6, //first row (0-based)
					            9, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging row  6 to 9  and col 17
					            6, //first row (0-based)
					            9, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging col 18 to 19 and row  6
					            6, //first row (0-based)
					            6, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging row  6 to 9 and col 20 
					            6, //first row (0-based)
					            9, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging col 4th to 7 and row no 7
					            7, //first row (0-based)
					            7, //last row  (0-based)
					            4, //first column (0-based)
					            7  //last column  (0-based)
					    ));
					  sheet.addMergedRegion(new CellRangeAddress(//Merging col 8 to 11  and row no 7
					            7, //first row (0-based)
					            7, //last row  (0-based)
					  ...
					  for(int i=0;i<4;i++){
					  sheet.addMergedRegion(new CellRangeAddress(//Merging row 7 to 9  and col no 12,13,1415
					            7, //first row (0-based)
					            9, //last row  (0-based)
					  ...
					  sheet.addMergedRegion(new CellRangeAddress(//Merging row 7 to 9  and col no 18
					            7, //first row (0-based)
					            9, //last row  (0-based)
					            18, //first column (0-based)
					            18  //last column  (0-based)
					    ));
					  sheet.addMergedRegion(new CellRangeAddress(//Merging row 7 to 9  and col no 19
					            7, //first row (0-based)
					            9, //last row  (0-based)
...
//							  dataList.add(objRG.getStrProdName());
	...
	//					String SqlchaptoerNo = "select a.strExciseChapter from tblsubgroupmaster a "
	//							+ " where a.strClientCode='"+clientCode+"' group by a.strExciseChapter"; 
	//					List listchaptoerNo = objGlobalFunctionsService.funGetDataList(SqlchaptoerNo,"sql");
	//					
	//					List listStock = new ArrayList();
...
//							  String sql="select DATE_FORMAT(f.dteInvDate,'%d/%m/%Y') as dateInv,a.strProdCode,a.strProdName,a.dblOpeningStk ,sum(e.dblQty) as mfgQTY , "
...
//								  
//								  String sqlInvCode="select a.strInvCode from tblinvoicehd a, tblinvoicedtl b where a.strInvCode=b.strInvCode "
//									  		+ " and a.dteInvDate = '"+obj[3].toString()+"'  and b.strProdCode='"+obj[2].toString()+"' ";
//								  List listInvCode = objGlobalFunctionsService.funGetDataList(sqlInvCode,"sql"); 
//								  String invCodes="";
