...
private clsGlobalFunctionsService objGlobalFunctionsService;
	...
	//Open Intent Status
			...
			public ModelAndView funOpenSOIntentStausModal(@RequestParam("soCode") String soCode,HttpServletRequest req,HashMap<String,Object> model){
				...
				String sql =" select * from tblproductionhd a,tblworkorderhd b "
						+ " where a.strWOCode=b.strWOCode and b.strSOCode='"+soCode+"' "
			...
			public  ArrayList<Object> funSetDataSOStatusUnPlanned_WOModal(@RequestParam("soCode") String soCode,HttpServletRequest req)
			{
				...
				/*String sqlData="select a.strJOCode,a.dteJODate,b.strProdCode,a.dblQty,a.strSOCode, "
						...
						+ "from tbljoborderhd a ,tblproductmaster b where a.strClientCode='"+clientCode+"' and a.strProdCode=b.strProdCode";*/
				
				String sqlData=" select a.strProdCode,c.strProdName,c.strPartNo,a.strWOCode,DATE_FORMAT(a.dtWODate,'%d-%m-%Y'), "
						+ " a.dblQty,b.strProcessCode,d.strProcessName,b.strStatus,'','' "
						+ " from tblworkorderhd a ,tblworkorderdtl b,tblproductmaster c,tblprocessmaster d "
						+ " where a.strWOCode=b.strWOCode and a.strSOCode='"+soCode+"' "
						+ " and a.strProdCode=c.strProdCode and b.strProcessCode=d.strProcessCode "
						+ " and b.strClientCode ='"+clientCode+"'  and c.strClientCode='"+clientCode+"' "
						+ " and d.strClientCode='"+clientCode+"' and a.strClientCode='"+clientCode+"'  "; 
