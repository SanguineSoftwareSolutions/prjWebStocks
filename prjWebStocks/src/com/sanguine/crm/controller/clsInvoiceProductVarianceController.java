...
public class clsInvoiceProductVarianceController {
	...
	{		
		...
		String sql="select a.strSOCode,b.strProdCode,a.strCustCode,c.strPName,b.dblQty,b.dblAcceptQty "
				+ "from tblsalesorderhd a ,tblsalesorderdtl b,tblpartymaster c where b.strProdCode='"+strProdCode+"' "
				+ "and a.dteSODate='"+date+"' and a.strSOCode=b.strSOCode and c.strPCode=a.strCustCode and a.strClientCode='"+clientCode+"' and b.strClientCode='"+clientCode+"'";
	...
	List <clsSalesOrderDtl> lstSPDtl=objBean.getListSODtl();
	  for(clsSalesOrderDtl objModel:lstSPDtl)
	  {
		...
		{
		String sql="update tblsalesorderdtl a set a.dblAcceptQty='"+objModel.getDblQty()+"' where a.strSOCode='"+objModel.getStrSOCode()+"'  "
				  +" and a.strProdCode='"+objModel.getStrProdCode()+"' and a.strClientCode='"+clientCode+"' "; 
