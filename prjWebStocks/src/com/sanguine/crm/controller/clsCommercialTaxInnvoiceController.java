...
//				String [] dateTime=date[2].split(" ");
			...
			private void funCallReportComercialTaxInvReport(String strInvCode,String type,HttpServletResponse resp,HttpServletRequest req)
			{
				try {
					...
					String sqlHd="select date(a.dteInvDate),CONCAT(b.strMAdd1,',',b.strMAdd2,',',b.strMCity,',',b.strMPin) as address,b.strPName "
							+ " from tblinvoicehd a,tblpartymaster b  "
							+ " where  a.strCustCode=b.strPCode and  a.strInvCode='"+strInvCode+"' "
		            ...
		            String sqlDtl="select b.strProdName strProdName,a.dblQty as Quantity,a.dblUnitPrice as Rates,(a.dblUnitPrice* a.dblQty) as Amount  "
		            		+ " from tblinvoicedtl  a,tblproductmaster b "
		            		+ " where a.strProdCode=b.strProdCode "
		            		+ " and a.strInvCode='"+strInvCode+"' and a.strClientCode='"+clientCode+"'  ";
		          ...
		          double totalAmt =0.00;
		       	 ...
		       	 String sqltaxDtl="  select a.strTaxDesc,a.dblTaxAmt "
		       	 		+ "from tblinvtaxdtl  a where a.strInvCode='"+strInvCode+"' and a.strClientCode='"+clientCode+"'; ";
...
//			List list=objTaxMasterService.funGetTaxes(objTaxDtl.getStrTaxCode(), clientCode);
//			Object[] objArr = (Object[]) list.get(0);
		...
		jObjCustDtl.put("strAccountName", objLinkCust.getStrGDes());
		...
		String sql = "  select a.strInvCode,a.dblGrandTotal,b.strDebtorCode , "
				+ " c.strDebtorFullName,date(a.dteInvDate),a.strNarration,date(a.dteInvDate),a.strPackNo "
				+ " from dbwebmms.tblinvoicehd a,dbwebmms.tblpartymaster b ,dbwebbooks.tblsundarydebtormaster c "
				+ " where a.strCustCode =b.strPCode and  b.strDebtorCode = c.strDebtorCode  and a.strInvCode='"+objModel.getStrInvCode()+"' "
