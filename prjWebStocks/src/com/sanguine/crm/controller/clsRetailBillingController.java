		...
		@RequestMapping(value = "/AutoCompletGetProdNamewithSubgroup", method = RequestMethod.POST)
		 public @ResponseBody Set<clsProductMasterModel> GetProdNamewithSubgroup(@RequestParam String term ,@RequestParam String sgName,@RequestParam String custcode, HttpServletResponse response,HttpServletRequest request) {
					 ...
					 for (Object obj : list) 
					 {
						 ...
						 if (prodModel.getStrProdName().contains((ProdName.toUpperCase())))
						 {
								String sqlHd="select b.dteInvDate,a.dblUnitPrice,b.strInvCode  from tblinvoicedtl a,tblinvoicehd b "
										+" where a.strProdCode='"+prodModel.getStrProdCode()+"' and a.strClientCode='"+clientCode+"' and b.strInvCode=a.strInvCode and a.strInvCode Like'__RB%' " 
										+" and a.strCustCode='"+custCode+"' and  b.dteInvDate=(SELECT MAX(b.dteInvDate) from tblinvoicedtl a,tblinvoicehd b "
										+" where a.strProdCode='"+prodModel.getStrProdCode()+"' and a.strClientCode='"+clientCode+"' and b.strInvCode=a.strInvCode and a.strInvCode Like'__RB%' "
			...
			//		double dblCurrencyConv=1.0;
				/*	objHdModel =funPrepardModel(objBean,clientCode,userCode,propCode,req);
						...
						//	dblCurrencyConv=objModel.getDblConvToBaseCurr();
							...
							for(clsInvoiceDtlBean objInvDtl:listInvDtlBean)
							{
								...
								{					
									...
									objInvDtlModel.setDblPrice(objInvDtl.getDblRate());
									...
									objInvDtlModel.setDblUnitPrice(objInvDtl.getDblRate());
									...
									double prodRateForTaxCal=objInvDtl.getDblRate();
									if(objInvDtl.getDblWeight()>0)
									{
									...
									Map<String,String> hmProdTaxDtl=objGlobalFunctions.funCalculateTax(prodTaxDtl,"Sales",objGlobalFunctions.funGetDate("yyyy-MM-dd", objBean.getDteInvDate()), req);
							...
							for(Map.Entry<String,List<clsInvoiceModelDtl>> entry : hmInvCustDtl.entrySet())
							{
			                    ...
			                    //    String	invCode=objGlobalFunctions.funGenerateDocumentCodeForLocSeries("frmRetailBilling", objBean.getDteInvDate(),objBean.getStrLocCode(), req);
								...
								for(clsInvoiceModelDtl objInvItemDtl:listInvoiceDtlModel)
								{
									...
									{
									//	totalAmt+=objInvItemDtl.getDblAssValue();
										totalAmt+=objInvItemDtl.getDblPrice()*objInvItemDtl.getDblQty();
										List<clsInvoiceProdTaxDtl> listInvProdTaxDtl=hmInvProdTaxDtl.get(key);
										for( clsInvoiceProdTaxDtl objInvTaxModel :listInvProdTaxDtl)
										{
											if(objInvItemDtl.getStrProdCode().equals(objInvTaxModel.getStrProdCode()))
...
//							}
	...
	/*		
			private clsInvoiceHdModel funPrepardModel(clsInvoiceBean objBean,String clientCode,String userCode,String propCode,HttpServletRequest req)
			{
				clsInvoiceHdModel objHdModel =null;	
				boolean res=false;
				if(null!=req.getSession().getAttribute("hmAuthorization"))
				{
					...
					if(hmAuthorization.get("RetailBilling"))
					{
						res=true;
					}
				}
				...
				{
					strDocNo=objGlobalFunctions.funGenerateDocumentCodeForLocSeries("frmRetailBilling", objBean.getDteInvDate(),objBean.getStrLocCode(), req);
					objHdModel.setStrInvCode(strDocNo);
				...
				{
					objHdModel =objInvoiceHdService.funGetInvoiceHd(objBean.getStrInvCode(),clientCode);
				        if(objHdModel== null){
				        	strDocNo=objGlobalFunctions.funGenerateDocumentCodeForLocSeries("frmRetailBilling", objBean.getDteInvDate(),objBean.getStrLocCode(), req);
							objHdModel.setStrInvCode(strDocNo);
							objHdModel.setIntid(lastNo);
				 ...
				 objHdModel.setDteInvDate(objGlobalFunctions.funGetDate("yyyy-MM-dd", objBean.getDteInvDate()));  
			        objHdModel.setStrAgainst("");
			        objHdModel.setStrSOCode("");
			        objHdModel.setStrCustCode(objBean.getStrCustCode());
			        objHdModel.setStrDktNo("");
			        objHdModel.setStrDulpicateFlag("N");
			        objHdModel.setStrExciseable("N");
			        objHdModel.setStrInvNo("");
			        objHdModel.setStrLocCode(objBean.getStrLocCode());
			        objHdModel.setStrMInBy("");
			        objHdModel.setStrNarration("");
			        objHdModel.setStrPackNo("");
			        objHdModel.setStrPONo("");
			        objHdModel.setStrReaCode("");
			        objHdModel.setStrSAdd1("");
			        objHdModel.setStrSAdd2("");
			        objHdModel.setStrSCity("");
			        objHdModel.setStrSCtry("");
			        objHdModel.setStrSerialNo("");
			        objHdModel.setStrSPin("");
			        objHdModel.setStrSState("");
			        objHdModel.setStrTimeInOut("");
			        objHdModel.setStrVehNo("");
			        objHdModel.setStrWarraValidity("");
			        objHdModel.setStrWarrPeriod("");
			        objHdModel.setDteLastModified(objGlobal.funGetCurrentDateTime("yyyy-MM-dd"));
			        objHdModel.setDblDiscount(0.00);
			        objHdModel.setDblDiscountAmt(0.00);
			        objHdModel.setDblGrandTotal(0.00);
			        objHdModel.setDblTaxAmt(0.00);
			        objHdModel.setDblTotalAmt(0.00);
			        
			        List<clsInvoiceGSTModel> listGST=new ArrayList<clsInvoiceGSTModel>();
			       
			        
			        List<clsInvoiceModelDtl> listInvDtlModel =new ArrayList<clsInvoiceModelDtl>();
			        for(clsInvoiceDtlBean objDtlBean : objBean.getListclsInvoiceModelDtl())
			        {
			        	Map<String,List<clsInvoiceModelDtl>> hmInvCustDtl=new HashMap<String,List<clsInvoiceModelDtl>>();
			        	Map<String,Map<String,clsInvoiceTaxDtlModel>> hmInvCustTaxDtl=new HashMap<String,Map<String,clsInvoiceTaxDtlModel>>();
			        	Map<String,List<clsInvoiceProdTaxDtl>> hmInvProdTaxDtl=new HashMap<String,List<clsInvoiceProdTaxDtl>>();
			        	...
			        	List list=objGlobalFunctionsService.funGetList("select strExciseable,strPickMRPForTaxCal from tblproductmaster "
							...
							String excisable=arrProdDtl[0].toString();
							String pickMRP=arrProdDtl[1].toString();
							String key=objDtlBean.getStrCustCode()+"!"+excisable;
			        	...
			        	clsInvoiceModelDtl objInvDtlModel =new clsInvoiceModelDtl();
			        	objInvDtlModel.setDblAssValue(0.00);
			        	objInvDtlModel.setDblBillRate(0.00);
			        	...
			        	objInvDtlModel.setDblWeight(0.00);
			        	objInvDtlModel.setIntindex(0);
			        	...
			        	objInvDtlModel.setStrProdType("");
			        	objInvDtlModel.setStrRemarks("");
			        	objInvDtlModel.setStrSerialNo("");
			        	objInvDtlModel.setStrSOCode("");
			        	listInvDtlModel.add(objInvDtlModel);
			        	
			        	double disAmt =0;
			        	String prodCodeForTax="";
			        	prodCodeForTax=prodCodeForTax+"!"+objDtlBean.getStrProdCode()+","+objDtlBean.getDblRate()+","+objDtlBean.getStrCustCode()+","+objDtlBean.getDblQty()+","+disAmt;
			        	Map<String,String> hGST= objGlobalFunctions.funCalculateTax(prodCodeForTax,"Sales",objGlobalFunctions.funGetDate("yyyy-MM-dd", objBean.getDteInvDate()) , req);
...
//				String [] dateTime=date[2].split(" ");
			...
			public @ResponseBody clsProductMasterModel funAssignFields(@RequestParam("prodCode") String prodCode,@RequestParam("custCode") String suppCode
			...
			{		
				...
				String sql=" select max(a.dblPrice) from tblstockadjustmentdtl a,tblstockadjustmenthd b "
						+ " where a.strSACode=b.strSACode and a.strProdCode='"+prodCode+"' and a.strRemark like '%Invoice%'"
