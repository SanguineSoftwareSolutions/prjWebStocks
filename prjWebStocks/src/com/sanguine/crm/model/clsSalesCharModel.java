...
public class clsSalesCharModel implements Serializable{
	...
	@Id
	@AttributeOverrides({
		@AttributeOverride(name="strSOCode",column=@Column(name="strSOCode")),
@AttributeOverride(name="strProdCode",column=@Column(name="strProdCode")),
@AttributeOverride(name="strCharCode",column=@Column(name="strCharCode"))
	})
