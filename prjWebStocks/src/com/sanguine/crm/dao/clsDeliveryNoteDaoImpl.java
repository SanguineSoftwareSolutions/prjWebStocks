...
public class clsDeliveryNoteDaoImpl implements clsDeliveryNoteDao{
	...
	public List funGetDelNoteHdObject(String DNCode,String clientCode) {
		...
		try{
			Query query = sessionFactory.getCurrentSession().createQuery("from clsDeliveryNoteHdModel a,clsPartyMasterModel b "
					+ "where a.strDNCode = '"+DNCode+"' and a.strSCCode=b.strPCode and "
	...
	public List funGetDelNoteDtlList(String DNCode, String clientCode) {
		List<Object> list = new ArrayList<Object>();
		try{
			Query query = sessionFactory.getCurrentSession().createQuery("from clsDeliveryNoteDtlModel a,clsProductMasterModel b,clsProcessMasterModel c "
					+ "where a.strDNCode = '"+DNCode+"' and a.strProdCode=b.strProdCode and  a.strProcessCode= c.strProcessCode and "
	...
	public boolean funDeleteDtl(String DNCode, String clientCode) {
		...
		try{
			...
			Query query = currentSession.createQuery("delete clsDeliveryNoteDtlModel where strDNCode = :strDNCode "
