...
public class clsCRMDayEndDaoImpl implements clsCRMDayEndDao {
	...
	public String funGetCRMDayEndLocationDate(String strLocCode,String strClientCode) {
		...
		try
		{
	//	Query query=sessionFactory.getCurrentSession().createQuery("select max(strDayEnd) from clsCRMDayEndModel where strClientCode=:clientCode and strLocCode=:strLocCode ");
