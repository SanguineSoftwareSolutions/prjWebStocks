...
public class clsDeliveryChallanDaoImpl implements clsDeliveryChallanDao{
	...
	{
		Query query = sessionFactory.getCurrentSession().createQuery("delete clsDeliveryChallanModelDtl "
				+ " where strDCCode=:dcCode and strClientCode=:clientCode "
	...
	public List <Object> funGetDeliveryChallan(String dcCode,String clientCode)
	{
		...
		Query query = sessionFactory.getCurrentSession().createQuery(" from clsDeliveryChallanHdModel a "
				+ "	,clsLocationMasterModel d ,clsPartyMasterModel e "
							+ "	where a.strDCCode=:dcCode and "
	...
	public List <Object> funGetDeliveryChallanDtl(String dcCode,String clientCode)
	{
		...
		Query query = sessionFactory.getCurrentSession().createQuery(" from clsDeliveryChallanModelDtl a,clsProductMasterModel b ,clsDeliveryChallanHdModel c "
							+ "	where a.strDCCode=:dcCode and a.strProdCode= b.strProdCode and a.strClientCode=:clientCode  and a.strDCCode=c.strDCCode "
