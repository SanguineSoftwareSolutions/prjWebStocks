...
public class clsSubContractorGRNDaoImpl implements clsSubContractorGRNDao{
	...
	{
		Query query = sessionFactory.getCurrentSession().createQuery("delete clsSubContractorGRNModelDtl "
				+ " where strSRCode=:strSRCode and strClientCode=:clientCode "
	...
	public List <Object> funLoadSubContractorGRNHDData(String docCode,String clientCode)
	{
		...
		Query query = sessionFactory.getCurrentSession().createQuery(" from clsSubContractorGRNModelHd a,clsPartyMasterModel b, clsLocationMasterModel c "
				+ "	where a.strSRCode=:SRCode and a.strLocCode=c.strLocCode and a.strSCCode=b.strPCode and a.strClientCode=:clientCode "
	...
	public List <Object> funLoadSubContractorGRNDtlData(String docCode,String clientCode)
	{
		...
		Query query = sessionFactory.getCurrentSession().createQuery(" from clsSubContractorGRNModelDtl a,clsProductMasterModel b "
