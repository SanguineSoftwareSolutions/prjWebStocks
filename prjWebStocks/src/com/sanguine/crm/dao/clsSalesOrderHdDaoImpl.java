...
public class clsSalesOrderHdDaoImpl implements clsSalesOrderHdDao{
	...
	public List <Object> funGetSalesOrder(String soCode,String clientCode){
		...
		Query query = sessionFactory.getCurrentSession().createQuery(" from clsSalesOrderHdModel a "
				+ "	,clsLocationMasterModel d ,clsPartyMasterModel e "
							+ "	where a.strSOCode=:soCode and "
	...
	{	
		...
		Query query = sessionFactory.getCurrentSession().createQuery(" from clsSalesOrderDtl a,clsProductMasterModel b "
							+ "	where a.strSOCode=:soCode and a.strProdCode= b.strProdCode and a.strClientCode=:clientCode "
	...
	{
			Query query = sessionFactory.getCurrentSession().createQuery("delete clsSalesOrderDtl "
					+ " where strSOCode=:soCode and strClientCode=:clientCode "
	...
	public void funUpdateSOforPO(String soCode,String clientCode)
	{
		...
		Query query = sessionFactory.getCurrentSession().createQuery("update clsSalesOrderHdModel set strCloseSO='Y'  "
				+ " where strSOCode=:soCode and strClientCode=:clientCode "
				+ "and strClientCode=:clientCode");
		query.setParameter("soCode", soCode);
		query.setParameter("clientCode", clientCode);
	...
	public List funGetMultipleSODtl(String[] soCodes, String clientCode)
	{
		...
		String sql = " select b.strProdCode,c.strProdName,c.strProdType,Sum(b.dblAcceptQty),c.dblCostRM ,"
				+ " c.dblWeight "
				+ " from tblsalesorderhd a,tblsalesorderdtl b,tblproductmaster c "
				+ " where a.strSOCode=b.strSOCode "
				+ " and b.strProdCode=c.strProdCode and a.strCloseSO='N' "
				+ " and ( "+soCode+" ) "
	...
	{
		Query query = sessionFactory.getCurrentSession().createSQLQuery("delete from tblsaleschar "
				+ " where strSOCode='"+soCode+"' and strProdCode='"+prodCode+"' ");
	...
	public List funGetMultipleSODtlForInvoice(String[] soCodes, String clientCode)
	{
		...
		List objSalesList=null;
		String sql = " select b.strProdCode,c.strProdName,c.strProdType,sum(b.dblAcceptQty),c.dblMRP , b.dblWeight,a.strCustCode"
				+ " ,d.dblDiscount,a.strSOCode  "
				+ " from tblsalesorderhd a,tblsalesorderdtl b,tblproductmaster c,tblpartymaster d "
				+ " where a.strSOCode=b.strSOCode and b.strProdCode=c.strProdCode and ( "+soCode+" ) "
				+"  and a.strCustCode=d.strPCode and a.strClientCode='"+clientCode+"' "
				+ " and b.strClientCode='"+clientCode+"' and c.strClientCode='"+clientCode+"' "
				+ " group by a.strCustCode,b.strProdCode ";
		
		/*
		String sql = " select b.strProdCode,c.strProdName,c.strProdType,b.dblAcceptQty,c.dblCostRM ,"
	...
	{
		 	String hql=" from  clsSalesOrderHdModel   where dteSODate between :fDate and :tDate "
			 		+ " and  strClientCode=:clientCode ";
