			...
			<div id="tab1" class="tab_content" style="height: 520px">
				<table class="masterTable">
					...
					<tr>
				        ...
				        <td colspan="3">
				        	<s:input type="number" min="0" max="100" step="0.01" id="txtTaxPer" name="txtTaxPer" path="dblPercent" required="true"  cssClass="BoxW116px right-Align"/>
					...
					<tr>
					    ...
					    <td colspan="3"><s:input id="txtPropCode" name="txtPropCode" path="strPropertyCode" cssClass="BoxW116px"/></td>
					</tr>
