  ...
  <head>
	...
	<tr><th colspan="2"></th></tr>
				<tr>
					...
					<td><s:input  id="txtProdOrderCode" path="strDocCode" ondblclick="funHelp('ProductionOrder')" cssClass="searchTextBox" cssStyle="width:150px;background-position: 136px 4px;"/></td>
				</tr>
