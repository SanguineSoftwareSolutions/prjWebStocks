...
<script>
		...
		$(document).ready(function(){
			...
			$("#dtFromDate").datepicker('setDate', 'today');	
	...
	<br />
		<s:form name="frmPurchaseRegisterReport" method="POST" action="rptPurchaseRegisterReport.html" target="_blank" >
			...
			<tr>
				...
				<td><s:input type="text" id="dtToDate" path="dteToDate" required="true" class="calenderTextBox" /></td>				
			</tr>
			...
			<tr>
				...
				<td colspan="2"><label id=lblSuppName> All Supplier </label>	</td>	
