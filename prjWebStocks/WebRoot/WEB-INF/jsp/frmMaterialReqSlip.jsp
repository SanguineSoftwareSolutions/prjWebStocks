...
<table class="transTable">
	...
	<tr>
		...
		<s:input type ="text" path="strFromDocCode" id="txtFromReqCode" name="strFromReqCode" readonly="true" placeholder="From Requisition Code"  class="searchTextBox" style="width: 162px;background-position: 150px 2px;" ondblclick="funHelp('MaterialReq')"/> 
		</td>  
