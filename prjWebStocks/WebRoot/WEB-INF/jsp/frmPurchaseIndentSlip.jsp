...
<table class="masterTable">
	...
	<tr>
		...
		<s:input type ="text" path="strFromDocCode" id="txtFromPICode" name="strFromPICode" readonly="true" placeholder="From PI Code"  class="searchTextBox" style="width: 118px;background-position: 104px 2px;" ondblclick="funHelp('PICode')"/> 
		</td>
