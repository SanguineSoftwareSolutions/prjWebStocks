		...
		<s:form name="frmStockTransferSlip" method="POST" action="rpttransferslip.html" target="_blank">
			...
			<tr>
			    ...
			    <tr>
			        ...
			        <td>
			        	<s:input id="txtFromSTCode" path="strFromDocCode" ondblclick="funHelp('stktransfercode')" cssClass="searchTextBox" cssStyle="width:150px;background-position: 136px 4px;"/>
			        </td>
			        <td></td>
