...
<head>
	...
	<script type="text/javascript">
 		...
 		{ 
 			...
 			$("#txtArriveFromDate" ).datepicker('setDate', 'today');
 			
 			$( "#txtArriveToDate" ).datepicker({ dateFormat: 'dd-mm-yy' });
 			$("#txtArriveToDate" ).datepicker('setDate', 'today');
 			
 			$( "#txtDepFromDate" ).datepicker({ dateFormat: 'dd-mm-yy' });
 			$("#txtDepFromDate" ).datepicker('setDate', 'today');
 			
 			$("#txtdepToDate" ).datepicker({ dateFormat: 'dd-mm-yy' });
 			$("#txtdepToDate" ).datepicker('setDate', 'today');
		...
		function pageselectCallback(page_index, jq)
		{
		    ...
		    var newcontent='<table id="tblResevFlash" class="transTablex" style="width: 100%;font-size:11px;font-weight: bold;"><tr bgcolor="#75c0ff"><td id="labls2">Reservation</td><td id="labls3">Arrive</td><td id="labls13">Depature</td><td id="labls14">Guest</td><td id="labls14">RoomNo</td><td id="labls14">Source</td><td id="labls14">Coparate</td><td id="labls14">Deposite</td><td id="labls14">User</td><td id="labls14">Res.Type</td><td style="width: 10%;"></td></tr>';
