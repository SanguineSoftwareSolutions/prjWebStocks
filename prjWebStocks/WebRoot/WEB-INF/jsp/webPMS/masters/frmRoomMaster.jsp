		...
		$.ajax({
	        ...
	        success: function(response)
	        {
	        	...
	        	else
	        	{
	        		...
	        		$("#txtFloorNo").val(response.strFloorNo);
	        		...
	        		$("#txtBathType").val(response.strBathType);
				...
				<div id="tab1" class="tab_content" style="height: 400px">
					...
					<table class="masterTable">
						...
						<tr>
							...
							<td><s:input id="txtFloorNo" path="strFloorNo" cssClass="longTextBox" style="width: 190px"/></td>
						...
						<tr>
							...
							<td><s:input id="txtBathType" path="strBathType"  cssClass="longTextBox" style="width: 190px"/></td>
						</tr>
						<tr>
