		        ...
		        {		        	
		        		if('Invalid Code' == response.strInvCode)
		        		{
							...
							$.each(response.listSalesReturn, function(i,item)
			       	       	 {
								funfillProductRowDC(response.listSalesReturn[i]);
		        ...
		        {		        	
		        		...
		        		//	funRemoveAllRows();
							...
							$.each(response.listclsInvoiceModelDtl, function(i,item)
			       	       	    	 {
								funfillProductRowDC(response.listclsInvoiceModelDtl[i]);
...
//								$('#').val(response.);
	...
	function funfillProductRowDC(prductDtl)
	{
		var table = document.getElementById("tblProdDet");
