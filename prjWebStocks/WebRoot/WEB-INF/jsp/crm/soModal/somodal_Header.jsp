...
// 				"dialogHeight:600px;dialogWidth:600px;dialogLeft:400px;");
	...
	function funChangeSO()
	{
		...
		document.InSoStatus.action = "frmUnplanned_Item.html?soCode="+soCode;
		document.InSoStatus.submit();
	}
...
<body>
	...
	<s:form name="InSoStatus" method="GET" action="frmUnplanned_Item.html?soCode=${soCode}">
		<table style="margin:auto;">
			<tr>
				<td><label>Against</label></td>
				<td><select id="txtAgainst" class="BoxW124px">
				...
				<td></td>
				<td id="btnGenJobOrder"><input type="submit"
					id="generateJobOrder"  value="Display" /></td>
			</tr>
		</table>
	</s:form>
</body>
