...
<table class="masterTable">
	...
	<tr>
		...
		<td width="150px" colspan="2"><s:input type ="text" path="strDocCode" id="txtOpStkCode" name="strGRNCode" readonly="readonly"  class="searchTextBox" style="width: 150px;background-position: 136px 4px;" ondblclick="funHelp('opstock')"/> </td>
