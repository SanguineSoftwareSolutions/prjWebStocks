...
<script type="text/javascript">
	...
	$(document).ready(function() 
			{
				...
				$.ajax({
				    ...
				    success: function(response)
				    {
						...
						{
						  funAddRow(response[i][0],response[i][1],response[i][2],response[i][3],response[i][4],response[i][5],response[i][6]);
						});
	 ...
	 */
	function funAddRow(strProdCode,strProdName,CStkQty,phystkQty,variance,UnitPrice,value)
	{
	    ...
	    row.insertCell(0).innerHTML= "<input readonly=\"readonly\" class=\"Box\" size=\"20%\"  id=\"txtPOSItemCode."+(rowCount)+"\" value='"+strProdCode+"' />";
