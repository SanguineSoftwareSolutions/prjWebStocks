	...
	<s:form method="post" action="uploadFile.html"
		...
		<table class="masterTable">
			...
			<tr>
				...
				<td><input type="hidden" name="formName"
					value="<c:out value="${formTitle}"/>" /> <input type="hidden"
					name="test" value="<c:out value="${formTitle}"/>" /> <c:out
						value="${formTitle}" /></td>
				<td>Code</td>
				
				<td><input type="hidden" name="code" id="code" 
					value="<c:out value="${docCode}"/>" /> <c:out value="${docCode}" /></td>
			</tr>
		</table>
