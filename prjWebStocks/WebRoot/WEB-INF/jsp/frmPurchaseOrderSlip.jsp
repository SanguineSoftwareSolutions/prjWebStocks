	...
	<tr>
		...
		<table class="masterTable">
			...
			<td width="1%" colspan="2">		
				<s:input type ="text" path="strFromDocCode" id="txtFromPOCode" name="strFromPOCode" readonly="true" placeholder="From PO Code"  class="searchTextBox" style="width: 150px;background-position: 136px 4px;" ondblclick="funHelp('purchaseorder')"/>
			</td> 
