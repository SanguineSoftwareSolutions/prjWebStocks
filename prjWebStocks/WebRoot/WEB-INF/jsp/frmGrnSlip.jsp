...
<table class="masterTable">
	...
	<tr>
		...
		<s:input type ="text" path="strFromDocCode" id="txtFromGRNCode" name="strGRNCode" readonly="true" placeholder="From GRN Code"  class="searchTextBox" style="width: 150px;background-position: 136px 4px;" ondblclick="funHelp('grncode')"/> 
		</td>
