	...
	<script type="text/javascript">
		...
		**/
		...
		{			
			...
			row.insertCell(0).innerHTML= "<label>"+poCode+"</label>";
		...
		function funGetPODataForDetail()
		{
			...
			$.ajax({
				    ...
				    success: function(response)
				    {
						...
						row.insertCell(18).innerHTML= "<label id=\"label17\"> GRN Code</lable>";
						row.insertCell(19).innerHTML= "<label id=\"label18\"> User </lable> ";
						row.insertCell(20).innerHTML= "<label id=\"label19\"> Date Created </lable> ";
						row.insertCell(21).innerHTML= "<label id=\"label20\"> Authorise </lable> ";
						row.insertCell(22).innerHTML= "<label id=\"label21\"> Authorise Level </lable> ";
		...
		**/
		function funFillPODetail(poCode,poDate,delDate,suppCode,suppName,against,purIndent,subTotal,taxAmt,finalAmt
				,pordCode,prodName,uom,orderQty,price,totalPrice,recQty,balQty,GRNCode,user,dateCreated,authorise,authoriseLevel)
		{
			...
			row.insertCell(13).innerHTML= "<label>"+orderQty+"</label>";
			row.insertCell(14).innerHTML= "<label>"+price+"</label>";
			row.insertCell(15).innerHTML= "<label>"+totalAmt+"</label>";
			row.insertCell(16).innerHTML= "<label>"+recQty+"</label>";
			row.insertCell(17).innerHTML= "<label>"+balQty+"</label>";
			row.insertCell(18).innerHTML= "<label>"+GRNCode+"</label>";
			row.insertCell(19).innerHTML= "<label>"+user+"</label>";
			row.insertCell(20).innerHTML= "<label>"+dateCreated+"</label>";
			row.insertCell(21).innerHTML= "<label>"+authorise+"</label>";
			row.insertCell(22).innerHTML= "<label>"+authoriseLevel+"</label>";
		}
...
<div id="formHeading">
	...
	<s:form action="frmPendingDocFlash.html" method="GET" name="frmStkFlash">
		<br>
			...
			<tr><th colspan="7"></th></tr>
				<tr>
					...
					<td id="tdPOStatus">
					 ...
					 <td colspan="2" id="lblSuppCode" style="visibility:hidden;">Supplier
			...
			<br>
			<div id="dvStock" style="width: 100% ;height: 100% ;padding-left: 26px;">
			<div style="width: 95%;
                 height: 400px;
                 overflow: scroll;
                 overflow-x:scroll;
                  overflow-y:scroll;
                 display: block;" >
				<table id="tblPendingDoc" border="1" class="transTable"  style="table-layout:fixed;width: 180%;">			
				</table>
			</div> 
		</div> 
		<br><br>
