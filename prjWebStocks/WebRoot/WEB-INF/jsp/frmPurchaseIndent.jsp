...
$(document).ready(function(){
	...
	<script type="text/javascript">
		...
		{	
		    ...
		    row.insertCell(3).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;\" class=\"decimal-places inputText-Auto Box\"  name=\"listPurchaseIndentDtlModel["+(rowCount)+"].dblRate\" id=\"txtRate."+(rowCount)+"\" value='"+parseFloat(dblUnitPrice).toFixed(maxQuantityDecimalPlaceLimit)+"'/>";
		    row.insertCell(4).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;\" class=\"decimal-places inputText-Auto Box totalValueCell\"  name=\"listPurchaseIndentDtlModel["+(rowCount)+"].dblAmount\" id=\"txtAmount."+(rowCount)+"\" value='"+parseFloat(dblAmount).toFixed(maxQuantityDecimalPlaceLimit)+"'/>";
	...
	<br>
		<table class="transTable">
			<tr >
			 ...
			 <a id="baseUrl" href="#">Attatch Documents</a>&nbsp; &nbsp; &nbsp;  &nbsp;</th>			   
		    </tr>
			<tr>
			...
			<tr>
				...
				<td width="30%"><label id="spProdName"  class="namelabel"></label></td>
				<td width="5%">Qty</td>
				<td width="5%"><input id="txtProdQty" style="width: 90%" name="txtProdQty" value="" type="text"  class="decimal-places numberField"  /></td>
