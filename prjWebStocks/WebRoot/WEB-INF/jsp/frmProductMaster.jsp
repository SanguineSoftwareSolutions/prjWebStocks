			...
			if(isOk)
			{
				...
				$.ajax({
				    ...
				    success: function(response)
				    {
				    	...
				    	$.each(response, function(i,item)
				    	{
				    		funAddReOrderRow1(response[i].strLocationCode,response[i].strLocationName,response[i].dblReOrderLevel,response[i].dblReOrderQty);
				    	});
				    },
					error: function(e)
				    {
						...
						<div id="tab2" class="tab_content" style="height: 400px">
							...
							<table class="masterTable">
								...
								<tr>
									...
									<td><s:checkbox id="strNonStockableItem" path="strNonStockableItem" value="Yes"></s:checkbox></td>		
