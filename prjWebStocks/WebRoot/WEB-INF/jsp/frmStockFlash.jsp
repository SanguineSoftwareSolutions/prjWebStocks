...
<head>
	...
	<script type="text/javascript">
		    ...
		    if($("#cmbReportType").val()=='Detail')
		   	{		    	
			    ...
			    for(var i=page_index*items_per_page;i<max_elem;i++)
			    {
			        ...
			        if(qtyWithUOM=='No')
			        {
				        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblCostRM).toFixed(maxAmountDecimalPlaceLimit)+'</td>';
				        ...
				        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblValue).toFixed(maxAmountDecimalPlaceLimit) +'</td>';
				    ...
				    {				        
				        newcontent += '<td align="right">'+StkFlashData[i].dblCostRM+'</td>';
		...
		function funCalculateStockFlashForSummary()
		{
			...
			var searchUrl=getContextPath()+"/frmStockFlashSummaryReport.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType;
		...
		{			
			...
			var searchUrl=getContextPath()+"/frmStockFlashDetailReport.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType;
			//alert(searchUrl);
		...
		function funCalculateMiniStockFlash()
		{
			...
			var prodType=$("#txtProdType").val();
			var param1=reportType+","+locCode+","+propCode+","+showZeroItems+","+strSGCode+","+strNonStkItems+","+strGCode+","+qtyWithUOM;
			var searchUrl=getContextPath()+"/frmMiniStockFlashReport.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType;
		...
		{			 
			$("#btnExport").click(function (e)
			{
				...
				if(reportType=='Summary' && strExportType=="PDF" )
					{
					window.location.href=getContextPath()+"/rptStockFlash.html?strExportType="+strExportType+"&prodType="+prodType+"&param1="+param1;
					}else if( reportType=='Mini')
						{
						window.location.href=getContextPath()+"/rptStkFlashMiniReport.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType;
						}else 
							{
								window.location.href=getContextPath()+"/downloadExcel.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType;
							}
						});
		});
		...
		<br>
			...
			<tr><th colspan="10"></th></tr>
				...
				<tr>
					...
					<td>Product Type</td>
						<td colspan="5"><s:select id="txtProdType" name="prodType" path="strProdType" items="${typeList}" cssClass="BoxW124px"/></td>
				</tr>
