...
**/
		...
		$.ajax({
	 		    ...
	 		    success: function(response)
	 		    {
			    	...
			    	$.each(response, function(i,item)
	 		         {
			    		funfillGrid(response[i][0],response[i][1],response[i][2],response[i][3],response[i][4],response[i][5],response[i][6]);
	 		         });
		        },
	 ...
	 * Filling Grid
	 */
	function funfillGrid(strReqCode,dtReqDate,strLocBy,strLocOn,strNarration,strAuthorise,dtReqiredDate)
	{	   
