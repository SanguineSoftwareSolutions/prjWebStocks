...
<script type="text/javascript">
	...
	function funSetReason(code){
		...
		$.ajax({
			type : "GET",
			url : getContextPath()+ "/loadReason.html?docCode=" + code,
			dataType : "json",
	...
	<s:form name="DeleteTransaction" method="POST" action="saveWebBooksDeleteTrans.html">
		...
		<table class="masterTable">
			...
			<tr>
				...
				<td colspan="2">
					<s:input  type="text" id="txtReasonCode" path="strReasonCode" cssClass="searchTextBox" ondblclick="funHelp('ReasonCode');"/>
				</td>
