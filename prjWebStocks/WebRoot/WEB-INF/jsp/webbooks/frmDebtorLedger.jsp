...
<script type="text/javascript">
	...
	function funGetDebtorLedger(fromDate,toDate,glCode,debtor,propCode)
	{
		...
		var searchUrl=getContextPath()+"/getDebtorLedger.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate;
	...
	function funShowDebtorLedger(response)
	{
		var table = document.getElementById("tblDebtorLedgerBill");
		var rowCount = table.rows.length;
		 ...
		 $.ajax({
			        ...
			        success: function(response)
			        {
			        	...
			        	{					        	    			        	    
			        	    ...
			        	    $("#lblFromDebtorName").text(response.strDebtorFullName);
