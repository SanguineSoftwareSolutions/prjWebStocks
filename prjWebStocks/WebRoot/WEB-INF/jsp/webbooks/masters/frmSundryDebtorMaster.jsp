...
// 		    col4.innerHTML = $("#txtCurrentBalance").val();
			...
			row.insertCell(0).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryDetorOpenongBalModel["+(rowCount)+"].strAccountCode\" id=\"strAccountCode."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtAccountCode").val()+"' />";
			row.insertCell(1).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryDetorOpenongBalModel["+(rowCount)+"].strAccountName\" id=\"strAccountName."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtAccountName").val()+"' />";
			row.insertCell(2).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryDetorOpenongBalModel["+(rowCount)+"].dblOpeningbal\" id=\"dblOpeningbal."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtOpeningBalance").val()+"' />";
			row.insertCell(3).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryDetorOpenongBalModel["+(rowCount)+"].strCrDr\" id=\"strCrDr."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#cmbDrCr").val()+"' />";
	...
	function funLoadOpeningBalTable(strAccountCode,strAccountName,dblOpeningbal,strCrDr)
	{
		    ...
		    row.insertCell(0).innerHTML= "<input class=\"Box\" size=\"22%\" name=\"listSundryDetorOpenongBalModel["+(rowCount)+"]\" id=\"txtAccountCode."+(rowCount)+"\" value='"+strAccountCode+"' >";
		    row.insertCell(1).innerHTML= "<input class=\"Box\" size=\"10%\" name=\"listSundryDetorOpenongBalModel["+(rowCount)+"]\"  id=\"txtAccountName."+(rowCount)+"\" value='"+strAccountName+"'>";		    	    
		    row.insertCell(2).innerHTML= "<input class=\"Box\" size=\"10%\" style=\"text-align: right;\" size=\"8%\" name=\"listSundryDetorOpenongBalModel["+(rowCount)+"]\" id=\"txtOpeningBalance."+(rowCount)+"\" value='"+dblOpeningbal+"'>";
		    row.insertCell(3).innerHTML= "<input class=\"Box\"  size=\"15%\" name=\"listSundryDetorOpenongBalModel["+(rowCount)+"]\" id=\"cmbDrCr."+(rowCount)+"\" value="+strCrDr+">";
		    row.insertCell(4).innerHTML= "<input class=\"Box\"  size=\"15%\" name=\"listSundryDetorOpenongBalModel["+(rowCount)+"]\" id=\"currentBal."+(rowCount)+"\" value="+0+">";
			row.insertCell(5).innerHTML="<input type=\"button\" value=\"Delete\"  class=\"deletebutton\" onclick=\"funRemoveRow(this,'tblOpeningBalance')\" />";   
