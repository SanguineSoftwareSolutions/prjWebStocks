	...
	function funAddRowToTblOpeningBalance(tableId)
	{
	    ...
	    if(flag)
	    {
	       /*  var row=table.insertRow();
		    ...
		    row.insertCell(0).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"].strAccountCode\" id=\"strAccountCode."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtAccountCode").val()+"' />";
		    row.insertCell(1).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"].strAccountName\" id=\"strAccountName."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtAccountName").val()+"' />";
		    row.insertCell(2).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"].dblOpeningbal\" id=\"dblOpeningbal."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtOpeningBalance").val()+"' />";
		    row.insertCell(3).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"].strCrDr\" id=\"strCrDr."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#cmbDrCr").val()+"' />";
		    row.insertCell(4).innerHTML = "<input readonly=\"readonly\" size=\"10%\" class=\"Box\"  name=\"currentBal\" id=\"currentBal."+(rowCount)+"\" style=\"text-align: left;  height:20px;\"  value='"+$("#txtCurrentBalance").val()+"' />";
...
// 		    col5.innerHTML = "<input type=\"button\" value=\"Delete\"  class=\"deletebutton\" onclick=\"funRemoveRow(this,'tblOpeningBalance')\" />";		    		   		    
	...
	function funLoadOpeningBalTable(strAccountCode,strAccountName,dblOpeningbal,strCrDr)
	{
		    ...
		    row.insertCell(0).innerHTML= "<input class=\"Box\" size=\"10%\" name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"]\" id=\"txtAccountCode."+(rowCount)+"\" value='"+strAccountCode+"' >";
		    row.insertCell(1).innerHTML= "<input class=\"Box\" size=\"10%\" name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"]\"  id=\"txtAccountName."+(rowCount)+"\" value='"+strAccountName+"'>";		    	    
		    row.insertCell(2).innerHTML= "<input class=\"Box\" size=\"10%\" style=\"text-align: right;\" size=\"8%\" name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"]\" id=\"txtOpeningBalance."+(rowCount)+"\" value='"+dblOpeningbal+"'>";
		    row.insertCell(3).innerHTML= "<input class=\"Box\"  size=\"10%\" name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"]\" id=\"cmbDrCr."+(rowCount)+"\" value="+strCrDr+">";
		    row.insertCell(4).innerHTML= "<input class=\"Box\"  size=\"10%\" name=\"listSundryCreditorOpenongBalModel["+(rowCount)+"]\" id=\"currentBal."+(rowCount)+"\" value="+0+">";
			row.insertCell(5).innerHTML="<input type=\"button\" value=\"Delete\"  class=\"deletebutton\" onclick=\"funRemoveRow(this,'tblOpeningBalance')\" />";   
	...
	<s:form name="SundryCreditorMaster" method="POST" action="saveSundryCreditorMaster.html">
		...
		<table class="masterTable" style="width: 99%">
			<tr>
			    ...
			    <td colspan="4"><s:input id="txtLastName" path="strLastName"  cssClass="longTextBox" cssStyle="width:65%"/></td>			    	    		        			  
			</tr>
			<tr>
		...
		<br> 
			<table class="masterTable" style="width: 99%">								
			    ...
			    <tr>
			    	...
			    	<td colspan="5"><s:input id="txtCountryName" path=""  readonly="true" cssClass="longTextBox" cssStyle="width:190px" /></td>			    			        			       				   				
			    </tr>
			    <tr>
		...
		<div id="tab2" class="tab_content" style="height: auto;">
		 <br> 
			<table class="masterTable" style="width: 99%">				
				<tr>
				        <th><label>Contact Person 1</label></th>
				        <th></th>
				        <th></th>
				        <th><label>Contact Person 2</label></th>				        
			   	</tr>	
			   	<tr>
			...
			<table class="masterTable" style="width: 99%">				
				<tr>
			   	...
			   	<tr>
			    	...
			    	<td><s:input id="txtOpeningBalance" path=""  cssClass="longTextBox" pattern="\d*"  /></td>			    	
