	...
	<s:form name="SuppGRNBill" method="POST" action="saveSuppGRNBill.html">
		...
		<table class="transTable">
			...
			<tr>
				...
				<td colspan="2">
					<s:input   type="number" step="0.01" style="text-align: right;width: 33%;" id="txtTotalAmount" readonly="readonly" path="dblTotalAmount" cssClass="longTextBox" />
				</td>
