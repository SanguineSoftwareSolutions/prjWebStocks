		...
		<div id="tab_container" style="height: 550px">
				...
				<table class="transTable">
				    ...
				    <tr>
				        ...
				        <td><s:input id="txtSupplierCode" required="required" path="strSuppCode" ondblclick="funHelp('suppcode')"  cssClass="searchTextBox"/></td>
					    <td colspan="4"><s:label id="txtSupplierName" path="strSuppName" cssClass="namelabel"/></td>
					</tr>
					...
					<td width="28%"><label id="lblProdName"></label></td>
