		...
		<br>
	   		<table class="transTable">
				...
				<tr>
					...
					<td width="10%"><s:input id="txtProdCode" path="strDocCode" value="" cssClass="searchTextBox"  readonly="readonly" ondblclick="funHelp('productmaster');" cssStyle="width:150px;background-position: 136px 4px;"/></td>
					<td colspan="3" id="spProdName">All Product</td>
				</tr>
				</table>
